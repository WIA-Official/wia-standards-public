# Cloud Computing — Phase 2: API Interface Specification
...
Phase 2 defines RESTful API endpoints for interacting with Cloud Computing services. This specification enables standardized programmatic access to cloud resource data across cloud platforms.

### 1.1 Base URL

```
Production: https://api.cloud-computing.wia.org/v1
Sandbox:    https://sandbox.cloud-computing.wia.org/v1
```
...
| Method | Endpoint | Description |
|--------|----------|-------------|
| POST | /data/ingest | Submit cloud resource data |
