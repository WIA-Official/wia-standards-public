# Autoimmune — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for Autoimmune systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across clinical research systems and diagnostic platforms.
...
```json
{
  ...
  "title": "WIA Autoimmune Data Format",
  "type": "object",
  "required": ["standard", "version", "timestamp", "data"],
  "properties": {
    "standard": {
      "type": "string",
      "const": "WIA-AUTOIMMUNE"
    },
    "version": {
      "type": "string",
      "pattern": "^\\d+\\.\\d+\\.\\d+$"
    ...
    "data": {
      "type": "object",
      "description": "Primary immunological data payload"
    }
  }
}
```
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (WIA-AUTOIMMUNE) |
...
| data | object | Yes | Domain-specific immunological data |
...
### 5.3 File Extensions
- `.wia-autoimmune.json` — JSON format
- `.wia-autoimmune.pb` — Protocol Buffers
