# Aeroponics — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for Aeroponics systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across management systems and technology platforms.
...
```json
{
  ...
  "title": "WIA Aeroponics Data Format",
  "type": "object",
  "required": ["standard", "version", "timestamp", "data"],
  "properties": {
    "standard": {
      "type": "string",
      "const": "WIA-AEROPONICS"
    },
    "version": {
      "type": "string",
      "pattern": "^\\d+\\.\\d+\\.\\d+$"
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (WIA-AEROPONICS) |
...
### 5.3 File Extensions
- `.wia-aeroponics.json` — JSON format
- `.wia-aeroponics.pb` — Protocol Buffers
