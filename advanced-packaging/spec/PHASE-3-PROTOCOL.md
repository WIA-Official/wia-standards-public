# WIA-CHIP-006 PHASE 3 — Protocol

**Standard:** WIA-CHIP-006 Advanced Packaging
**Phase:** 3 — Protocol
**Version:** 1.0
**Status:** Stable
**Source:** consolidated from `advanced-packaging-spec-v1.0.md` §9
(Interconnect Specification) and §12 (Signal Integrity)

This document defines the protocols used among WIA-CHIP-006-conformant
chiplets and packagers. It standardizes link bring-up, training,
signal-integrity reporting, and capability negotiation so that
multi-vendor packaging flows are reproducible and auditable.

References:
- UCIe 1.1 link layer and protocol layer
- IEEE 1149.6-2015 boundary-scan signalling
- IEEE 802.3-2022 (PMD/PCS reuse for inter-die links)
- JEDEC JESD235D (HBM3 signalling)
