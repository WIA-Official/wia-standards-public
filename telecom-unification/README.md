# WIA-UNI-006 — Telecom Unification

> 통신 통합 표준 — 통신사 표준 통합 · 3GPP · TM Forum · Open RAN · Open Gateway
...
telecom unification hosts that need to interoperate across
...
3. GSMA Open Gateway CAMARA
4. O-RAN Alliance Architecture
5. ETSI NFV Architecture
6. Numbering and Routing E.164/E.212
7. RCS Universal Profile per GSMA
8. Network Slicing and SBA

## CLI

A POSIX shell helper is published at `cli/telecom-unification.sh`. The helper ships
