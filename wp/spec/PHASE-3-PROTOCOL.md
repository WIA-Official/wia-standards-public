# WIA-wp PHASE 3 — PROTOCOL Specification
...
A wp operator MAY claim conformance to
WIA-wp only after the operating jurisdiction's
...
A programme conformant with WIA-wp publishes
