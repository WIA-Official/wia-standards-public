# WIA-wp PHASE 4 — INTEGRATION Specification
...
This document defines how a wp programme
...
`/.well-known/wia-wp` that links to the API
...
date WIA-wp MAY migrate historical records by
