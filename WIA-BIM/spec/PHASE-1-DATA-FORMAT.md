# BIM — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for BIM systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across management systems and technology platforms.
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (WIA-BIM) |
...
### 5.3 File Extensions
- `.wia-bim.json` — JSON format
- `.wia-bim.pb` — Protocol Buffers
