# Aerospace Engine — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for Aerospace Engine systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across space communication systems and orbital platforms.
...
```json
{
  ...
  "title": "WIA Aerospace Engine Data Format",
  "type": "object",
  "required": ["standard", "version", "timestamp", "data"],
  "properties": {
    "standard": {
      "type": "string",
      "const": "WIA-AEROSPACE_ENGINE"
    },
    "version": {
      "type": "string",
      "pattern": "^\\d+\\.\\d+\\.\\d+$"
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (WIA-AEROSPACE_ENGINE) |
...
### 5.3 File Extensions
- `.wia-aerospace-engine.json` — JSON format
- `.wia-aerospace-engine.pb` — Protocol Buffers
