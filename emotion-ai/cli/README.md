...
Minimal POSIX shell client that demonstrates the WIA `emotion-ai` standard's
...
```sh
export WIA_API_BASE="https://emotion-ai.example.com/api/v1"
export WIA_API_TOKEN="<your-bearer-token>"
./emotion-ai.sh list
./emotion-ai.sh get <id>
./emotion-ai.sh create payload.json
./emotion-ai.sh validate payload.json
./emotion-ai.sh export <id>
```
