...
echo -e "${CYAN}"
echo "╔════════════════════════════════════════════════════════════╗"
echo "║    WIA-OCEAN-008: Port Automation Standard Setup     ║"
echo "║              弘益人間 · Benefit All Humanity                ║"
echo "╚════════════════════════════════════════════════════════════╝"
echo -e "${NC}"

echo "Installing WIA-OCEAN-008 Port Automation Standard..."
...
# Make CLI executable
if [ -f "cli/port-automation.sh" ]; then
    chmod +x cli/port-automation.sh
...
if [ -d "$INSTALL_DIR" ]; then
    ln -sf "$(pwd)/cli/port-automation.sh" "$INSTALL_DIR/wia-ocean-008"
    echo -e "${GREEN}✓ Command 'wia-ocean-008' available${NC}"
else
...
echo ""
echo "Quick start:"
echo "  1. View status: ./cli/port-automation.sh status"
echo "  2. Read sensors: ./cli/port-automation.sh sensor read"
echo "  3. Start mission: ./cli/port-automation.sh mission start"
echo ""
echo "Documentation:"
...
echo "  npm install @wia/ocean-008"
echo ""
