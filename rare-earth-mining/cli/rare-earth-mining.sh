#!/usr/bin/env bash
# rare-earth-mining — Rare Earth Mining CLI helper.
#
# Sample envelope generators for the WIA-ENE-041 standard.
# Requires: bash 4+, jq.
set -euo pipefail

STD_ID="WIA-ENE-041"
SLUG="rare-earth-mining"
...
cmd_refs() {
    cat <<REFS
Normative references for WIA-ENE-041 (Rare Earth Mining):
