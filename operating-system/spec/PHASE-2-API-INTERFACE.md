# Operating System — Phase 2: API Interface Specification
...
Phase 2 defines RESTful API endpoints for interacting with Operating System services. This specification enables standardized programmatic access to operational data across management systems.

### 1.1 Base URL

```
Production: https://api.operating-system.wia.org/v1
Sandbox:    https://sandbox.operating-system.wia.org/v1
```
