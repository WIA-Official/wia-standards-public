# WIA-SOC-005 Phase 1: Data Format Specification
...
Phase 1 defines the standardized data formats for emergency responses, including emergency system state representation, map data structures, sensor readings, and cleaning logs. All data MUST use JSON-LD format for semantic interoperability.

## 2. Core Data Types

### 2.1 Emergency System Identity

```json
{
  "@context": "https://wiastandards.com/rob-011/v1",
  "@type": "CleaningEmergency System",
  "emergency systemId": "ROB-2025-XXXX-YYYY",
  "manufacturer": "string",
  "model": "string",
  "serialNumber": "string",
...
### 2.2 Emergency System State

```json
{
  "@type": "Emergency SystemState",
...
### Complete Emergency System State Example
