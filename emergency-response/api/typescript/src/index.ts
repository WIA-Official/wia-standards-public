/**
 * WIA-SOC-005 Emergency Response Standard API
...
/**
 * Main API client for WIA-SOC-005 cleaning robots
 */
export class WiaEmergencyResponse {
 ...
 */
export function createRobot(options: types.ApiClientOptions): WiaEmergencyResponse {
  return new WiaEmergencyResponse(options);
}
 ...
 * Default export
 */
export default WiaEmergencyResponse;
