...
export class DeepSeaExplorer {
  ...
  private async initialize(): Promise<void> {
    console.log(`[WIA-OCEAN-001] Initializing ${this.config.vehicleId}`);
    ...
    console.log('[WIA-OCEAN-001] Initialization complete');
  }
  ...
  async startMission(config: MissionConfig): Promise<MissionData> {
    console.log('[WIA-OCEAN-001] Starting mission');
  ...
  async descend(targetDepth: number, rate: number = 30): Promise<void> {
    console.log(`[WIA-OCEAN-001] Descending to ${targetDepth}m at ${rate}m/min`);
    ...
    console.log(`[WIA-OCEAN-001] Reached target depth: ${targetDepth}m`);
  }
  ...
  async ascend(rate: number = 30): Promise<void> {
    console.log(`[WIA-OCEAN-001] Ascending at ${rate}m/min`);

    this.emitEvent('dive_end', { rate });

    await this.delay(1000); // Simulate ascent

    console.log('[WIA-OCEAN-001] Surfaced');
  }
  ...
  async sendCommand(command: ControlCommand): Promise<void> {
    console.log('[WIA-OCEAN-001] Sending command:', command);
    await this.delay(100);
  }
  ...
  async emergencySurface(): Promise<void> {
    console.log('[WIA-OCEAN-001] EMERGENCY SURFACE INITIATED');
    ...
    console.log('[WIA-OCEAN-001] Surfaced - Emergency procedure complete');
  }
