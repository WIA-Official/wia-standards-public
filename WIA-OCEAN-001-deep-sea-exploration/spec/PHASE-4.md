...
class PerformanceBenchmark {
  industry_comparison = {
    depth_capability: {
      wia_ocean_001: 11000, // meters
      industry_average: 6000,
      percentile: 95
    },

    operational_cost: {
      wia_ocean_001: 25000, // per dive day
      industry_average: 40000,
      savings: '37.5%'
    },

    data_quality: {
      wia_ocean_001: 99.2, // percent
      industry_average: 95.0,
      improvement: '+4.2%'
    },

    safety_record: {
      wia_ocean_001: 0, // incidents per 1000 dives
...
```yaml
WIA-OCEAN-001 Excellence Criteria:
  Safety:
    - Zero loss of life
...
WIA conformance for WIA-OCEAN-001-deep-sea-exploration is evaluated across three tiers:
...
- `wia-standards/standards/WIA-OCEAN-001-deep-sea-exploration/api/` — TypeScript SDK skeleton
- `wia-standards/standards/WIA-OCEAN-001-deep-sea-exploration/cli/` — POSIX shell client demonstrating the request/response contract
- `wia-standards/standards/WIA-OCEAN-001-deep-sea-exploration/simulator/` — interactive browser-based simulator for the PHASE protocol
