# Connected CAR — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for Connected CAR systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across management systems and technology platforms.
...
```json
{
  ...
  "title": "WIA Connected CAR Data Format",
  "type": "object",
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (connected-car) |
...
### 5.3 File Extensions
- `.wia-connected-car.json` — JSON format
- `.wia-connected-car.pb` — Protocol Buffers
