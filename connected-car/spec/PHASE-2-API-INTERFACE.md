# Connected CAR — Phase 2: API Interface Specification
...
Phase 2 defines RESTful API endpoints for interacting with Connected CAR services. This specification enables standardized programmatic access to operational data across management systems.

### 1.1 Base URL

```
Production: https://api.connected-car.wia.org/v1
Sandbox:    https://sandbox.connected-car.wia.org/v1
```
