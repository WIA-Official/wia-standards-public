# Agricultural Drone — Phase 2: API Interface Specification
...
Phase 2 defines RESTful API endpoints for interacting with Agricultural Drone services. This specification enables standardized programmatic access to agricultural data across farm management systems.

### 1.1 Base URL

```
Production: https://api.agricultural-drone.wia.org/v1
Sandbox:    https://sandbox.agricultural-drone.wia.org/v1
```
