# Agricultural Drone — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for Agricultural Drone systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across farm management systems and agricultural equipment.
...
```json
{
  ...
  "title": "WIA Agricultural Drone Data Format",
  "type": "object",
  "required": ["standard", "version", "timestamp", "data"],
  "properties": {
    "standard": {
      "type": "string",
      "const": "WIA-AGRICULTURAL_DRONE"
    },
    "version": {
      "type": "string",
      "pattern": "^\\d+\\.\\d+\\.\\d+$"
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (WIA-AGRICULTURAL_DRONE) |
...
### 5.3 File Extensions
- `.wia-agricultural-drone.json` — JSON format
- `.wia-agricultural-drone.pb` — Protocol Buffers
...
```json
{
  "standard": "WIA-AGRICULTURAL_DRONE",
  "version": "1.0.0",
