...
Minimal POSIX shell client that demonstrates the WIA `privacy` standard's
...
```sh
export WIA_API_BASE="https://privacy.example.com/api/v1"
export WIA_API_TOKEN="<your-bearer-token>"
./privacy.sh list
./privacy.sh get <id>
./privacy.sh create payload.json
./privacy.sh validate payload.json
./privacy.sh export <id>
```
