# LOW Code Platform — Phase 2: API Interface Specification
...
Phase 2 defines RESTful API endpoints for interacting with LOW Code Platform services. This specification enables standardized programmatic access to operational data across management systems.

### 1.1 Base URL

```
Production: https://api.low-code-platform.wia.org/v1
Sandbox:    https://sandbox.low-code-platform.wia.org/v1
```
