# Vehicle Semiconductor — Phase 2: API Interface Specification
...
Phase 2 defines RESTful API endpoints for interacting with Vehicle Semiconductor services. This specification enables standardized programmatic access to vehicle data across transportation networks.

### 1.1 Base URL

```
Production: https://api.vehicle-semiconducto.wia.org/v1
Sandbox:    https://sandbox.vehicle-semiconducto.wia.org/v1
```
