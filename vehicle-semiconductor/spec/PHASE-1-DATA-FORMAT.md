# Vehicle Semiconductor — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for Vehicle Semiconductor systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across transportation networks and vehicular systems.
...
```json
{
  ...
  "title": "WIA Vehicle Semiconductor Data Format",
  "type": "object",
  "required": ["standard", "version", "timestamp", "data"],
  "properties": {
    "standard": {
      "type": "string",
      "const": "vehicle-semiconductor"
    },
    "version": {
      "type": "string",
      "pattern": "^\\d+\\.\\d+\\.\\d+$"
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (vehicle-semiconductor) |
...
### 5.3 File Extensions
- `.wia-vehicle-semiconducto.json` — JSON format
- `.wia-vehicle-semiconducto.pb` — Protocol Buffers
...
```json
{
  "standard": "vehicle-semiconductor",
  "version": "1.0.0",
