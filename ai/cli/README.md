...
Minimal POSIX shell client that demonstrates the WIA `ai` standard's
...
```sh
export WIA_API_BASE="https://ai.example.com/api/v1"
export WIA_API_TOKEN="<your-bearer-token>"
./ai.sh list
./ai.sh get <id>
./ai.sh create payload.json
./ai.sh validate payload.json
./ai.sh export <id>
```
