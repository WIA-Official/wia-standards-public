# `deep-sea-aquaculture` CLI

Minimal POSIX shell client that demonstrates the WIA `deep-sea-aquaculture` standard's
...
```sh
export WIA_API_BASE="https://deep-sea-aquaculture.example.com/api/v1"
export WIA_API_TOKEN="<your-bearer-token>"
./deep-sea-aquaculture.sh list
./deep-sea-aquaculture.sh get <id>
./deep-sea-aquaculture.sh create payload.json
./deep-sea-aquaculture.sh validate payload.json
./deep-sea-aquaculture.sh export <id>
```
