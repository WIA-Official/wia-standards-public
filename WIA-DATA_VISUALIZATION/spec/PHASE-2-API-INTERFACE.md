# WIA-DATA_VISUALIZATION: Phase 2 - API Interface Specification
**Version:** 1.0
**Status:** Official
...
This document specifies the API interface requirements for DATA VISUALIZATION. All implementations MUST provide these endpoints to ensure interoperability.

## 2. REST API Endpoints

### 2.1 Base URL
```
https://api.wia.org/v1/wia-data-visualization/
```
...
```http
POST /v1/wia-data-visualization/records HTTP/1.1
...
### 3.1 Installation
```bash
npm install @wia/wia-data-visualization-sdk
```
...
### 3.3 Usage Example
```typescript
import { createClient } from '@wia/wia-data-visualization-sdk';
...
WIA conformance for WIA-DATA_VISUALIZATION is evaluated across three tiers:
...
- `wia-standards/standards/WIA-DATA_VISUALIZATION/api/` — TypeScript SDK skeleton
- `wia-standards/standards/WIA-DATA_VISUALIZATION/cli/` — POSIX shell client demonstrating the request/response contract
- `wia-standards/standards/WIA-DATA_VISUALIZATION/simulator/` — interactive browser-based simulator for the PHASE protocol
