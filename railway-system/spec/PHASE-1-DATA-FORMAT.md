# Railway System — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for Railway System systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across AI service platforms and AI processing systems.
...
```json
{
  ...
  "title": "WIA Railway System Data Format",
  "type": "object",
  "required": ["standard", "version", "timestamp", "data"],
  "properties": {
    "standard": {
      "type": "string",
      "const": "railway-system"
    },
    "version": {
      "type": "string",
      "pattern": "^\\d+\\.\\d+\\.\\d+$"
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (railway-system) |
...
### 5.3 File Extensions
- `.wia-railway-system.json` — JSON format
- `.wia-railway-system.pb` — Protocol Buffers
