# Cyber Weapon — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for Cyber Weapon systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across security operations centers and network defense systems.
...
```json
{
  ...
  "title": "WIA Cyber Weapon Data Format",
  "type": "object",
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (cyber-weapon) |
...
### 5.3 File Extensions
- `.wia-cyber-weapon.json` — JSON format
- `.wia-cyber-weapon.pb` — Protocol Buffers
