# WIA-video PHASE 4 — INTEGRATION Specification
...
This document defines how a video programme
...
`/.well-known/wia-video` that links to the API
...
date WIA-video MAY migrate historical records by
