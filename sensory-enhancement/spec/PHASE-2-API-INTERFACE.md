# Sensory Enhancement — Phase 2: API Interface Specification
...
Phase 2 defines RESTful API endpoints for interacting with Sensory Enhancement services. This specification enables standardized programmatic access to sensor readings across sensor networks.

### 1.1 Base URL

```
Production: https://api.sensory-enhancement.wia.org/v1
Sandbox:    https://sandbox.sensory-enhancement.wia.org/v1
```
...
| Method | Endpoint | Description |
|--------|----------|-------------|
| POST | /data/ingest | Submit sensor readings |
