#!/usr/bin/env bash
# rust-learn — Rust Learn CLI helper.
#
# Sample envelope generators for the WIA-RUST-LEARN-PRIMER standard.
# Requires: bash 4+, jq.
set -euo pipefail

STD_ID="WIA-RUST-LEARN-PRIMER"
SLUG="rust-learn"
...
cmd_refs() {
    cat <<REFS
Normative references for WIA-RUST-LEARN-PRIMER (Rust Learn):
