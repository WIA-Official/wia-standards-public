...
Minimal POSIX shell client that demonstrates the WIA `metamaterial` standard's
...
```sh
export WIA_API_BASE="https://metamaterial.example.com/api/v1"
export WIA_API_TOKEN="<your-bearer-token>"
./metamaterial.sh list
./metamaterial.sh get <id>
./metamaterial.sh create payload.json
./metamaterial.sh validate payload.json
./metamaterial.sh export <id>
```
