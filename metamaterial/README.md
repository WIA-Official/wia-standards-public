...
WIA standard `metamaterial` — see <https://wiastandards.com> for the full standards catalogue.
...
WIA conformance for **metamaterial** is evaluated across three tiers, mirrored in every PHASE document under `spec/`:
