# WIA-ART-002: Phase 4 - Integration Specification
**Version:** 1.0
**Status:** Official
...
Integration guidelines for WIA-ART-002 AI-Generated Art Standard.

## 2. Platform Integration

### 2.1 Web Applications
```html
<script src="https://cdn.wia.org/art-002/v1/wia-art-002.js"></script>
<script>
...
let sdk = WIAART002(apiKey: "your-api-key")
```

### 2.3 Server-Side Integration
```python
from wia_art_002 import SDK
