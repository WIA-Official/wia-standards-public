# Virtualization — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for Virtualization systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across management systems and technology platforms.
...
```json
{
  ...
  "title": "WIA Virtualization Data Format",
  "type": "object",
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (virtualization) |
...
### 5.3 File Extensions
- `.wia-virtualization.json` — JSON format
- `.wia-virtualization.pb` — Protocol Buffers
