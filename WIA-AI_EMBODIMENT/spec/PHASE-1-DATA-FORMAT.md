# AI Embodiment — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for AI Embodiment systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across AI service platforms and AI processing systems.
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (WIA-AI_EMBODIMENT) |
...
### 5.3 File Extensions
- `.wia-ai-embodiment.json` — JSON format
- `.wia-ai-embodiment.pb` — Protocol Buffers
