# WIA-AIR-POWER PHASE 2 — API Interface

**Standard:** WIA-AIR-POWER
**Phase:** 2 — API Interface
**Version:** 1.0
**Status:** Stable
**Source:** consolidated from `WIA-AIR-POWER-v1.0.md` §11 (API
Specification)

This document defines the REST and event-stream APIs for device
registration, capability negotiation, power-grant issuance, and
telemetry retrieval. Authentication uses OAuth 2.1 (RFC 9700) with
...
- `deviceCatalog` — list, retrieve, search WIA-AIR-POWER device types
- `capabilityNegotiate` — exchange supported power profiles
- `powerGrant` — issue and revoke power-delivery grants
- `telemetry` — submit and retrieve power telemetry envelopes
- `serviceBulletin` — publish safety notifications
...
`/.well-known/wia/air-power`. Manifest endpoints are signed using
