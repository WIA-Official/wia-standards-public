...
- Implement the `WIAinfrastructure_monitoringAdapter` interface
...
```json
{
  ...
  "channels": [
    "infrastructure-monitoring.data.ingested",
    "infrastructure-monitoring.resource.updated",
    "infrastructure-monitoring.alert.triggered"
  ]
}
```
...
```
WIA_STANDARD=infrastructure-monitoring
WIA_VERSION=1.0.0
WIA_LOG_LEVEL=info
