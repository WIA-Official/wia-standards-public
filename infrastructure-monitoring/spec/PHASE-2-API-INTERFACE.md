# Infrastructure Monitoring — Phase 2: API Interface Specification
...
Phase 2 defines RESTful API endpoints for interacting with Infrastructure Monitoring services. This specification enables standardized programmatic access to infrastructure monitoring data across structural health systems.

### 1.1 Base URL

```
Production: https://api.infrastructure-monit.wia.org/v1
Sandbox:    https://sandbox.infrastructure-monit.wia.org/v1
```
...
| Method | Endpoint | Description |
|--------|----------|-------------|
| POST | /data/ingest | Submit infrastructure monitoring data |
