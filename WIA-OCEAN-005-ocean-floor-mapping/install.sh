...
echo -e "${CYAN}"
echo "╔════════════════════════════════════════════════════════════╗"
echo "║    WIA-OCEAN-005: Ocean Floor Mapping Standard Setup     ║"
echo "║              弘益人間 · Benefit All Humanity                ║"
echo "╚════════════════════════════════════════════════════════════╝"
echo -e "${NC}"

echo "Installing WIA-OCEAN-005 Ocean Floor Mapping Standard..."
...
# Make CLI executable
if [ -f "cli/ocean-floor-mapping.sh" ]; then
    chmod +x cli/ocean-floor-mapping.sh
...
if [ -d "$INSTALL_DIR" ]; then
    ln -sf "$(pwd)/cli/ocean-floor-mapping.sh" "$INSTALL_DIR/wia-ocean-005"
    echo -e "${GREEN}✓ Command 'wia-ocean-005' available${NC}"
else
...
echo ""
echo "Quick start:"
echo "  1. View status: ./cli/ocean-floor-mapping.sh status"
echo "  2. Read sensors: ./cli/ocean-floor-mapping.sh sensor read"
echo "  3. Start mission: ./cli/ocean-floor-mapping.sh mission start"
echo ""
echo "Documentation:"
...
echo "  npm install @wia/ocean-005"
echo ""
