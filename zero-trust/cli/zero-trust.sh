#!/usr/bin/env bash
# zero-trust — Zero Trust CLI helper.
#
# Sample envelope generators for the WIA-SEC-ZT-001 standard.
# Requires: bash 4+, jq.
set -euo pipefail

STD_ID="WIA-SEC-ZT-001"
SLUG="zero-trust"
...
cmd_refs() {
    cat <<REFS
Normative references for WIA-SEC-ZT-001 (Zero Trust):
