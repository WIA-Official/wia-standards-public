# Microservices — Phase 2: API Interface Specification
...
Phase 2 defines RESTful API endpoints for interacting with Microservices services. This specification enables standardized programmatic access to micro-scale measurement data across detection systems.

### 1.1 Base URL

```
Production: https://api.microservices.wia.org/v1
Sandbox:    https://sandbox.microservices.wia.org/v1
```
