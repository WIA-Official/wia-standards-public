# Microservices — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for Microservices systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across detection systems and analytical platforms.
...
```json
{
  ...
  "title": "WIA Microservices Data Format",
  "type": "object",
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (microservices) |
...
### 5.3 File Extensions
- `.wia-microservices.json` — JSON format
- `.wia-microservices.pb` — Protocol Buffers
