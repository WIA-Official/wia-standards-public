# Microservices — Phase 4: Integration Specification
...
Phase 4 defines integration patterns and requirements for deploying Microservices within existing infrastructure. This specification covers system architecture, integration patterns, testing requirements, and deployment guidelines for detection systems and analytical platforms.
...
- Implement the `WIAmicroservicesAdapter` interface
...
```json
{
  ...
  "channels": [
    "microservices.data.ingested",
    "microservices.resource.updated",
    "microservices.alert.triggered"
  ]
}
```
