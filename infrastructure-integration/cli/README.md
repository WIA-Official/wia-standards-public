# `infrastructure-integration` CLI

Minimal POSIX shell client that demonstrates the WIA `infrastructure-integration` standard's
...
```sh
export WIA_API_BASE="https://infrastructure-integration.example.com/api/v1"
export WIA_API_TOKEN="<your-bearer-token>"
./infrastructure-integration.sh list
./infrastructure-integration.sh get <id>
./infrastructure-integration.sh create payload.json
./infrastructure-integration.sh validate payload.json
./infrastructure-integration.sh export <id>
```
