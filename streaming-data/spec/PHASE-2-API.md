# WIA-DATA-001 — Phase 2: API

> Streaming Data canonical Phase 2 specification per the WIA Standards four-Phase architecture.

> Domain: 스트리밍 데이터 — 이벤트 스트리밍 · Kafka · Pulsar · Flink · Beam · CDC.

## A.1 Scope

This Phase covers the canonical api layer of the WIA-DATA-001 standard. It composes with the Phase 3 document for cross-Phase integration and inherits cross-standard behaviour from the wider WIA Standards family per the README.md scope statement.
