...
/**
 * WIA-HERITAGE-001 SDK Client
 */
export class WIAHeritage001 {
  private config: WIAHeritage001Config;
  private endpoint: string;

  constructor(config: WIAHeritage001Config) {
    this.config = {
