# Tourism Data — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for Tourism Data systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across travel booking systems and hospitality platforms.
...
```json
{
  ...
  "title": "WIA Tourism Data Data Format",
  "type": "object",
  ...
  "properties": {
    ...
    "data": {
      "type": "object",
      "description": "Primary tourism analytics data payload"
    }
  }
}
```
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (tourism-data) |
...
| data | object | Yes | Domain-specific tourism analytics data |
...
### 5.3 File Extensions
- `.wia-tourism-data.json` — JSON format
- `.wia-tourism-data.pb` — Protocol Buffers
