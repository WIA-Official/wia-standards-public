# Tourism Data — Phase 2: API Interface Specification
...
Phase 2 defines RESTful API endpoints for interacting with Tourism Data services. This specification enables standardized programmatic access to tourism analytics data across travel booking systems.

### 1.1 Base URL

```
Production: https://api.tourism-data.wia.org/v1
Sandbox:    https://sandbox.tourism-data.wia.org/v1
```
...
| Method | Endpoint | Description |
|--------|----------|-------------|
| POST | /data/ingest | Submit tourism analytics data |
