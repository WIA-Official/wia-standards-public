# WIA-archive PHASE 4 — INTEGRATION Specification
...
This document defines how a archive programme
...
`/.well-known/wia-archive` that links to the API
...
date WIA-archive MAY migrate historical records by
