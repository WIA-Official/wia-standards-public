# WIA-archive PHASE 3 — PROTOCOL Specification
...
A archive operator MAY claim conformance to
WIA-archive only after the operating jurisdiction's
...
A programme conformant with WIA-archive publishes
