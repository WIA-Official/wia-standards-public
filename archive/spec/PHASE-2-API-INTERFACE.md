# WIA-archive PHASE 2 — API-INTERFACE Specification

**Standard:** WIA-archive
...
`urn:wia:archive:status-transition`.
...
`422` with type
`urn:wia:archive:source-mix-required`.
...
with type
`urn:wia:archive:laboratory-not-accredited`.
...
`409` with type
`urn:wia:archive:quality-certificate-required`.
...
- `urn:wia:archive:hydrogen-quality-out-of-grade`
- `urn:wia:archive:cryogenic-temperature-excursion`
- `urn:wia:archive:guarantee-of-origin-mismatch`
- `urn:wia:archive:evidence-mismatch`
