# WIA-DIGITAL_EXECUTOR Rust SDK

> **弘益人間 (Benefit All Humanity)**

Official Rust SDK for the WIA-DIGITAL_EXECUTOR Standard.
...
```rust
use wia_digital_executor_sdk::CreateDigitalExecutorRequest;

let request = CreateDigitalExecutorRequest {
...
```rust
use wia_digital_executor_sdk::ListParams;
...
```rust
use wia_digital_executor_sdk::Error;
...
- Documentation: https://docs.wiastandards.com/WIA-DIGITAL_EXECUTOR
