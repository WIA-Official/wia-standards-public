# WIA-HERITAGE-008 PHASE 2 — API-INTERFACE Specification
...
`urn:wia:WIA-HERITAGE-008:status-transition`.
...
`422` with type
`urn:wia:WIA-HERITAGE-008:source-mix-required`.
...
with type
`urn:wia:WIA-HERITAGE-008:laboratory-not-accredited`.
...
`409` with type
`urn:wia:WIA-HERITAGE-008:quality-certificate-required`.
...
- `urn:wia:WIA-HERITAGE-008:hydrogen-quality-out-of-grade`
- `urn:wia:WIA-HERITAGE-008:cryogenic-temperature-excursion`
- `urn:wia:WIA-HERITAGE-008:guarantee-of-origin-mismatch`
- `urn:wia:WIA-HERITAGE-008:evidence-mismatch`
