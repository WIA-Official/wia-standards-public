...
This document defines how a WIA-HERITAGE-008 programme
...
`/.well-known/wia-WIA-HERITAGE-008` that links to the API
...
date WIA-HERITAGE-008 MAY migrate historical records by
