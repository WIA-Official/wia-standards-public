# Climate Refugee — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for Climate Refugee systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across environmental systems and monitoring stations.
...
```json
{
  ...
  "title": "WIA Climate Refugee Data Format",
  "type": "object",
  "required": ["standard", "version", "timestamp", "data"],
  "properties": {
    "standard": {
      "type": "string",
      "const": "climate-refugee"
    },
    "version": {
      "type": "string",
      "pattern": "^\\d+\\.\\d+\\.\\d+$"
    ...
    "data": {
      "type": "object",
      "description": "Primary climate measurement data payload"
    }
  }
}
```
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (climate-refugee) |
...
| data | object | Yes | Domain-specific climate measurement data |
...
### 5.3 File Extensions
- `.wia-climate-refugee.json` — JSON format
- `.wia-climate-refugee.pb` — Protocol Buffers
