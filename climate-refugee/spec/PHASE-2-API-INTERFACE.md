# Climate Refugee — Phase 2: API Interface Specification
...
Phase 2 defines RESTful API endpoints for interacting with Climate Refugee services. This specification enables standardized programmatic access to climate measurement data across environmental systems.

### 1.1 Base URL

```
Production: https://api.climate-refugee.wia.org/v1
Sandbox:    https://sandbox.climate-refugee.wia.org/v1
```
...
| Method | Endpoint | Description |
|--------|----------|-------------|
| POST | /data/ingest | Submit climate measurement data |
