# LOW Power Network — Phase 2: API Interface Specification
...
Phase 2 defines RESTful API endpoints for interacting with LOW Power Network services. This specification enables standardized programmatic access to network traffic data across network management systems.

### 1.1 Base URL

```
Production: https://api.low-power-network.wia.org/v1
Sandbox:    https://sandbox.low-power-network.wia.org/v1
```
...
| Method | Endpoint | Description |
|--------|----------|-------------|
| POST | /data/ingest | Submit network traffic data |
