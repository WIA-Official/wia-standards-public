# Network Slicing — Phase 2: API Interface Specification
...
Phase 2 defines RESTful API endpoints for interacting with Network Slicing services. This specification enables standardized programmatic access to network traffic data across network management systems.

### 1.1 Base URL

```
Production: https://api.network-slicing.wia.org/v1
Sandbox:    https://sandbox.network-slicing.wia.org/v1
```
