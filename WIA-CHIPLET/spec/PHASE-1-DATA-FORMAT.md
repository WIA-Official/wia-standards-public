# Chiplet — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for Chiplet systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across semiconductor fabrication systems and chip testing equipment.
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (WIA-CHIPLET) |
...
### 5.3 File Extensions
- `.wia-chiplet.json` — JSON format
- `.wia-chiplet.pb` — Protocol Buffers
