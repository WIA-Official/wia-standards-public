...
Minimal POSIX shell client that demonstrates the WIA `smart-contract` standard's
...
```sh
export WIA_API_BASE="https://smart-contract.example.com/api/v1"
export WIA_API_TOKEN="<your-bearer-token>"
./smart-contract.sh list
./smart-contract.sh get <id>
./smart-contract.sh create payload.json
./smart-contract.sh validate payload.json
./smart-contract.sh export <id>
```
