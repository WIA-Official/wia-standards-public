# Health Monitoring — Phase 3: Protocol Specification
...
Phase 3 defines communication protocols for real-time data exchange between Health Monitoring components, including clinical systems and health monitoring devices. This specification ensures secure, efficient, and interoperable data streaming.
...
┌─────────────────────────────────────┐
│      Application Layer              │
│   (WIA-HEALTH_MONITORING Messages)             │
├─────────────────────────────────────┤
│      Presentation Layer             │
...
|------|-----------|-------------|
| DATA | Uni/Bi | patient health data transmission |
