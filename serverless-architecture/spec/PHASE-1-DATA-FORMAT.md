# Serverless Architecture — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for Serverless Architecture systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across management systems and technology platforms.
...
```json
{
  ...
  "title": "WIA Serverless Architecture Data Format",
  "type": "object",
  "required": ["standard", "version", "timestamp", "data"],
  "properties": {
    "standard": {
      "type": "string",
      "const": "serverless-architecture"
    },
    "version": {
      "type": "string",
      "pattern": "^\\d+\\.\\d+\\.\\d+$"
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (serverless-architecture) |
...
### 5.3 File Extensions
- `.wia-serverless-architect.json` — JSON format
- `.wia-serverless-architect.pb` — Protocol Buffers
