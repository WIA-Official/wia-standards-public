# Wireless Power Transfer — Phase 2: API Interface Specification
...
Phase 2 defines RESTful API endpoints for interacting with Wireless Power Transfer services. This specification enables standardized programmatic access to wireless signal data across radio communication systems.

### 1.1 Base URL

```
Production: https://api.wireless-power-trans.wia.org/v1
Sandbox:    https://sandbox.wireless-power-trans.wia.org/v1
```
...
| Method | Endpoint | Description |
|--------|----------|-------------|
| POST | /data/ingest | Submit wireless signal data |
