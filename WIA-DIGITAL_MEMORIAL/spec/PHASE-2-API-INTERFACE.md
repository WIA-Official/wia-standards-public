...
This document specifies the API interface requirements for DIGITAL MEMORIAL. All implementations MUST provide these endpoints to ensure interoperability.

## 2. REST API Endpoints

### 2.1 Base URL
```
https://api.wia.org/v1/wia-digital-memorial/
```
...
```http
POST /v1/wia-digital-memorial/records HTTP/1.1
...
### 3.1 Installation
```bash
npm install @wia/wia-digital-memorial-sdk
```
...
### 3.3 Usage Example
```typescript
import { createClient } from '@wia/wia-digital-memorial-sdk';
