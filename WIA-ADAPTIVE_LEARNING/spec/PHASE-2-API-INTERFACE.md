# Adaptive Learning — Phase 2: API Interface Specification
...
Phase 2 defines RESTful API endpoints for interacting with Adaptive Learning services. This specification enables standardized programmatic access to learning analytics across LMS platforms.

### 1.1 Base URL

```
Production: https://api.adaptive-learning.wia.org/v1
Sandbox:    https://sandbox.adaptive-learning.wia.org/v1
```
...
| Method | Endpoint | Description |
|--------|----------|-------------|
| POST | /data/ingest | Submit learning analytics |
