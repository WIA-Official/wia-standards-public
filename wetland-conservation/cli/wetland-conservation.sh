#!/usr/bin/env bash
# wetland-conservation — Wetland Conservation CLI helper.
#
# Sample envelope generators for the WIA-ENV-014 standard.
# Requires: bash 4+, jq.
set -euo pipefail
...
cmd_refs() {
    cat <<REFS
Normative references for WIA-ENV-014 (Wetland Conservation):
