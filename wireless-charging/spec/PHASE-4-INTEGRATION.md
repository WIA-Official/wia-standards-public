...
- Implement the `WIAwireless_chargingAdapter` interface
...
```json
{
  ...
  "channels": [
    "wireless-charging.data.ingested",
    "wireless-charging.resource.updated",
    "wireless-charging.alert.triggered"
  ]
}
```
...
```
WIA_STANDARD=wireless-charging
WIA_VERSION=1.0.0
WIA_LOG_LEVEL=info
