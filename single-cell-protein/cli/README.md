# `single-cell-protein` CLI

Minimal POSIX shell client that demonstrates the WIA `single-cell-protein` standard's
...
```sh
export WIA_API_BASE="https://single-cell-protein.example.com/api/v1"
export WIA_API_TOKEN="<your-bearer-token>"
./single-cell-protein.sh list
./single-cell-protein.sh get <id>
./single-cell-protein.sh create payload.json
./single-cell-protein.sh validate payload.json
./single-cell-protein.sh export <id>
```
