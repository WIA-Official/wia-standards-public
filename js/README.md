...
WIA standard `js` — see <https://wiastandards.com> for the full standards catalogue.
...
WIA conformance for **js** is evaluated across three tiers, mirrored in every PHASE document under `spec/`:
