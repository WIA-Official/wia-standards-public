...
Minimal POSIX shell client that demonstrates the WIA `js` standard's
...
```sh
export WIA_API_BASE="https://js.example.com/api/v1"
export WIA_API_TOKEN="<your-bearer-token>"
./js.sh list
./js.sh get <id>
./js.sh create payload.json
./js.sh validate payload.json
./js.sh export <id>
```
