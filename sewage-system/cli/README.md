...
Minimal POSIX shell client that demonstrates the WIA `sewage-system` standard's
...
```sh
export WIA_API_BASE="https://sewage-system.example.com/api/v1"
export WIA_API_TOKEN="<your-bearer-token>"
./sewage-system.sh list
./sewage-system.sh get <id>
./sewage-system.sh create payload.json
./sewage-system.sh validate payload.json
./sewage-system.sh export <id>
```
