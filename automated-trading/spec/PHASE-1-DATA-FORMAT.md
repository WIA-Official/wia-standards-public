# Automated Trading — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for Automated Trading systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across management systems and technology platforms.
...
```json
{
  ...
  "title": "WIA Automated Trading Data Format",
  "type": "object",
  "required": ["standard", "version", "timestamp", "data"],
  "properties": {
    "standard": {
      "type": "string",
      "const": "automated-trading"
    },
    "version": {
      "type": "string",
      "pattern": "^\\d+\\.\\d+\\.\\d+$"
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (automated-trading) |
...
### 5.3 File Extensions
- `.wia-automated-trading.json` — JSON format
- `.wia-automated-trading.pb` — Protocol Buffers
