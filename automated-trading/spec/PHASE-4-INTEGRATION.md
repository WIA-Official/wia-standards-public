# Automated Trading — Phase 4: Integration Specification
...
Phase 4 defines integration patterns and requirements for deploying Automated Trading within existing infrastructure. This specification covers system architecture, integration patterns, testing requirements, and deployment guidelines for management systems and technology platforms.
...
- Implement the `WIAautomated_tradingAdapter` interface
...
```json
{
  ...
  "channels": [
    "automated-trading.data.ingested",
    "automated-trading.resource.updated",
    "automated-trading.alert.triggered"
  ]
}
```
...
```
WIA_STANDARD=automated-trading
WIA_VERSION=1.0.0
WIA_LOG_LEVEL=info
