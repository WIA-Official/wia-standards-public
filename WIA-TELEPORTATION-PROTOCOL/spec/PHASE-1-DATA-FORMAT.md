# Teleportation Protocol — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for Teleportation Protocol systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across teleportation systems and experimental platforms.
...
```json
{
  ...
  "title": "WIA Teleportation Protocol Data Format",
  "type": "object",
  "required": ["standard", "version", "timestamp", "data"],
  "properties": {
    "standard": {
      "type": "string",
      "const": "WIA-TELEPORTATION-PROTOCOL"
    },
    "version": {
      "type": "string",
      "pattern": "^\\d+\\.\\d+\\.\\d+$"
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (WIA-TELEPORTATION-PROTOCOL) |
...
### 5.3 File Extensions
- `.wia-teleportation-protoc.json` — JSON format
- `.wia-teleportation-protoc.pb` — Protocol Buffers
...
```json
{
  "standard": "WIA-TELEPORTATION-PROTOCOL",
  "version": "1.0.0",
