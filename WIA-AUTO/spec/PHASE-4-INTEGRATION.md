# Auto — Phase 4: Integration Specification
...
Phase 4 defines integration patterns and requirements for deploying Auto within existing infrastructure. This specification covers system architecture, integration patterns, testing requirements, and deployment guidelines for management systems and technology platforms.
...
- Implement the `WIAWIA_AUTOAdapter` interface
...
```json
{
  ...
  "channels": [
    "wia-auto.data.ingested",
    "wia-auto.resource.updated",
    "wia-auto.alert.triggered"
  ]
}
```
