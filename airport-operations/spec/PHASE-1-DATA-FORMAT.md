# Airport Operations — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for Airport Operations systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across AI service platforms and AI processing systems.
...
```json
{
  ...
  "title": "WIA Airport Operations Data Format",
  "type": "object",
  "required": ["standard", "version", "timestamp", "data"],
  "properties": {
    "standard": {
      "type": "string",
      "const": "airport-operations"
    },
    "version": {
      "type": "string",
      "pattern": "^\\d+\\.\\d+\\.\\d+$"
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (airport-operations) |
...
### 5.3 File Extensions
- `.wia-airport-operations.json` — JSON format
- `.wia-airport-operations.pb` — Protocol Buffers
