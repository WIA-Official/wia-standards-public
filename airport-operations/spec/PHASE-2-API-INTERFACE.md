# Airport Operations — Phase 2: API Interface Specification
...
Phase 2 defines RESTful API endpoints for interacting with Airport Operations services. This specification enables standardized programmatic access to AI model data across AI service platforms.

### 1.1 Base URL

```
Production: https://api.airport-operations.wia.org/v1
Sandbox:    https://sandbox.airport-operations.wia.org/v1
```
