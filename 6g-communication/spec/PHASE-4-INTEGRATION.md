# WIA-6g-communication PHASE 4 — INTEGRATION Specification
...
This document defines how a 6g-communication programme
...
`/.well-known/wia-6g-communication` that links to the API
...
date WIA-6g-communication MAY migrate historical records by
