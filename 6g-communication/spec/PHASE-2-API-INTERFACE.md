# WIA-6g-communication PHASE 2 — API-INTERFACE Specification

**Standard:** WIA-6g-communication
...
`urn:wia:6g-communication:status-transition`.
...
`422` with type
`urn:wia:6g-communication:source-mix-required`.
...
with type
`urn:wia:6g-communication:laboratory-not-accredited`.
...
`409` with type
`urn:wia:6g-communication:quality-certificate-required`.
...
- `urn:wia:6g-communication:hydrogen-quality-out-of-grade`
- `urn:wia:6g-communication:cryogenic-temperature-excursion`
- `urn:wia:6g-communication:guarantee-of-origin-mismatch`
- `urn:wia:6g-communication:evidence-mismatch`
