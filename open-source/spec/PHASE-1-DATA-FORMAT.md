# Open Source — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for Open Source systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across management systems and technology platforms.
...
```json
{
  ...
  "title": "WIA Open Source Data Format",
  "type": "object",
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (open-source) |
...
### 5.3 File Extensions
- `.wia-open-source.json` — JSON format
- `.wia-open-source.pb` — Protocol Buffers
