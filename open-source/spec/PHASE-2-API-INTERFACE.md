# Open Source — Phase 2: API Interface Specification
...
Phase 2 defines RESTful API endpoints for interacting with Open Source services. This specification enables standardized programmatic access to operational data across management systems.

### 1.1 Base URL

```
Production: https://api.open-source.wia.org/v1
Sandbox:    https://sandbox.open-source.wia.org/v1
```
