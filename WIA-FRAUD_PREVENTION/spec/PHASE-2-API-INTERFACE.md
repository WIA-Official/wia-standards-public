# Fraud Prevention — Phase 2: API Interface Specification
...
Phase 2 defines RESTful API endpoints for interacting with Fraud Prevention services. This specification enables standardized programmatic access to fraud detection data across risk assessment systems.

### 1.1 Base URL

```
Production: https://api.fraud-prevention.wia.org/v1
Sandbox:    https://sandbox.fraud-prevention.wia.org/v1
```
...
| Method | Endpoint | Description |
|--------|----------|-------------|
| POST | /data/ingest | Submit fraud detection data |
