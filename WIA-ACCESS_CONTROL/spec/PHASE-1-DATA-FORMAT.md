# Access Control — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for Access Control systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across management systems and technology platforms.
...
```json
{
  ...
  "title": "WIA Access Control Data Format",
  "type": "object",
  "required": ["standard", "version", "timestamp", "data"],
  "properties": {
    "standard": {
      "type": "string",
      "const": "WIA-ACCESS_CONTROL"
    },
    "version": {
      "type": "string",
      "pattern": "^\\d+\\.\\d+\\.\\d+$"
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (WIA-ACCESS_CONTROL) |
...
### 5.3 File Extensions
- `.wia-access-control.json` — JSON format
- `.wia-access-control.pb` — Protocol Buffers
