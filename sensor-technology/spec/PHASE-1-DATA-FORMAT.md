# Sensor Technology — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for Sensor Technology systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across sensor networks and measurement systems.
...
```json
{
  ...
  "title": "WIA Sensor Technology Data Format",
  "type": "object",
  "required": ["standard", "version", "timestamp", "data"],
  "properties": {
    "standard": {
      "type": "string",
      "const": "sensor-technology"
    },
    "version": {
      "type": "string",
      "pattern": "^\\d+\\.\\d+\\.\\d+$"
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (sensor-technology) |
...
### 5.3 File Extensions
- `.wia-sensor-technology.json` — JSON format
- `.wia-sensor-technology.pb` — Protocol Buffers
