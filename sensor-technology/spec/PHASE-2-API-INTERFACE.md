# Sensor Technology — Phase 2: API Interface Specification
...
Phase 2 defines RESTful API endpoints for interacting with Sensor Technology services. This specification enables standardized programmatic access to sensor readings across sensor networks.

### 1.1 Base URL

```
Production: https://api.sensor-technology.wia.org/v1
Sandbox:    https://sandbox.sensor-technology.wia.org/v1
```
