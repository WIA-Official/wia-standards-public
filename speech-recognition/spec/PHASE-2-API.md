# WIA-AI-ASR-001 — Phase 2: API

> Speech Recognition canonical Phase 2 specification per the WIA Standards four-Phase architecture.

> Domain: 음성 인식 — 음성→텍스트 · ASR · 단대단 · 다국어 · 접근성.

## A.1 Scope

This Phase covers the canonical api layer of the WIA-AI-ASR-001 standard. It composes with the Phase 3 document for cross-Phase integration and inherits cross-standard behaviour from the wider WIA Standards family per the README.md scope statement.
