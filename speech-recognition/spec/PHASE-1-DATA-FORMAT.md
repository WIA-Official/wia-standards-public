# WIA-AI-ASR-001 — Phase 1: DATA-FORMAT

> Speech Recognition canonical Phase 1 specification per the WIA Standards four-Phase architecture.

> Domain: 음성 인식 — 음성→텍스트 · ASR · 단대단 · 다국어 · 접근성.

## A.1 Scope

This Phase covers the canonical data-format layer of the WIA-AI-ASR-001 standard. It composes with the Phase 2 document for cross-Phase integration and inherits cross-standard behaviour from the wider WIA Standards family per the README.md scope statement.
...
with `wia.standard.slug` = `speech-recognition` and `wia.standard.phase` =
...
`/.well-known/wia-speech-recognition-capabilities` enumerating per-endpoint
