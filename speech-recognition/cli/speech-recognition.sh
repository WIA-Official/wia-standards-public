#!/usr/bin/env bash
# speech-recognition — Speech Recognition CLI helper.
#
# Sample envelope generators for the WIA-AI-ASR-001 standard.
# Requires: bash 4+, jq.
set -euo pipefail

STD_ID="WIA-AI-ASR-001"
...
cmd_refs() {
    cat <<REFS
Normative references for WIA-AI-ASR-001 (Speech Recognition):
