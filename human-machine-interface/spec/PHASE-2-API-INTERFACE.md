# Human Machine Interface — Phase 2: API Interface Specification
...
Phase 2 defines RESTful API endpoints for interacting with Human Machine Interface services. This specification enables standardized programmatic access to operational data across management systems.

### 1.1 Base URL

```
Production: https://api.human-machine-interf.wia.org/v1
Sandbox:    https://sandbox.human-machine-interf.wia.org/v1
```
