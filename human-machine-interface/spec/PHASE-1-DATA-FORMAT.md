# Human Machine Interface — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for Human Machine Interface systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across management systems and technology platforms.
...
```json
{
  ...
  "title": "WIA Human Machine Interface Data Format",
  "type": "object",
  "required": ["standard", "version", "timestamp", "data"],
  "properties": {
    "standard": {
      "type": "string",
      "const": "human-machine-interface"
    },
    "version": {
      "type": "string",
      "pattern": "^\\d+\\.\\d+\\.\\d+$"
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (human-machine-interface) |
...
### 5.3 File Extensions
- `.wia-human-machine-interf.json` — JSON format
- `.wia-human-machine-interf.pb` — Protocol Buffers
...
```json
{
  "standard": "human-machine-interface",
  "version": "1.0.0",
