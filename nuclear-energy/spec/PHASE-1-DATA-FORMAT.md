# Nuclear Energy — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for Nuclear Energy systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across power grid systems and energy infrastructure.
...
```json
{
  ...
  "title": "WIA Nuclear Energy Data Format",
  "type": "object",
  "required": ["standard", "version", "timestamp", "data"],
  "properties": {
    "standard": {
      "type": "string",
      "const": "nuclear-energy"
    },
    "version": {
      "type": "string",
      "pattern": "^\\d+\\.\\d+\\.\\d+$"
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (nuclear-energy) |
...
### 5.3 File Extensions
- `.wia-nuclear-energy.json` — JSON format
- `.wia-nuclear-energy.pb` — Protocol Buffers
