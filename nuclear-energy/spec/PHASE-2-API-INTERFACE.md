# Nuclear Energy — Phase 2: API Interface Specification
...
Phase 2 defines RESTful API endpoints for interacting with Nuclear Energy services. This specification enables standardized programmatic access to energy metrics across power grid systems.

### 1.1 Base URL

```
Production: https://api.nuclear-energy.wia.org/v1
Sandbox:    https://sandbox.nuclear-energy.wia.org/v1
```
