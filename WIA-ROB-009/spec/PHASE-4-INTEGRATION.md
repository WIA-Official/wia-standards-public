# WIA-ROB-009 PHASE 4 — INTEGRATION Specification
...
This document defines how a WIA-ROB-009 programme
...
`/.well-known/wia-WIA-ROB-009` that links to the API
...
date WIA-ROB-009 MAY migrate historical records by
