# Restaurant Tech — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for Restaurant Tech systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across POS systems and kitchen management platforms.
...
```json
{
  ...
  "title": "WIA Restaurant Tech Data Format",
  "type": "object",
  "required": ["standard", "version", "timestamp", "data"],
  "properties": {
    "standard": {
      "type": "string",
      "const": "restaurant-tech"
    },
    "version": {
      "type": "string",
      "pattern": "^\\d+\\.\\d+\\.\\d+$"
    ...
    "data": {
      "type": "object",
      "description": "Primary restaurant operations data payload"
    }
  }
}
```
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (restaurant-tech) |
...
| data | object | Yes | Domain-specific restaurant operations data |
...
### 5.3 File Extensions
- `.wia-restaurant-tech.json` — JSON format
- `.wia-restaurant-tech.pb` — Protocol Buffers
