# Restaurant Tech — Phase 2: API Interface Specification
...
Phase 2 defines RESTful API endpoints for interacting with Restaurant Tech services. This specification enables standardized programmatic access to restaurant operations data across POS systems.

### 1.1 Base URL

```
Production: https://api.restaurant-tech.wia.org/v1
Sandbox:    https://sandbox.restaurant-tech.wia.org/v1
```
...
| Method | Endpoint | Description |
|--------|----------|-------------|
| POST | /data/ingest | Submit restaurant operations data |
