# 3d Touch — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for 3d Touch systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across management systems and technology platforms.
...
```json
{
  ...
  "title": "WIA 3d Touch Data Format",
  "type": "object",
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (3d-touch) |
...
### 5.3 File Extensions
- `.wia-3d-touch.json` — JSON format
- `.wia-3d-touch.pb` — Protocol Buffers
