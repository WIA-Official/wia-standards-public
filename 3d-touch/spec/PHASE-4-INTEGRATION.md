# WIA-3d-touch PHASE 4 — INTEGRATION Specification
...
This document defines how a 3d-touch programme
...
`/.well-known/wia-3d-touch` that links to the API
...
date WIA-3d-touch MAY migrate historical records by
