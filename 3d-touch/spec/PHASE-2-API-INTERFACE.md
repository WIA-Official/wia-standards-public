# WIA-3d-touch PHASE 2 — API-INTERFACE Specification

**Standard:** WIA-3d-touch
...
`urn:wia:3d-touch:status-transition`.
...
`422` with type
`urn:wia:3d-touch:source-mix-required`.
...
with type
`urn:wia:3d-touch:laboratory-not-accredited`.
...
`409` with type
`urn:wia:3d-touch:quality-certificate-required`.
...
- `urn:wia:3d-touch:hydrogen-quality-out-of-grade`
- `urn:wia:3d-touch:cryogenic-temperature-excursion`
- `urn:wia:3d-touch:guarantee-of-origin-mismatch`
- `urn:wia:3d-touch:evidence-mismatch`
