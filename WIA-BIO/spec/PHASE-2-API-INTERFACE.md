# BIO — Phase 2: API Interface Specification
...
Phase 2 defines RESTful API endpoints for interacting with BIO services. This specification enables standardized programmatic access to biological data across biotech research platforms.

### 1.1 Base URL

```
Production: https://api.bio.wia.org/v1
Sandbox:    https://sandbox.bio.wia.org/v1
```
