# BIO — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for BIO systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across biotech research platforms and laboratory systems.
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (WIA-BIO) |
...
### 5.3 File Extensions
- `.wia-bio.json` — JSON format
- `.wia-bio.pb` — Protocol Buffers
