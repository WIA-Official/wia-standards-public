# WIA-ESPORTS Specification - PHASE 2
...
The WIA-ESPORTS standard supports multiple API paradigms:
...
```typescript
import { WIAEsports Industry StandardSDK } from '@wia/defi-sdk';

// Initialize SDK
const sdk = new WIAEsports Industry StandardSDK({
  apiKey: 'YOUR_API_KEY',
...
```python
from wia_defi import WIAEsports Industry StandardSDK

# Initialize SDK
sdk = WIAEsports Industry StandardSDK(api_key='YOUR_API_KEY', network='mainnet')
