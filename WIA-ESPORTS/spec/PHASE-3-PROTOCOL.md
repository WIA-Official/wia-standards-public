# WIA-ESPORTS PHASE 3 — PROTOCOL Specification
...
A WIA-ESPORTS operator MAY claim conformance to
WIA-ESPORTS only after the operating jurisdiction's
...
A programme conformant with WIA-ESPORTS publishes
