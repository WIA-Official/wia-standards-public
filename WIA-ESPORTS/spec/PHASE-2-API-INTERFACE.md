# WIA-ESPORTS PHASE 2 — API-INTERFACE Specification
...
`urn:wia:WIA-ESPORTS:status-transition`.
...
`422` with type
`urn:wia:WIA-ESPORTS:source-mix-required`.
...
with type
`urn:wia:WIA-ESPORTS:laboratory-not-accredited`.
...
`409` with type
`urn:wia:WIA-ESPORTS:quality-certificate-required`.
...
- `urn:wia:WIA-ESPORTS:hydrogen-quality-out-of-grade`
- `urn:wia:WIA-ESPORTS:cryogenic-temperature-excursion`
- `urn:wia:WIA-ESPORTS:guarantee-of-origin-mismatch`
- `urn:wia:WIA-ESPORTS:evidence-mismatch`
