# WIA-ESPORTS PHASE 4 — INTEGRATION Specification
...
This document defines how a WIA-ESPORTS programme
...
`/.well-known/wia-WIA-ESPORTS` that links to the API
...
date WIA-ESPORTS MAY migrate historical records by
