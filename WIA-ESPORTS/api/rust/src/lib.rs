//! # WIA-ESPORTS SDK for Rust
//!
//! A Rust SDK for interacting with the WIA-ESPORTS Standard API.
//!
...
//! - **API Client** - Easy-to-use client for WIA-ESPORTS API
...
pub use types::*;
pub use client::EsportsClient;
pub use error::{Error, Result};

/// SDK version
pub const VERSION: &str = env!("CARGO_PKG_VERSION");

/// WIA-ESPORTS Standard version
