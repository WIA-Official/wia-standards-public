...
- **Type-Safe**: Full TypeScript support with comprehensive type esportsnitions
...
```bash
npm install @wia/esports-sdk
# or
yarn add @wia/esports-sdk
# or
pnpm add @wia/esports-sdk
```

## Quick Start

```typescript
import { WIADeFiSDK } from '@wia/esports-sdk';
...
Get your API key at: https://api.wia-esports.org/register
...
- Documentation: https://docs.wia.org/esports-sdk
