# WIA-HEALTHCARE_INTEGRATION: Phase 2 - API Interface Specification
**Version:** 1.0
**Status:** Official
...
This document specifies the API interface requirements for HEALTHCARE INTEGRATION. All implementations MUST provide these endpoints to ensure interoperability.

## 2. REST API Endpoints

### 2.1 Base URL
```
https://api.wia.org/v1/wia-healthcare-integration/
```
...
```http
POST /v1/wia-healthcare-integration/records HTTP/1.1
...
### 3.1 Installation
```bash
npm install @wia/wia-healthcare-integration-sdk
```
...
### 3.3 Usage Example
```typescript
import { createClient } from '@wia/wia-healthcare-integration-sdk';
