# WIA-FINANCIAL_FRAUD_DETECTION Rust SDK

> **弘益人間 (Benefit All Humanity)**

Official Rust SDK for the WIA-FINANCIAL_FRAUD_DETECTION Standard.
...
```toml
[dependencies]
wia-financial-fraud-detection-sdk = "1.0"
...
- ✅ **Data Validation** - Validate data against WIA-FINANCIAL_FRAUD_DETECTION standards
...
```rust
use wia_financial_fraud_detection_sdk::CreateFinancialFraudDetectionRequest;
...
```rust
use wia_financial_fraud_detection_sdk::ListParams;
...
```rust
use wia_financial_fraud_detection_sdk::Error;
...
- Documentation: https://docs.wiastandards.com/WIA-FINANCIAL_FRAUD_DETECTION
