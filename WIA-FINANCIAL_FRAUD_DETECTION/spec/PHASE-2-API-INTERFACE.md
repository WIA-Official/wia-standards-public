# WIA-FINANCIAL_FRAUD_DETECTION PHASE 2 — API-INTERFACE Specification
...
`urn:wia:WIA-FINANCIAL_FRAUD_DETECTION:status-transition`.
...
`422` with type
`urn:wia:WIA-FINANCIAL_FRAUD_DETECTION:source-mix-required`.
...
with type
`urn:wia:WIA-FINANCIAL_FRAUD_DETECTION:laboratory-not-accredited`.
...
`409` with type
`urn:wia:WIA-FINANCIAL_FRAUD_DETECTION:quality-certificate-required`.
...
- `urn:wia:WIA-FINANCIAL_FRAUD_DETECTION:hydrogen-quality-out-of-grade`
- `urn:wia:WIA-FINANCIAL_FRAUD_DETECTION:cryogenic-temperature-excursion`
- `urn:wia:WIA-FINANCIAL_FRAUD_DETECTION:guarantee-of-origin-mismatch`
- `urn:wia:WIA-FINANCIAL_FRAUD_DETECTION:evidence-mismatch`
