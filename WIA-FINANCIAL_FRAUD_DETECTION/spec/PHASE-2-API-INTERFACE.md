# Financial Fraud Detection — Phase 2: API Interface Specification
...
Phase 2 defines RESTful API endpoints for interacting with Financial Fraud Detection services. This specification enables standardized programmatic access to financial transaction data across banking systems.

### 1.1 Base URL

```
Production: https://api.financial-fraud-dete.wia.org/v1
Sandbox:    https://sandbox.financial-fraud-dete.wia.org/v1
```
...
| Method | Endpoint | Description |
|--------|----------|-------------|
| POST | /data/ingest | Submit financial transaction data |
