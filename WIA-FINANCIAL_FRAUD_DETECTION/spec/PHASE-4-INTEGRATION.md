# WIA-FINANCIAL_FRAUD_DETECTION PHASE 4 — INTEGRATION Specification
...
This document defines how a WIA-FINANCIAL_FRAUD_DETECTION programme
...
`/.well-known/wia-WIA-FINANCIAL_FRAUD_DETECTION` that links to the API
...
date WIA-FINANCIAL_FRAUD_DETECTION MAY migrate historical records by
