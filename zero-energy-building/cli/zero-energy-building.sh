#!/usr/bin/env bash
# zero-energy-building — Zero Energy Building CLI helper.
#
# Sample envelope generators for the WIA-ENE-031 standard.
# Requires: bash 4+, jq.
set -euo pipefail
...
cmd_refs() {
    cat <<REFS
Normative references for WIA-ENE-031 (Zero Energy Building):
