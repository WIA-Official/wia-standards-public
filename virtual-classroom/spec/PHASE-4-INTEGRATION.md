# WIA-EDU-006 — Phase 4: INTEGRATION

> Virtual Classroom canonical Phase 4 specification per the WIA Standards four-Phase architecture.

> Domain: 가상 교실 — 원격 교육 · LMS · LRS · LTI · WebRTC · 접근성.

## A.1 Scope

This Phase covers the canonical integration layer of the WIA-EDU-006 standard. It composes with the Phase 1 document for cross-Phase integration and inherits cross-standard behaviour from the wider WIA Standards family per the README.md scope statement.
