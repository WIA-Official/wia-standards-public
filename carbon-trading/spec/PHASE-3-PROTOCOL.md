# WIA-FIN-025 PHASE 3 — Protocol

**Standard:** WIA-FIN-025 Carbon Trading
**Phase:** 3 — Protocol
**Version:** 1.0
**Status:** Stable
**Source:** consolidated from `spec/v2.0.md` §5–§7 (Quality Scoring,
Blockchain Integration, Article 6 Compliance)

This document defines the protocols that connect WIA-FIN-025 to its
downstream peers: an automated quality-scoring framework, a blockchain
event protocol for credit lifecycle anchoring, and the message schema
required for Article 6 of the Paris Agreement international transfers.
