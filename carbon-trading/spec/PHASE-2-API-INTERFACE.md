# WIA-FIN-025 PHASE 2 — API Interface

**Standard:** WIA-FIN-025 Carbon Trading
**Phase:** 2 — API Interface
**Version:** 1.0
**Status:** Stable
**Source:** consolidated from `spec/v2.0.md` §4 (API v2.0 Endpoints)

This document defines the REST and WebSocket interfaces for WIA-FIN-025
v2.0 implementations. The API is documented in OpenAPI 3.1 and the
real-time channels are documented as AsyncAPI 2.6 (a complementary
specification owned by the Linux Foundation). Authentication uses
OAuth 2.1 (RFC 9700) with mTLS for institutional callers.
