# WIA-FIN-025 PHASE 4 — Integration

**Standard:** WIA-FIN-025 Carbon Trading
**Phase:** 4 — Integration
**Version:** 1.0
**Status:** Stable
**Source:** consolidated from `spec/v2.0.md` §2 (Enhanced Architecture),
§8 (Security), §9 (Performance Requirements), §10 (Migration from v1.x)

This document defines the architecture, security, performance, and
migration concerns for WIA-FIN-025 implementations. Topics include the
four-layer reference architecture, the security baseline (OAuth 2.1,
TLS 1.3, ISO/IEC 27001 control mapping), the performance envelope, and
the version-migration procedure from v1.x.
