# WIA-LANG-006 PHASE 4 — INTEGRATION Specification
...
This document defines how a WIA-LANG-006 programme
...
`/.well-known/wia-WIA-LANG-006` that links to the API
...
date WIA-LANG-006 MAY migrate historical records by
