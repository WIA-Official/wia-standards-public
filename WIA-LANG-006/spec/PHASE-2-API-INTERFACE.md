# WIA-LANG-006 PHASE 2 — API-INTERFACE Specification
...
`urn:wia:WIA-LANG-006:status-transition`.
...
`422` with type
`urn:wia:WIA-LANG-006:source-mix-required`.
...
with type
`urn:wia:WIA-LANG-006:laboratory-not-accredited`.
...
`409` with type
`urn:wia:WIA-LANG-006:quality-certificate-required`.
...
- `urn:wia:WIA-LANG-006:hydrogen-quality-out-of-grade`
- `urn:wia:WIA-LANG-006:cryogenic-temperature-excursion`
- `urn:wia:WIA-LANG-006:guarantee-of-origin-mismatch`
- `urn:wia:WIA-LANG-006:evidence-mismatch`
