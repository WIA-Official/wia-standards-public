# 🏛️ WIA-ART-011: Virtual Exhibition Standard
...
cd wia-standards/standards/WIA-ART-011-virtual-exhibition
```
...
Virtual gallery and exhibition platform standards
...
- **Standardized Formats**: Universal data formats for virtual exhibition
...
Standardized formats for virtual exhibition assets ensuring compatibility and preservation.
...
```typescript
import { VirtualExhibitionSDK } from '@wia/art-011';

const sdk = new VirtualExhibitionSDK({
  apiKey: 'your-api-key'
});
...
```bash
# Create new asset
wia-art-011 create --title "My Asset"

# Validate asset
wia-art-011 validate asset.json

# Export asset
wia-art-011 export --format json
```

### TypeScript SDK

```bash
npm install @wia/art-011
```
