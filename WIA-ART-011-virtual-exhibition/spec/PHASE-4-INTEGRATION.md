# WIA-ART-011: Phase 4 - Integration Specification
**Version:** 1.0
**Status:** Official
...
Integration guidelines for WIA-ART-011 Virtual Exhibition Standard.

## 2. Platform Integration

### 2.1 Web Applications
```html
<script src="https://cdn.wia.org/art-011/v1/wia-art-011.js"></script>
<script>
  const sdk = new WIAART011({
    apiKey: 'your-api-key'
  });
</script>
```
...
let sdk = WIAART011(apiKey: "your-api-key")
```

### 2.3 Server-Side Integration
```python
from wia_art_011 import SDK
