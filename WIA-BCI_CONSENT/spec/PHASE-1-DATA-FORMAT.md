# BCI Consent — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for BCI Consent systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across management systems and technology platforms.
...
```json
{
  ...
  "title": "WIA BCI Consent Data Format",
  "type": "object",
  "required": ["standard", "version", "timestamp", "data"],
  "properties": {
    "standard": {
      "type": "string",
      "const": "WIA-BCI_CONSENT"
    },
    "version": {
      "type": "string",
      "pattern": "^\\d+\\.\\d+\\.\\d+$"
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (WIA-BCI_CONSENT) |
...
### 5.3 File Extensions
- `.wia-bci-consent.json` — JSON format
- `.wia-bci-consent.pb` — Protocol Buffers
