# BCI Consent — Phase 4: Integration Specification
...
Phase 4 defines integration patterns and requirements for deploying BCI Consent within existing infrastructure. This specification covers system architecture, integration patterns, testing requirements, and deployment guidelines for management systems and technology platforms.
...
- Implement the `WIAWIA_BCI_CONSENTAdapter` interface
...
```json
{
  ...
  "channels": [
    "wia-bci_consent.data.ingested",
    "wia-bci_consent.resource.updated",
    "wia-bci_consent.alert.triggered"
  ]
}
```
