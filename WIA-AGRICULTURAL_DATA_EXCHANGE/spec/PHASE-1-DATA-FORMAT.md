# Agricultural Data Exchange — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for Agricultural Data Exchange systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across farm management systems and agricultural equipment.
...
```json
{
  ...
  "title": "WIA Agricultural Data Exchange Data Format",
  "type": "object",
  "required": ["standard", "version", "timestamp", "data"],
  "properties": {
    "standard": {
      "type": "string",
      "const": "WIA-AGRICULTURAL_DATA_EXCHANGE"
    },
    "version": {
      "type": "string",
      "pattern": "^\\d+\\.\\d+\\.\\d+$"
    ...
    "data": {
      "type": "object",
      "description": "Primary agricultural data payload"
    }
  }
}
```
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (WIA-AGRICULTURAL_DATA_EXCHANGE) |
...
| data | object | Yes | Domain-specific agricultural data |
...
### 5.3 File Extensions
- `.wia-agricultural-data-ex.json` — JSON format
- `.wia-agricultural-data-ex.pb` — Protocol Buffers
...
```json
{
  "standard": "WIA-AGRICULTURAL_DATA_EXCHANGE",
  "version": "1.0.0",
