# Agricultural Data Exchange — Phase 2: API Interface Specification
...
Phase 2 defines RESTful API endpoints for interacting with Agricultural Data Exchange services. This specification enables standardized programmatic access to agricultural data across farm management systems.

### 1.1 Base URL

```
Production: https://api.agricultural-data-ex.wia.org/v1
Sandbox:    https://sandbox.agricultural-data-ex.wia.org/v1
```
...
| Method | Endpoint | Description |
|--------|----------|-------------|
| POST | /data/ingest | Submit agricultural data |
