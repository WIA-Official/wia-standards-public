# Blockchain Interop — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for Blockchain Interop systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across distributed ledger networks and blockchain nodes.
...
```json
{
  ...
  "title": "WIA Blockchain Interop Data Format",
  "type": "object",
  "required": ["standard", "version", "timestamp", "data"],
  "properties": {
    "standard": {
      "type": "string",
      "const": "WIA-BLOCKCHAIN-INTEROP"
    },
    "version": {
      "type": "string",
      "pattern": "^\\d+\\.\\d+\\.\\d+$"
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (WIA-BLOCKCHAIN-INTEROP) |
...
### 5.3 File Extensions
- `.wia-blockchain-interop.json` — JSON format
- `.wia-blockchain-interop.pb` — Protocol Buffers
...
```json
{
  "standard": "WIA-BLOCKCHAIN-INTEROP",
  "version": "1.0.0",
