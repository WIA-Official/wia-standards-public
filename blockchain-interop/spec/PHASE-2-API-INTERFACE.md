# Blockchain Interop — Phase 2: API Interface Specification
...
Phase 2 defines RESTful API endpoints for interacting with Blockchain Interop services. This specification enables standardized programmatic access to blockchain records across distributed ledger networks.

### 1.1 Base URL

```
Production: https://api.blockchain-interop.wia.org/v1
Sandbox:    https://sandbox.blockchain-interop.wia.org/v1
```
