# Blockchain Interop — Phase 4: Integration Specification
...
Phase 4 defines integration patterns and requirements for deploying Blockchain Interop within existing infrastructure. This specification covers system architecture, integration patterns, testing requirements, and deployment guidelines for distributed ledger networks and blockchain nodes.
...
- Implement the `WIAWIA_BLOCKCHAIN_INTEROPAdapter` interface
...
```json
{
  ...
  "channels": [
    "wia-blockchain-interop.data.ingested",
    "wia-blockchain-interop.resource.updated",
    "wia-blockchain-interop.alert.triggered"
  ]
}
```
...
```
WIA_STANDARD=WIA-BLOCKCHAIN-INTEROP
WIA_VERSION=1.0.0
WIA_LOG_LEVEL=info
