# WIA-css PHASE 3 — PROTOCOL Specification
...
A css operator MAY claim conformance to
WIA-css only after the operating jurisdiction's
...
A programme conformant with WIA-css publishes
