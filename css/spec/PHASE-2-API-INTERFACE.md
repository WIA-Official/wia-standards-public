# WIA-css PHASE 2 — API-INTERFACE Specification
...
`422` with type
`urn:wia:css:source-mix-required`.
...
with type
`urn:wia:css:laboratory-not-accredited`.
...
`409` with type
`urn:wia:css:quality-certificate-required`.
...
- `urn:wia:css:hydrogen-quality-out-of-grade`
- `urn:wia:css:cryogenic-temperature-excursion`
- `urn:wia:css:guarantee-of-origin-mismatch`
- `urn:wia:css:evidence-mismatch`
