...
/**
 * WIA-HERITAGE-007 SDK Client
 */
export class WIAHeritage007 {
  private config: WIAHeritage007Config;
  private endpoint: string;

  constructor(config: WIAHeritage007Config) {
    this.config = {
