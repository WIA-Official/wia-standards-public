# Semiconductor Packaging — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for Semiconductor Packaging systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across fabrication systems and testing platforms.
...
```json
{
  ...
  "title": "WIA Semiconductor Packaging Data Format",
  "type": "object",
  "required": ["standard", "version", "timestamp", "data"],
  "properties": {
    "standard": {
      "type": "string",
      "const": "semiconductor-packaging"
    },
    "version": {
      "type": "string",
      "pattern": "^\\d+\\.\\d+\\.\\d+$"
    ...
    "data": {
      "type": "object",
      "description": "Primary semiconductor data payload"
    }
  }
}
```
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (semiconductor-packaging) |
...
| data | object | Yes | Domain-specific semiconductor data |
...
### 5.3 File Extensions
- `.wia-semiconductor-packag.json` — JSON format
- `.wia-semiconductor-packag.pb` — Protocol Buffers
