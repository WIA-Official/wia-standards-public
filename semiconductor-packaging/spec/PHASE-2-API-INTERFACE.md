# PHASE 2 — API INTERFACE · semiconductor-packaging
**Version:** 1.0
**Status:** Active
...
This Phase defines the API INTERFACE layer of the *semiconductor-packaging* WIA standard.
...
in lockstep across Phases 1–4 of semiconductor-packaging so that conformance claims at any
