# Wireless Charging — Phase 2: API Interface Specification
...
Phase 2 defines RESTful API endpoints for interacting with Wireless Charging services. This specification enables standardized programmatic access to wireless signal data across radio communication systems.

### 1.1 Base URL

```
Production: https://api.wireless-charging.wia.org/v1
Sandbox:    https://sandbox.wireless-charging.wia.org/v1
```
