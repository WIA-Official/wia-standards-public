# Wireless Charging — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for Wireless Charging systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across radio communication systems and wireless networks.
...
```json
{
  ...
  "title": "WIA Wireless Charging Data Format",
  "type": "object",
  "required": ["standard", "version", "timestamp", "data"],
  "properties": {
    "standard": {
      "type": "string",
      "const": "WIA-WIRELESS-CHARGING"
    },
    "version": {
      "type": "string",
      "pattern": "^\\d+\\.\\d+\\.\\d+$"
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (WIA-WIRELESS-CHARGING) |
...
### 5.3 File Extensions
- `.wia-wireless-charging.json` — JSON format
- `.wia-wireless-charging.pb` — Protocol Buffers
...
```json
{
  "standard": "WIA-WIRELESS-CHARGING",
  "version": "1.0.0",
