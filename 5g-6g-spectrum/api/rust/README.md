# 5g-6g-spectrum Rust SDK

> **弘益人間 (Benefit All Humanity)**

Official Rust SDK for the 5g-6g-spectrum Standard.
...
```rust
use 5g_6g_spectrum_sdk::CreateFiveGSixGSpectrumRequest;
...
```rust
use 5g_6g_spectrum_sdk::ListParams;
...
- Documentation: https://docs.wiastandards.com/5g-6g-spectrum
