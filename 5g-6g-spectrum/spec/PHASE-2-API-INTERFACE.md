# 5G 6G Spectrum — Phase 2: API Interface Specification
...
Phase 2 defines RESTful API endpoints for interacting with 5G 6G Spectrum services. This specification enables standardized programmatic access to operational data across management systems.

### 1.1 Base URL

```
Production: https://api.5g-6g-spectrum.wia.org/v1
Sandbox:    https://sandbox.5g-6g-spectrum.wia.org/v1
```
