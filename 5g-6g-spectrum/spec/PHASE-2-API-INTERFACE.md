# WIA-5g-6g-spectrum PHASE 2 — API-INTERFACE Specification

**Standard:** WIA-5g-6g-spectrum
...
`urn:wia:5g-6g-spectrum:status-transition`.
...
`422` with type
`urn:wia:5g-6g-spectrum:source-mix-required`.
...
with type
`urn:wia:5g-6g-spectrum:laboratory-not-accredited`.
...
`409` with type
`urn:wia:5g-6g-spectrum:quality-certificate-required`.
...
- `urn:wia:5g-6g-spectrum:hydrogen-quality-out-of-grade`
- `urn:wia:5g-6g-spectrum:cryogenic-temperature-excursion`
- `urn:wia:5g-6g-spectrum:guarantee-of-origin-mismatch`
- `urn:wia:5g-6g-spectrum:evidence-mismatch`
