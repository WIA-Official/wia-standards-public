# 5G 6G Spectrum — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for 5G 6G Spectrum systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across management systems and technology platforms.
...
```json
{
  ...
  "title": "WIA 5G 6G Spectrum Data Format",
  "type": "object",
  "required": ["standard", "version", "timestamp", "data"],
  "properties": {
    "standard": {
      "type": "string",
      "const": "5g-6g-spectrum"
    },
    "version": {
      "type": "string",
      "pattern": "^\\d+\\.\\d+\\.\\d+$"
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (5g-6g-spectrum) |
...
### 5.3 File Extensions
- `.wia-5g-6g-spectrum.json` — JSON format
- `.wia-5g-6g-spectrum.pb` — Protocol Buffers
