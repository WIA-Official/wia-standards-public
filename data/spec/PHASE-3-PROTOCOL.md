# WIA-data PHASE 3 — PROTOCOL Specification
...
A data operator MAY claim conformance to
WIA-data only after the operating jurisdiction's
...
A programme conformant with WIA-data publishes
