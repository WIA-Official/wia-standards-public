# Anti Gravity — Phase 2: API Interface Specification
...
Phase 2 defines RESTful API endpoints for interacting with Anti Gravity services. This specification enables standardized programmatic access to gravitational field data across propulsion systems.

### 1.1 Base URL

```
Production: https://api.anti-gravity.wia.org/v1
Sandbox:    https://sandbox.anti-gravity.wia.org/v1
```
...
| Method | Endpoint | Description |
|--------|----------|-------------|
| POST | /data/ingest | Submit gravitational field data |
