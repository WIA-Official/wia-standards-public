#!/usr/bin/env bash
# robot-safety — Robot Safety CLI helper.
#
# Sample envelope generators for the WIA-ROBOT-SAFETY-001 standard.
# Requires: bash 4+, jq.
set -euo pipefail

STD_ID="WIA-ROBOT-SAFETY-001"
SLUG="robot-safety"
...
cmd_refs() {
    cat <<REFS
Normative references for WIA-ROBOT-SAFETY-001 (Robot Safety):
