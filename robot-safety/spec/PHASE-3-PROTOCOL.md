# WIA-ROBOT-SAFETY-001 — Phase 3: PROTOCOL

> Robot Safety canonical Phase 3 specification per the WIA Standards four-Phase architecture.

> Domain: 로봇 안전 — 로봇 안전 · ISO 10218 · 협동 로봇 · 안전 정격 모니터링 정지.

## A.1 Scope

This Phase covers the canonical protocol layer of the WIA-ROBOT-SAFETY-001 standard. It composes with the Phase 4 document for cross-Phase integration and inherits cross-standard behaviour from the wider WIA Standards family per the README.md scope statement.
