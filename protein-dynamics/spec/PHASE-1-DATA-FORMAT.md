# Protein Dynamics — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for Protein Dynamics systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across management systems and technology platforms.
...
```json
{
  ...
  "title": "WIA Protein Dynamics Data Format",
  "type": "object",
  "required": ["standard", "version", "timestamp", "data"],
  "properties": {
    "standard": {
      "type": "string",
      "const": "protein-dynamics"
    },
    "version": {
      "type": "string",
      "pattern": "^\\d+\\.\\d+\\.\\d+$"
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (protein-dynamics) |
...
### 5.3 File Extensions
- `.wia-protein-dynamics.json` — JSON format
- `.wia-protein-dynamics.pb` — Protocol Buffers
