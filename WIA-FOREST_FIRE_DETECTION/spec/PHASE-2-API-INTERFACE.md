# Forest Fire Detection — Phase 2: API Interface Specification
...
Phase 2 defines RESTful API endpoints for interacting with Forest Fire Detection services. This specification enables standardized programmatic access to thermal imaging data across fire alert systems.

### 1.1 Base URL

```
Production: https://api.forest-fire-detectio.wia.org/v1
Sandbox:    https://sandbox.forest-fire-detectio.wia.org/v1
```
...
| Method | Endpoint | Description |
|--------|----------|-------------|
| POST | /data/ingest | Submit thermal imaging data |
