 ...
 *
 * Comprehensive INSURTECH SDK supporting:
...
export class WIAINSURTECHSDK {
  ...
  constructor(config: SDKConfig) {
    this.config = {
      ...
      baseURL: config.baseURL || 'https://api.wia-insurtech.org/v1',
  ...
  /**
   * Get all supported INSURTECH protocols
 ...
 * Create SDK instance
 */
export function createWIAINSURTECHSDK(config: SDKConfig): WIAINSURTECHSDK {
  return new WIAINSURTECHSDK(config);
}

/**
 * Default export
 */
export default WIAINSURTECHSDK;
