# WIA-INSURTECH Rust SDK

> **弘益人間 (Benefit All Humanity)**

Official Rust SDK for the WIA-INSURTECH Standard.
...
```rust
use wia_insurtech_sdk::CreateInsurtechRequest;
...
```rust
use wia_insurtech_sdk::ListParams;
...
- Documentation: https://docs.wiastandards.com/WIA-INSURTECH
