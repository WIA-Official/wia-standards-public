# WIA-INSURTECH Specification - PHASE 2
...
The WIA-INSURTECH standard supports multiple API paradigms:
...
```typescript
import { WIAInsurance TechnologySDK } from '@wia/defi-sdk';

// Initialize SDK
const sdk = new WIAInsurance TechnologySDK({
  apiKey: 'YOUR_API_KEY',
...
```python
from wia_defi import WIAInsurance TechnologySDK

# Initialize SDK
sdk = WIAInsurance TechnologySDK(api_key='YOUR_API_KEY', network='mainnet')
