...
`urn:wia:WIA-INSURTECH:status-transition`.
...
`422` with type
`urn:wia:WIA-INSURTECH:source-mix-required`.
...
with type
`urn:wia:WIA-INSURTECH:laboratory-not-accredited`.
...
`409` with type
`urn:wia:WIA-INSURTECH:quality-certificate-required`.
...
- `urn:wia:WIA-INSURTECH:hydrogen-quality-out-of-grade`
- `urn:wia:WIA-INSURTECH:cryogenic-temperature-excursion`
- `urn:wia:WIA-INSURTECH:guarantee-of-origin-mismatch`
- `urn:wia:WIA-INSURTECH:evidence-mismatch`
