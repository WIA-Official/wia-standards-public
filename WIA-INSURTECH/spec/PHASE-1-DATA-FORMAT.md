# Insurtech — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for Insurtech systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across management systems and technology platforms.
...
```json
{
  ...
  "title": "WIA Insurtech Data Format",
  "type": "object",
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (WIA-INSURTECH) |
...
### 5.3 File Extensions
- `.wia-insurtech.json` — JSON format
- `.wia-insurtech.pb` — Protocol Buffers
