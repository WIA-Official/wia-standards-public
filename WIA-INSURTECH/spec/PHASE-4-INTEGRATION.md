...
This document defines how a WIA-INSURTECH programme
...
`/.well-known/wia-WIA-INSURTECH` that links to the API
...
date WIA-INSURTECH MAY migrate historical records by
