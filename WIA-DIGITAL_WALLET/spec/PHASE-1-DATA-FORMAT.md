# WIA-DIGITAL_WALLET: Phase 1 - Data Format Specification
**Version:** 1.0
**Status:** Official
...
This document specifies the data format requirements for DIGITAL WALLET. All implementations MUST follow these specifications to ensure interoperability across systems.
...
```json
{
  ...
  "properties": {
    "type": { "type": "string", "const": "WIA-DIGITAL_WALLETRecord" },
