# WIA-glacier-preservation Glacier Preservation

> Cross-vendor data and protocol layer for Glacier Preservation.

## Overview

WIA-glacier-preservation defines standardized data formats and protocol semantics for
Glacier Preservation. The standard exposes four PHASE documents covering data
...
```bash
npm install @wia/glacier-preservation
```

```typescript
import { Client } from '@wia/glacier-preservation';
const client = new Client({ baseUrl: 'https://api.example.com/wia-glacier-preservation' });
