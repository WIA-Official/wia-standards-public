# PHASE 2 — API INTERFACE · space-station
**Version:** 1.0
**Status:** Active
...
This Phase defines the API INTERFACE layer of the *space-station* WIA standard.
...
in lockstep across Phases 1–4 of space-station so that conformance claims at any
