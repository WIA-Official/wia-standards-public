# Carbon Capture — Phase 2: API Interface Specification
...
Phase 2 defines RESTful API endpoints for interacting with Carbon Capture services. This specification enables standardized programmatic access to carbon emissions data across carbon tracking systems.

### 1.1 Base URL

```
Production: https://api.carbon-capture.wia.org/v1
Sandbox:    https://sandbox.carbon-capture.wia.org/v1
```
