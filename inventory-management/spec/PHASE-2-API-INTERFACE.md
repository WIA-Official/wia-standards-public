# Inventory Management — Phase 2: API Interface Specification
...
Phase 2 defines RESTful API endpoints for interacting with Inventory Management services. This specification enables standardized programmatic access to operational data across management systems.

### 1.1 Base URL

```
Production: https://api.inventory-management.wia.org/v1
Sandbox:    https://sandbox.inventory-management.wia.org/v1
```
