# Fashion Tech — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for Fashion Tech systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across fashion tech platforms and manufacturing systems.
...
```json
{
  ...
  "title": "WIA Fashion Tech Data Format",
  "type": "object",
  ...
  "properties": {
    ...
    "data": {
      "type": "object",
      "description": "Primary design and fit data payload"
    }
  }
}
```
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (fashion-tech) |
...
| data | object | Yes | Domain-specific design and fit data |
...
### 5.3 File Extensions
- `.wia-fashion-tech.json` — JSON format
- `.wia-fashion-tech.pb` — Protocol Buffers
