# Fashion Tech — Phase 2: API Interface Specification
...
Phase 2 defines RESTful API endpoints for interacting with Fashion Tech services. This specification enables standardized programmatic access to design and fit data across fashion tech platforms.

### 1.1 Base URL

```
Production: https://api.fashion-tech.wia.org/v1
Sandbox:    https://sandbox.fashion-tech.wia.org/v1
```
...
| Method | Endpoint | Description |
|--------|----------|-------------|
| POST | /data/ingest | Submit design and fit data |
