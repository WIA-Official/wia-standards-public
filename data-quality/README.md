...
> Cross-vendor data and protocol layer for Data Quality.

## Overview

WIA Data Quality defines standardized data formats and protocol semantics.
...
issues with the `data-quality` label. The WIA Standards working group
