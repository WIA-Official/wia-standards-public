# Dark Matter Detection — Phase 2: API Interface Specification
...
Phase 2 defines RESTful API endpoints for interacting with Dark Matter Detection services. This specification enables standardized programmatic access to operational data across management systems.

### 1.1 Base URL

```
Production: https://api.dark-matter-detectio.wia.org/v1
Sandbox:    https://sandbox.dark-matter-detectio.wia.org/v1
```
