# Dark Matter Detection — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for Dark Matter Detection systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across management systems and technology platforms.
...
```json
{
  ...
  "title": "WIA Dark Matter Detection Data Format",
  "type": "object",
  "required": ["standard", "version", "timestamp", "data"],
  "properties": {
    "standard": {
      "type": "string",
      "const": "dark-matter-detection"
    },
    "version": {
      "type": "string",
      "pattern": "^\\d+\\.\\d+\\.\\d+$"
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (dark-matter-detection) |
...
### 5.3 File Extensions
- `.wia-dark-matter-detectio.json` — JSON format
- `.wia-dark-matter-detectio.pb` — Protocol Buffers
...
```json
{
  "standard": "dark-matter-detection",
  "version": "1.0.0",
