# WIA-components PHASE 3 — PROTOCOL Specification
...
A components operator MAY claim conformance to
WIA-components only after the operating jurisdiction's
...
A programme conformant with WIA-components publishes
