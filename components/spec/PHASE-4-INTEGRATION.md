# WIA-components PHASE 4 — INTEGRATION Specification
...
This document defines how a components programme
...
`/.well-known/wia-components` that links to the API
...
date WIA-components MAY migrate historical records by
