...
This document defines how a WIA-HERITAGE-003 programme
...
`/.well-known/wia-WIA-HERITAGE-003` that links to the API
...
date WIA-HERITAGE-003 MAY migrate historical records by
