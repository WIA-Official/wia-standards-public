# Fleet Management — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for Fleet Management systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across management systems and technology platforms.
...
```json
{
  ...
  "title": "WIA Fleet Management Data Format",
  "type": "object",
  "required": ["standard", "version", "timestamp", "data"],
  "properties": {
    "standard": {
      "type": "string",
      "const": "WIA-FLEET_MANAGEMENT"
    },
    "version": {
      "type": "string",
      "pattern": "^\\d+\\.\\d+\\.\\d+$"
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (WIA-FLEET_MANAGEMENT) |
...
### 5.3 File Extensions
- `.wia-fleet-management.json` — JSON format
- `.wia-fleet-management.pb` — Protocol Buffers
