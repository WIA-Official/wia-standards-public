# Battery Passport — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for Battery Passport systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across sports analytics platforms and sports equipment.
...
```json
{
  ...
  "title": "WIA Battery Passport Data Format",
  "type": "object",
  "required": ["standard", "version", "timestamp", "data"],
  "properties": {
    "standard": {
      "type": "string",
      "const": "WIA-BATTERY_PASSPORT"
    },
    "version": {
      "type": "string",
      "pattern": "^\\d+\\.\\d+\\.\\d+$"
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (WIA-BATTERY_PASSPORT) |
...
### 5.3 File Extensions
- `.wia-battery-passport.json` — JSON format
- `.wia-battery-passport.pb` — Protocol Buffers
