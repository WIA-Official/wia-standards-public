# Battery Passport — Phase 2: API Interface Specification
...
Phase 2 defines RESTful API endpoints for interacting with Battery Passport services. This specification enables standardized programmatic access to athletic performance data across sports analytics platforms.

### 1.1 Base URL

```
Production: https://api.battery-passport.wia.org/v1
Sandbox:    https://sandbox.battery-passport.wia.org/v1
```
