...
Minimal POSIX shell client that demonstrates the WIA `insurtech` standard's
...
```sh
export WIA_API_BASE="https://insurtech.example.com/api/v1"
export WIA_API_TOKEN="<your-bearer-token>"
./insurtech.sh list
./insurtech.sh get <id>
./insurtech.sh create payload.json
./insurtech.sh validate payload.json
./insurtech.sh export <id>
```
