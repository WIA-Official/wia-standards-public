# Travel Tech — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for Travel Tech systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across management systems and technology platforms.
...
```json
{
  ...
  "title": "WIA Travel Tech Data Format",
  "type": "object",
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (travel-tech) |
...
### 5.3 File Extensions
- `.wia-travel-tech.json` — JSON format
- `.wia-travel-tech.pb` — Protocol Buffers
