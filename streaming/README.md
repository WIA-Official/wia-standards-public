# WIA-MEDIA-001 — Streaming

> 스트리밍 표준 — 미디어 스트리밍 · ABR · 저지연 · CDN · DRM
...
streaming hosts that need to interoperate across
...
1. MPEG-DASH per ISO/IEC 23009-1
2. HLS per RFC 8216bis
3. CMAF per ISO/IEC 23000-19
4. Adaptive Bitrate Algorithms
5. DRM per W3C EME and CENC
6. Server-Side Ad Insertion (SSAI)
7. Low-Latency Live (LL-HLS / DASH-LL)
8. Origin / CDN Architecture

## CLI

A POSIX shell helper is published at `cli/streaming.sh`. The helper ships
