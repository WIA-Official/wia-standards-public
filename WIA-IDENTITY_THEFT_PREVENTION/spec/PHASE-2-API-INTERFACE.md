# Identity Theft Prevention — Phase 2: API Interface Specification
...
Phase 2 defines RESTful API endpoints for interacting with Identity Theft Prevention services. This specification enables standardized programmatic access to identity verification data across authentication systems.

### 1.1 Base URL

```
Production: https://api.identity-theft-preve.wia.org/v1
Sandbox:    https://sandbox.identity-theft-preve.wia.org/v1
```
...
| Method | Endpoint | Description |
|--------|----------|-------------|
| POST | /data/ingest | Submit identity verification data |
