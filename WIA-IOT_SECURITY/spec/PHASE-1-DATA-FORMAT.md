# IOT Security — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for IOT Security systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across management systems and technology platforms.
...
```json
{
  ...
  "title": "WIA IOT Security Data Format",
  "type": "object",
  "required": ["standard", "version", "timestamp", "data"],
  "properties": {
    "standard": {
      "type": "string",
      "const": "WIA-IOT_SECURITY"
    },
    "version": {
      "type": "string",
      "pattern": "^\\d+\\.\\d+\\.\\d+$"
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (WIA-IOT_SECURITY) |
...
### 5.3 File Extensions
- `.wia-iot-security.json` — JSON format
- `.wia-iot-security.pb` — Protocol Buffers
