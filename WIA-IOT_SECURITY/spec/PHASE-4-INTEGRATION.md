# IOT Security — Phase 4: Integration Specification
...
Phase 4 defines integration patterns and requirements for deploying IOT Security within existing infrastructure. This specification covers system architecture, integration patterns, testing requirements, and deployment guidelines for management systems and technology platforms.
...
- Implement the `WIAWIA_IOT_SECURITYAdapter` interface
...
```json
{
  ...
  "channels": [
    "wia-iot_security.data.ingested",
    "wia-iot_security.resource.updated",
    "wia-iot_security.alert.triggered"
  ]
}
```
