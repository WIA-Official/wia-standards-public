...
This specification defines standardized data formats for 3D printing construction projects. Phase 1 establishes JSON schemas for product models, material specifications, layer definitions, structural metadata, quality requirements, and process parameters.
...
```
https://standards.wia.org/schemas/upcycling/v1.0/
```
