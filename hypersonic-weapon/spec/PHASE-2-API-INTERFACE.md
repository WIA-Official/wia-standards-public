# Hypersonic Weapon — Phase 2: API Interface Specification
...
Phase 2 defines RESTful API endpoints for interacting with Hypersonic Weapon services. This specification enables standardized programmatic access to weapons system data across defense command systems.

### 1.1 Base URL

```
Production: https://api.hypersonic-weapon.wia.org/v1
Sandbox:    https://sandbox.hypersonic-weapon.wia.org/v1
```
...
| Method | Endpoint | Description |
|--------|----------|-------------|
| POST | /data/ingest | Submit weapons system data |
