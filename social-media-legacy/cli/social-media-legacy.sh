#!/usr/bin/env bash
# social-media-legacy — Social Media Legacy CLI helper.
#
# Sample envelope generators for the WIA-SOC-001 standard.
# Requires: bash 4+, jq.
set -euo pipefail

STD_ID="WIA-SOC-001"
SLUG="social-media-legacy"
...
cmd_refs() {
    cat <<REFS
Normative references for WIA-SOC-001 (Social Media Legacy):
