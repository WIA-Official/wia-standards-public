# WIA-EDIBLE_ALGAE: Phase 2 - API Interface Specification
**Version:** 1.0
**Status:** Official
...
This document specifies the API interface requirements for EDIBLE ALGAE. All implementations MUST provide these endpoints to ensure interoperability.

## 2. REST API Endpoints

### 2.1 Base URL
```
https://api.wia.org/v1/wia-edible-algae/
```
...
```http
POST /v1/wia-edible-algae/records HTTP/1.1
...
### 3.1 Installation
```bash
npm install @wia/wia-edible-algae-sdk
```
...
### 3.3 Usage Example
```typescript
import { createClient } from '@wia/wia-edible-algae-sdk';
