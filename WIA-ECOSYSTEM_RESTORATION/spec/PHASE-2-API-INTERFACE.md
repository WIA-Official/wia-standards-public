# WIA-ECOSYSTEM_RESTORATION: Phase 2 - API Interface Specification
**Version:** 1.0
**Status:** Official
...
This document specifies the API interface requirements for ECOSYSTEM RESTORATION. All implementations MUST provide these endpoints to ensure interoperability.

## 2. REST API Endpoints

### 2.1 Base URL
```
https://api.wia.org/v1/wia-ecosystem-restoration/
```
...
```http
POST /v1/wia-ecosystem-restoration/records HTTP/1.1
...
### 3.1 Installation
```bash
npm install @wia/wia-ecosystem-restoration-sdk
```
...
### 3.3 Usage Example
```typescript
import { createClient } from '@wia/wia-ecosystem-restoration-sdk';
