# Anti Money Laundering — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for Anti Money Laundering systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across management systems and technology platforms.
...
```json
{
  ...
  "title": "WIA Anti Money Laundering Data Format",
  "type": "object",
  "required": ["standard", "version", "timestamp", "data"],
  "properties": {
    "standard": {
      "type": "string",
      "const": "anti-money-laundering"
    },
    "version": {
      "type": "string",
      "pattern": "^\\d+\\.\\d+\\.\\d+$"
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (anti-money-laundering) |
...
### 5.3 File Extensions
- `.wia-anti-money-launderin.json` — JSON format
- `.wia-anti-money-launderin.pb` — Protocol Buffers
