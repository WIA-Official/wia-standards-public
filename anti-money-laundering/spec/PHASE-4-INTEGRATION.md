# Anti Money Laundering — Phase 4: Integration Specification
...
Phase 4 defines integration patterns and requirements for deploying Anti Money Laundering within existing infrastructure. This specification covers system architecture, integration patterns, testing requirements, and deployment guidelines for management systems and technology platforms.
...
- Implement the `WIAanti_money_launderingAdapter` interface
...
```json
{
  ...
  "channels": [
    "anti-money-laundering.data.ingested",
    "anti-money-laundering.resource.updated",
    "anti-money-laundering.alert.triggered"
  ]
}
```
...
```
WIA_STANDARD=anti-money-laundering
WIA_VERSION=1.0.0
WIA_LOG_LEVEL=info
