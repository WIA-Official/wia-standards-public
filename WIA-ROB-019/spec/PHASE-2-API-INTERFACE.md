# WIA-ROB-019 PHASE 2 — API-INTERFACE Specification
...
`urn:wia:WIA-ROB-019:status-transition`.
...
`422` with type
`urn:wia:WIA-ROB-019:source-mix-required`.
...
with type
`urn:wia:WIA-ROB-019:laboratory-not-accredited`.
...
`409` with type
`urn:wia:WIA-ROB-019:quality-certificate-required`.
...
- `urn:wia:WIA-ROB-019:hydrogen-quality-out-of-grade`
- `urn:wia:WIA-ROB-019:cryogenic-temperature-excursion`
- `urn:wia:WIA-ROB-019:guarantee-of-origin-mismatch`
- `urn:wia:WIA-ROB-019:evidence-mismatch`
