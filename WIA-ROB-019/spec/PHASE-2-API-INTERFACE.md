# ROB 019 — Phase 2: API Interface Specification
...
Phase 2 defines RESTful API endpoints for interacting with ROB 019 services. This specification enables standardized programmatic access to operational data across management systems.

### 1.1 Base URL

```
Production: https://api.rob-019.wia.org/v1
Sandbox:    https://sandbox.rob-019.wia.org/v1
```
