# WIA-ROB-019 PHASE 4 — INTEGRATION Specification
...
This document defines how a WIA-ROB-019 programme
...
`/.well-known/wia-WIA-ROB-019` that links to the API
...
date WIA-ROB-019 MAY migrate historical records by
