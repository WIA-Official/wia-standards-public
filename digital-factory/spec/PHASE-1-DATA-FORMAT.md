# Digital Factory — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for Digital Factory systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across management systems and technology platforms.
...
```json
{
  ...
  "title": "WIA Digital Factory Data Format",
  "type": "object",
  "required": ["standard", "version", "timestamp", "data"],
  "properties": {
    "standard": {
      "type": "string",
      "const": "digital-factory"
    },
    "version": {
      "type": "string",
      "pattern": "^\\d+\\.\\d+\\.\\d+$"
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (digital-factory) |
...
### 5.3 File Extensions
- `.wia-digital-factory.json` — JSON format
- `.wia-digital-factory.pb` — Protocol Buffers
