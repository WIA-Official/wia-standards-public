...
/**
 * WIA-HERITAGE-009 SDK Client
 */
export class WIAHeritage009 {
  private config: WIAHeritage009Config;
  private endpoint: string;

  constructor(config: WIAHeritage009Config) {
    this.config = {
