...
<OAI-PMH xmlns="http://www.openarchives.org/OAI/2.0/">
  ...
  <request verb="GetRecord"
           identifier="oai:wia.org:heritage:art-009"
  ...
  <GetRecord>
    <record>
      <header>
        <identifier>oai:wia.org:heritage:art-009</identifier>
...
<http://wia.org/artifact/art-009> a crm:E22_Human-Made_Object ;
    dc:title "Ancient Greek Amphora" ;
    crm:P45_consists_of <http://vocab.getty.edu/aat/300090669> ; # terracotta
    ...
    wia:hasDigitalRepresentation <http://wia.org/model/model-009> .
```
...
```yaml
crossref_deposits:
  artifact_doi: 10.5555/wia.heritage.art.009
  model_doi: 10.5555/wia.heritage.model.009
  metadata: Crossmark
  funding: FundRef
```
...
```json
{
  ...
  "previous_versions": [
    {
      "version": "2.3.4",
      "url": "/artifacts/art-009/versions/2.3.4",
      "archived": true
    }
  ]
}
