# WIA-ENV-017 — Phase 4: INTEGRATION

> Water Quality canonical Phase 4 specification per the WIA Standards four-Phase architecture.

> Domain: 수질 — 수질 모니터링 · WHO·EPA 음용수 · IoT · 수처리 · WHO GDWQ.

## A.1 Scope

This Phase covers the canonical integration layer of the WIA-ENV-017 standard. It composes with the Phase 1 document for cross-Phase integration and inherits cross-standard behaviour from the wider WIA Standards family per the README.md scope statement.
