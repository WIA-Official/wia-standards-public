...
/**
 * WIA-HERITAGE-002 SDK Client
 */
export class WIAHeritage002 {
  private config: WIAHeritage002Config;
  private endpoint: string;

  constructor(config: WIAHeritage002Config) {
    this.config = {
