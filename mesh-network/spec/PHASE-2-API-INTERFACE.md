# Mesh Network — Phase 2: API Interface Specification
...
Phase 2 defines RESTful API endpoints for interacting with Mesh Network services. This specification enables standardized programmatic access to network traffic data across network management systems.

### 1.1 Base URL

```
Production: https://api.mesh-network.wia.org/v1
Sandbox:    https://sandbox.mesh-network.wia.org/v1
```
