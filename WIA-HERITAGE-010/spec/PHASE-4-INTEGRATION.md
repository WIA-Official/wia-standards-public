...
This document defines how a WIA-HERITAGE-010 programme
...
`/.well-known/wia-WIA-HERITAGE-010` that links to the API
...
date WIA-HERITAGE-010 MAY migrate historical records by
