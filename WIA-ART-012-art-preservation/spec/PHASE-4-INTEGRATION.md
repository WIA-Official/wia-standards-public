# WIA-ART-012: Phase 4 - Integration Specification
**Version:** 1.0
**Status:** Official
...
Integration guidelines for WIA-ART-012 Art Preservation Standard.

## 2. Platform Integration

### 2.1 Web Applications
```html
<script src="https://cdn.wia.org/art-012/v1/wia-art-012.js"></script>
<script>
  const sdk = new WIAART012({
    apiKey: 'your-api-key'
  });
</script>
```
...
let sdk = WIAART012(apiKey: "your-api-key")
```

### 2.3 Server-Side Integration
```python
from wia_art_012 import SDK
