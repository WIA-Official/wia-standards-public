# WIA-SEMI-003 - Phase 2: RESTful API Interfaces
...
## 3. API Interface Specification (Phase 2)
...
|---------|-------------|---------------|
| SEMI-003-P2-001 | Schema validation | 100% schema compliance |
| SEMI-003-P2-002 | Data completeness | All mandatory fields present |
| SEMI-003-P2-003 | Value range validation | Within specified bounds |
| SEMI-003-P2-004 | Unit consistency | Correct SI units |
| SEMI-003-P2-005 | Cross-validation | Internal consistency |
