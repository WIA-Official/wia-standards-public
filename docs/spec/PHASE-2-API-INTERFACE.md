# WIA-docs PHASE 2 — API-INTERFACE Specification
...
`urn:wia:docs:status-transition`.
...
`422` with type
`urn:wia:docs:source-mix-required`.
...
with type
`urn:wia:docs:laboratory-not-accredited`.
...
`409` with type
`urn:wia:docs:quality-certificate-required`.
...
- `urn:wia:docs:hydrogen-quality-out-of-grade`
- `urn:wia:docs:cryogenic-temperature-excursion`
- `urn:wia:docs:guarantee-of-origin-mismatch`
- `urn:wia:docs:evidence-mismatch`
