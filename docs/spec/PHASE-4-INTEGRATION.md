# WIA-docs PHASE 4 — INTEGRATION Specification
...
This document defines how a docs programme
...
`/.well-known/wia-docs` that links to the API
...
date WIA-docs MAY migrate historical records by
