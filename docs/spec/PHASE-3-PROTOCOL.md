# WIA-docs PHASE 3 — PROTOCOL Specification
...
A docs operator MAY claim conformance to
WIA-docs only after the operating jurisdiction's
...
A programme conformant with WIA-docs publishes
