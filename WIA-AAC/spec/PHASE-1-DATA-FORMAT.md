# AAC — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for AAC systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across management systems and technology platforms.
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (WIA-AAC) |
...
### 5.3 File Extensions
- `.wia-aac.json` — JSON format
- `.wia-aac.pb` — Protocol Buffers
