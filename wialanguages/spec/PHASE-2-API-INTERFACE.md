# WIA-wialanguages PHASE 2 — API-INTERFACE Specification

**Standard:** WIA-wialanguages
...
`urn:wia:wialanguages:status-transition`.
...
`422` with type
`urn:wia:wialanguages:source-mix-required`.
...
with type
`urn:wia:wialanguages:laboratory-not-accredited`.
...
`409` with type
`urn:wia:wialanguages:quality-certificate-required`.
...
- `urn:wia:wialanguages:hydrogen-quality-out-of-grade`
- `urn:wia:wialanguages:cryogenic-temperature-excursion`
- `urn:wia:wialanguages:guarantee-of-origin-mismatch`
- `urn:wia:wialanguages:evidence-mismatch`
