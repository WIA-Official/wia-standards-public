# WIA-wialanguages PHASE 3 — PROTOCOL Specification
...
A wialanguages operator MAY claim conformance to
WIA-wialanguages only after the operating jurisdiction's
...
A programme conformant with WIA-wialanguages publishes
