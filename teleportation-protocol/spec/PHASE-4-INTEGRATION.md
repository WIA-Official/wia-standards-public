...
- Implement the `WIAteleportation_protocolAdapter` interface
...
```json
{
  ...
  "channels": [
    "teleportation-protocol.data.ingested",
    "teleportation-protocol.resource.updated",
    "teleportation-protocol.alert.triggered"
  ]
}
```
...
```
WIA_STANDARD=teleportation-protocol
WIA_VERSION=1.0.0
WIA_LOG_LEVEL=info
