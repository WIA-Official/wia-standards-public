# Cyber Defense — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for Cyber Defense systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across security operations centers and network defense systems.
...
```json
{
  ...
  "title": "WIA Cyber Defense Data Format",
  "type": "object",
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (cyber-defense) |
...
### 5.3 File Extensions
- `.wia-cyber-defense.json` — JSON format
- `.wia-cyber-defense.pb` — Protocol Buffers
