...
Minimal POSIX shell client that demonstrates the WIA `sign-language` standard's
...
```sh
export WIA_API_BASE="https://sign-language.example.com/api/v1"
export WIA_API_TOKEN="<your-bearer-token>"
./sign-language.sh list
./sign-language.sh get <id>
./sign-language.sh create payload.json
./sign-language.sh validate payload.json
./sign-language.sh export <id>
```
