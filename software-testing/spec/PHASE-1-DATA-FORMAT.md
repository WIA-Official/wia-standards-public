# Software Testing — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for Software Testing systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across management systems and technology platforms.
...
```json
{
  ...
  "title": "WIA Software Testing Data Format",
  "type": "object",
  "required": ["standard", "version", "timestamp", "data"],
  "properties": {
    "standard": {
      "type": "string",
      "const": "software-testing"
    },
    "version": {
      "type": "string",
      "pattern": "^\\d+\\.\\d+\\.\\d+$"
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (software-testing) |
...
### 5.3 File Extensions
- `.wia-software-testing.json` — JSON format
- `.wia-software-testing.pb` — Protocol Buffers
