# Space Tourism — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for Space Tourism systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across space communication systems and orbital platforms.
...
```json
{
  ...
  "title": "WIA Space Tourism Data Format",
  "type": "object",
  "required": ["standard", "version", "timestamp", "data"],
  "properties": {
    "standard": {
      "type": "string",
      "const": "WIA-SPACE-TOURISM"
    },
    "version": {
      "type": "string",
      "pattern": "^\\d+\\.\\d+\\.\\d+$"
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (WIA-SPACE-TOURISM) |
...
### 5.3 File Extensions
- `.wia-space-tourism.json` — JSON format
- `.wia-space-tourism.pb` — Protocol Buffers
