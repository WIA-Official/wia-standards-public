# Space Tourism — Phase 2: API Interface Specification
...
Phase 2 defines RESTful API endpoints for interacting with Space Tourism services. This specification enables standardized programmatic access to telemetry data across space communication systems.

### 1.1 Base URL

```
Production: https://api.space-tourism.wia.org/v1
Sandbox:    https://sandbox.space-tourism.wia.org/v1
```
