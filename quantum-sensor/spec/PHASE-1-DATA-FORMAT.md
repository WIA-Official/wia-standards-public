# Quantum Sensor — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for Quantum Sensor systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across quantum computing platforms and quantum hardware.
...
```json
{
  ...
  "title": "WIA Quantum Sensor Data Format",
  "type": "object",
  "required": ["standard", "version", "timestamp", "data"],
  "properties": {
    "standard": {
      "type": "string",
      "const": "quantum-sensor"
    },
    "version": {
      "type": "string",
      "pattern": "^\\d+\\.\\d+\\.\\d+$"
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (quantum-sensor) |
...
### 5.3 File Extensions
- `.wia-quantum-sensor.json` — JSON format
- `.wia-quantum-sensor.pb` — Protocol Buffers
