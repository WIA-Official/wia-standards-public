# Network Protocol — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for Network Protocol systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across network management systems and network infrastructure.
...
```json
{
  ...
  "title": "WIA Network Protocol Data Format",
  "type": "object",
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (network-protocol) |
...
### 5.3 File Extensions
- `.wia-network-protocol.json` — JSON format
- `.wia-network-protocol.pb` — Protocol Buffers
