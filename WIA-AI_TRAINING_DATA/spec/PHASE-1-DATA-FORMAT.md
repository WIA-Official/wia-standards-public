# AI Training Data — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for AI Training Data systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across AI service platforms and AI processing systems.
...
```json
{
  ...
  "title": "WIA AI Training Data Data Format",
  "type": "object",
  "required": ["standard", "version", "timestamp", "data"],
  "properties": {
    "standard": {
      "type": "string",
      "const": "WIA-AI_TRAINING_DATA"
    },
    "version": {
      "type": "string",
      "pattern": "^\\d+\\.\\d+\\.\\d+$"
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (WIA-AI_TRAINING_DATA) |
...
### 5.3 File Extensions
- `.wia-ai-training-data.json` — JSON format
- `.wia-ai-training-data.pb` — Protocol Buffers
