# WIA-3d-printing-material PHASE 2 — API-INTERFACE Specification

**Standard:** WIA-3d-printing-material
...
`urn:wia:3d-printing-material:status-transition`.
...
`422` with type
`urn:wia:3d-printing-material:source-mix-required`.
...
with type
`urn:wia:3d-printing-material:laboratory-not-accredited`.
...
`409` with type
`urn:wia:3d-printing-material:quality-certificate-required`.
...
- `urn:wia:3d-printing-material:hydrogen-quality-out-of-grade`
- `urn:wia:3d-printing-material:cryogenic-temperature-excursion`
- `urn:wia:3d-printing-material:guarantee-of-origin-mismatch`
- `urn:wia:3d-printing-material:evidence-mismatch`
