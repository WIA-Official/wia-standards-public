#!/usr/bin/env bash
# smart-building — Smart Building CLI helper.
#
# Sample envelope generators for the WIA-CITY-003 standard.
# Requires: bash 4+, jq.
set -euo pipefail
...
cmd_refs() {
    cat <<REFS
Normative references for WIA-CITY-003 (Smart Building):
