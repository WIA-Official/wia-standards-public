# WIA-CITY-003 — Smart Building

> 스마트 빌딩 표준 — 건물 자동화 · BAS · BMS · BACnet · 에너지 관리
...
smart building hosts that need to interoperate across
...
- LEED v4.1 (USGBC)
- BREEAM v6.1 (BRE Global)
- ISO 16484-2 BACnet
- ISO 16484-5 BACnet/IP
...
1. BACnet Foundations
2. Building Automation Architecture
3. HVAC Sequences and Control
4. Energy Management ISO 50001
5. LEED v4.1 Operations Pathway
6. Indoor Environmental Quality
7. BACnet Cybersecurity ISO/IEC 27001
8. Net-Zero and Grid-Interactive Pathways

## CLI

A POSIX shell helper is published at `cli/smart-building.sh`. The helper ships
