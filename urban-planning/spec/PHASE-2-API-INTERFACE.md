# PHASE 2 — API INTERFACE · WIA-CITY-016: Urban Planning Standard v1.0
**Version:** 1.0
**Status:** Active
...
This Phase defines the API INTERFACE layer of the *WIA-CITY-016: Urban Planning Standard v1.0* WIA standard.
...
in lockstep across Phases 1–4 of WIA-CITY-016: Urban Planning Standard v1.0 so that conformance claims at any
