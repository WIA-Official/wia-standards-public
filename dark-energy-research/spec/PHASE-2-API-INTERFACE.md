# Dark Energy Research — Phase 2: API Interface Specification
...
Phase 2 defines RESTful API endpoints for interacting with Dark Energy Research services. This specification enables standardized programmatic access to energy metrics across power grid systems.

### 1.1 Base URL

```
Production: https://api.dark-energy-research.wia.org/v1
Sandbox:    https://sandbox.dark-energy-research.wia.org/v1
```
...
| Method | Endpoint | Description |
|--------|----------|-------------|
| POST | /data/ingest | Submit energy metrics |
