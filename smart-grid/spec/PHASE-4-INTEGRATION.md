# WIA-ENE-027 — Phase 4: INTEGRATION

> Smart Grid canonical Phase 4 specification per the WIA Standards four-Phase architecture.

> Domain: 스마트 그리드 — 스마트 그리드 · IEC 61850 · DERMS · AMI · 사이버 보안.

## A.1 Scope

This Phase covers the canonical integration layer of the WIA-ENE-027 standard. It composes with the Phase 1 document for cross-Phase integration and inherits cross-standard behaviour from the wider WIA Standards family per the README.md scope statement.
