# WIA-ENE-027 — Phase 3: PROTOCOL

> Smart Grid canonical Phase 3 specification per the WIA Standards four-Phase architecture.

> Domain: 스마트 그리드 — 스마트 그리드 · IEC 61850 · DERMS · AMI · 사이버 보안.

## A.1 Scope

This Phase covers the canonical protocol layer of the WIA-ENE-027 standard. It composes with the Phase 4 document for cross-Phase integration and inherits cross-standard behaviour from the wider WIA Standards family per the README.md scope statement.
