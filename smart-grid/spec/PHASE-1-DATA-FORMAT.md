# WIA-ENE-027 — Phase 1: DATA-FORMAT

> Smart Grid canonical Phase 1 specification per the WIA Standards four-Phase architecture.

> Domain: 스마트 그리드 — 스마트 그리드 · IEC 61850 · DERMS · AMI · 사이버 보안.

## A.1 Scope

This Phase covers the canonical data-format layer of the WIA-ENE-027 standard. It composes with the Phase 2 document for cross-Phase integration and inherits cross-standard behaviour from the wider WIA Standards family per the README.md scope statement.
...
with `wia.standard.slug` = `smart-grid` and `wia.standard.phase` =
...
`/.well-known/wia-smart-grid-capabilities` enumerating per-endpoint
