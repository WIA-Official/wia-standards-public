# 3d-image-sensor Rust SDK

> **弘益人間 (Benefit All Humanity)**

Official Rust SDK for the 3d-image-sensor Standard.
...
```rust
use 3d_image_sensor_sdk::CreateThreeDImageSensorRequest;

let request = CreateThreeDImageSensorRequest {
...
```rust
use 3d_image_sensor_sdk::ListParams;
...
- Documentation: https://docs.wiastandards.com/3d-image-sensor
