...
Minimal POSIX shell client that demonstrates the WIA `plugins` standard's
...
```sh
export WIA_API_BASE="https://plugins.example.com/api/v1"
export WIA_API_TOKEN="<your-bearer-token>"
./plugins.sh list
./plugins.sh get <id>
./plugins.sh create payload.json
./plugins.sh validate payload.json
./plugins.sh export <id>
```
