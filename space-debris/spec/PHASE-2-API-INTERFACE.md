# PHASE 2 — API INTERFACE · WIA-SPACE-010: Space Debris Standards Specification v1.0
**Version:** 1.0
**Status:** Active
...
This Phase defines the API INTERFACE layer of the *WIA-SPACE-010: Space Debris Standards Specification v1.0* WIA standard.
...
in lockstep across Phases 1–4 of WIA-SPACE-010: Space Debris Standards Specification v1.0 so that conformance claims at any
