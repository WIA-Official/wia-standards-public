# WIA-FINTECH_INNOVATION PHASE 3 — PROTOCOL Specification
...
A WIA-FINTECH_INNOVATION operator MAY claim conformance to
WIA-FINTECH_INNOVATION only after the operating jurisdiction's
...
A programme conformant with WIA-FINTECH_INNOVATION publishes
