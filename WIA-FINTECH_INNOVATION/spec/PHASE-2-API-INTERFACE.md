# Fintech Innovation — Phase 2: API Interface Specification
...
Phase 2 defines RESTful API endpoints for interacting with Fintech Innovation services. This specification enables standardized programmatic access to financial transaction data across banking systems.

### 1.1 Base URL

```
Production: https://api.fintech-innovation.wia.org/v1
Sandbox:    https://sandbox.fintech-innovation.wia.org/v1
```
