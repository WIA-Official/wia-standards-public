# WIA-FINTECH_INNOVATION PHASE 2 — API-INTERFACE Specification
...
`urn:wia:WIA-FINTECH_INNOVATION:status-transition`.
...
`422` with type
`urn:wia:WIA-FINTECH_INNOVATION:source-mix-required`.
...
with type
`urn:wia:WIA-FINTECH_INNOVATION:laboratory-not-accredited`.
...
`409` with type
`urn:wia:WIA-FINTECH_INNOVATION:quality-certificate-required`.
...
- `urn:wia:WIA-FINTECH_INNOVATION:hydrogen-quality-out-of-grade`
- `urn:wia:WIA-FINTECH_INNOVATION:cryogenic-temperature-excursion`
- `urn:wia:WIA-FINTECH_INNOVATION:guarantee-of-origin-mismatch`
- `urn:wia:WIA-FINTECH_INNOVATION:evidence-mismatch`
