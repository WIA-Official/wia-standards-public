# WIA-FINTECH_INNOVATION Rust SDK

> **弘益人間 (Benefit All Humanity)**

Official Rust SDK for the WIA-FINTECH_INNOVATION Standard.
...
```toml
[dependencies]
wia-fintech-innovation-sdk = "1.0"
...
```rust
use wia_fintech_innovation_sdk::CreateFintechInnovationRequest;

let request = CreateFintechInnovationRequest {
...
```rust
use wia_fintech_innovation_sdk::ListParams;
...
```rust
use wia_fintech_innovation_sdk::Error;
...
- Documentation: https://docs.wiastandards.com/WIA-FINTECH_INNOVATION
