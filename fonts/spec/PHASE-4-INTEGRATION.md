# WIA-fonts PHASE 4 — INTEGRATION Specification
...
This document defines how a fonts programme
...
`/.well-known/wia-fonts` that links to the API
...
date WIA-fonts MAY migrate historical records by
