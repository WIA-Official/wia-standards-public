# WIA-fonts PHASE 2 — API-INTERFACE Specification
...
`urn:wia:fonts:status-transition`.
...
`422` with type
`urn:wia:fonts:source-mix-required`.
...
with type
`urn:wia:fonts:laboratory-not-accredited`.
...
`409` with type
`urn:wia:fonts:quality-certificate-required`.
...
- `urn:wia:fonts:hydrogen-quality-out-of-grade`
- `urn:wia:fonts:cryogenic-temperature-excursion`
- `urn:wia:fonts:guarantee-of-origin-mismatch`
- `urn:wia:fonts:evidence-mismatch`
