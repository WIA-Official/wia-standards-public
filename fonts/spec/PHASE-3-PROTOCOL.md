# WIA-fonts PHASE 3 — PROTOCOL Specification
...
A fonts operator MAY claim conformance to
WIA-fonts only after the operating jurisdiction's
...
A programme conformant with WIA-fonts publishes
