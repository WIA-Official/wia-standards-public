# Semiconductor Material — Phase 2: API Interface Specification
...
Phase 2 defines RESTful API endpoints for interacting with Semiconductor Material services. This specification enables standardized programmatic access to semiconductor data across fabrication systems.

### 1.1 Base URL

```
Production: https://api.semiconductor-materi.wia.org/v1
Sandbox:    https://sandbox.semiconductor-materi.wia.org/v1
```
