# Semiconductor Material — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for Semiconductor Material systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across fabrication systems and testing platforms.
...
```json
{
  ...
  "title": "WIA Semiconductor Material Data Format",
  "type": "object",
  "required": ["standard", "version", "timestamp", "data"],
  "properties": {
    "standard": {
      "type": "string",
      "const": "semiconductor-material"
    },
    "version": {
      "type": "string",
      "pattern": "^\\d+\\.\\d+\\.\\d+$"
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (semiconductor-material) |
...
### 5.3 File Extensions
- `.wia-semiconductor-materi.json` — JSON format
- `.wia-semiconductor-materi.pb` — Protocol Buffers
