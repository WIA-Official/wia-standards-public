# Display Technology — Phase 2: API Interface Specification
...
Phase 2 defines RESTful API endpoints for interacting with Display Technology services. This specification enables standardized programmatic access to display parameters across display testing systems.

### 1.1 Base URL

```
Production: https://api.display-technology.wia.org/v1
Sandbox:    https://sandbox.display-technology.wia.org/v1
```
...
| Method | Endpoint | Description |
|--------|----------|-------------|
| POST | /data/ingest | Submit display parameters |
