# Microled — Phase 2: API Interface Specification
...
Phase 2 defines RESTful API endpoints for interacting with Microled services. This specification enables standardized programmatic access to micro-scale measurement data across detection systems.

### 1.1 Base URL

```
Production: https://api.microled.wia.org/v1
Sandbox:    https://sandbox.microled.wia.org/v1
```
