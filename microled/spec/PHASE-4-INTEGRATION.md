# Microled — Phase 4: Integration Specification
...
Phase 4 defines integration patterns and requirements for deploying Microled within existing infrastructure. This specification covers system architecture, integration patterns, testing requirements, and deployment guidelines for detection systems and analytical platforms.
...
- Implement the `WIAmicroledAdapter` interface
...
```json
{
  ...
  "channels": [
    "microled.data.ingested",
    "microled.resource.updated",
    "microled.alert.triggered"
  ]
}
```
