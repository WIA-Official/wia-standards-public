# Microled — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for Microled systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across detection systems and analytical platforms.
...
```json
{
  ...
  "title": "WIA Microled Data Format",
  "type": "object",
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (microled) |
...
### 5.3 File Extensions
- `.wia-microled.json` — JSON format
- `.wia-microled.pb` — Protocol Buffers
