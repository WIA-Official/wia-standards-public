# WIA-EMERGENCY_MEDICAL_DATA: Phase 1 - Data Format Specification
**Version:** 1.0
**Status:** Official
...
This document specifies the data format requirements for EMERGENCY MEDICAL DATA. All implementations MUST follow these specifications to ensure interoperability across systems.
...
```json
{
  "type": "WIA-EMERGENCY_MEDICAL_DATARecord",
  "version": "1.0",
  "id": "string (UUID v4)",
  "timestamp": "ISO 8601",
  "data": {
...
```json
{
  ...
  "properties": {
    "type": { "type": "string", "const": "WIA-EMERGENCY_MEDICAL_DATARecord" },
