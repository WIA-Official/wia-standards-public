...
Minimal POSIX shell client that demonstrates the WIA `defi` standard's
...
```sh
export WIA_API_BASE="https://defi.example.com/api/v1"
export WIA_API_TOKEN="<your-bearer-token>"
./defi.sh list
./defi.sh get <id>
./defi.sh create payload.json
./defi.sh validate payload.json
./defi.sh export <id>
```
