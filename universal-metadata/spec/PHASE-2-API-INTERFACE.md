# PHASE 2 — API INTERFACE · universal-metadata
**Version:** 1.0
**Status:** Active
...
This Phase defines the API INTERFACE layer of the *universal-metadata* WIA standard.
...
in lockstep across Phases 1–4 of universal-metadata so that conformance claims at any
