# EV Charging — Phase 4: Integration Specification
...
Phase 4 defines integration patterns and requirements for deploying EV Charging within existing infrastructure. This specification covers system architecture, integration patterns, testing requirements, and deployment guidelines for management systems and technology platforms.
...
- Implement the `WIAev_chargingAdapter` interface
...
```json
{
  ...
  "channels": [
    "ev-charging.data.ingested",
    "ev-charging.resource.updated",
    "ev-charging.alert.triggered"
  ]
}
```
