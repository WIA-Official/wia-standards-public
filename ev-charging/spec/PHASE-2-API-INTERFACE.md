# EV Charging — Phase 2: API Interface Specification
...
Phase 2 defines RESTful API endpoints for interacting with EV Charging services. This specification enables standardized programmatic access to operational data across management systems.

### 1.1 Base URL

```
Production: https://api.ev-charging.wia.org/v1
Sandbox:    https://sandbox.ev-charging.wia.org/v1
```
