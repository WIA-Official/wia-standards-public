# EV Charging — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for EV Charging systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across management systems and technology platforms.
...
```json
{
  ...
  "title": "WIA EV Charging Data Format",
  "type": "object",
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (ev-charging) |
...
### 5.3 File Extensions
- `.wia-ev-charging.json` — JSON format
- `.wia-ev-charging.pb` — Protocol Buffers
