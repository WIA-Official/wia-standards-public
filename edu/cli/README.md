...
Minimal POSIX shell client that demonstrates the WIA `edu` standard's
...
```sh
export WIA_API_BASE="https://edu.example.com/api/v1"
export WIA_API_TOKEN="<your-bearer-token>"
./edu.sh list
./edu.sh get <id>
./edu.sh create payload.json
./edu.sh validate payload.json
./edu.sh export <id>
```
