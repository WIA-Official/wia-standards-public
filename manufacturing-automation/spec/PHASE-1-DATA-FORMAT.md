# Manufacturing Automation — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for Manufacturing Automation systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across management systems and technology platforms.
...
```json
{
  ...
  "title": "WIA Manufacturing Automation Data Format",
  "type": "object",
  "required": ["standard", "version", "timestamp", "data"],
  "properties": {
    "standard": {
      "type": "string",
      "const": "manufacturing-automation"
    },
    "version": {
      "type": "string",
      "pattern": "^\\d+\\.\\d+\\.\\d+$"
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (manufacturing-automation) |
...
### 5.3 File Extensions
- `.wia-manufacturing-automa.json` — JSON format
- `.wia-manufacturing-automa.pb` — Protocol Buffers
...
```json
{
  "standard": "manufacturing-automation",
  "version": "1.0.0",
