# WIA-unicode-emoji-proposal PHASE 4 — INTEGRATION Specification
...
This document defines how a unicode-emoji-proposal programme
...
`/.well-known/wia-unicode-emoji-proposal` that links to the API
...
date WIA-unicode-emoji-proposal MAY migrate historical records by
