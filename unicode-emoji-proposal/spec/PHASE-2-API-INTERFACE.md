# WIA-unicode-emoji-proposal PHASE 2 — API-INTERFACE Specification

**Standard:** WIA-unicode-emoji-proposal
...
`urn:wia:unicode-emoji-proposal:status-transition`.
...
`422` with type
`urn:wia:unicode-emoji-proposal:source-mix-required`.
...
with type
`urn:wia:unicode-emoji-proposal:laboratory-not-accredited`.
...
`409` with type
`urn:wia:unicode-emoji-proposal:quality-certificate-required`.
...
- `urn:wia:unicode-emoji-proposal:hydrogen-quality-out-of-grade`
- `urn:wia:unicode-emoji-proposal:cryogenic-temperature-excursion`
- `urn:wia:unicode-emoji-proposal:guarantee-of-origin-mismatch`
- `urn:wia:unicode-emoji-proposal:evidence-mismatch`
