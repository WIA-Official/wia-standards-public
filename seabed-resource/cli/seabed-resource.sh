#!/usr/bin/env bash
# seabed-resource — Seabed Resource CLI helper.
#
# Sample envelope generators for the WIA-ENE-037 standard.
# Requires: bash 4+, jq.
set -euo pipefail

STD_ID="WIA-ENE-037"
SLUG="seabed-resource"
...
cmd_refs() {
    cat <<REFS
Normative references for WIA-ENE-037 (Seabed Resource):
