# `digital-currency` CLI

Minimal POSIX shell client that demonstrates the WIA `digital-currency` standard's
...
```sh
export WIA_API_BASE="https://digital-currency.example.com/api/v1"
export WIA_API_TOKEN="<your-bearer-token>"
./digital-currency.sh list
./digital-currency.sh get <id>
./digital-currency.sh create payload.json
./digital-currency.sh validate payload.json
./digital-currency.sh export <id>
```
