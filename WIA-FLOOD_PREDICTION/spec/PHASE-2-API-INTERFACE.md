# Flood Prediction — Phase 2: API Interface Specification
...
Phase 2 defines RESTful API endpoints for interacting with Flood Prediction services. This specification enables standardized programmatic access to hydrological data across flood monitoring systems.

### 1.1 Base URL

```
Production: https://api.flood-prediction.wia.org/v1
Sandbox:    https://sandbox.flood-prediction.wia.org/v1
```
...
| Method | Endpoint | Description |
|--------|----------|-------------|
| POST | /data/ingest | Submit hydrological data |
