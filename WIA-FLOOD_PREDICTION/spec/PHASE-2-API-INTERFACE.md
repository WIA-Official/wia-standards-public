# WIA-FLOOD_PREDICTION PHASE 2 — API-INTERFACE Specification
...
`urn:wia:WIA-FLOOD_PREDICTION:status-transition`.
...
`422` with type
`urn:wia:WIA-FLOOD_PREDICTION:source-mix-required`.
...
with type
`urn:wia:WIA-FLOOD_PREDICTION:laboratory-not-accredited`.
...
`409` with type
`urn:wia:WIA-FLOOD_PREDICTION:quality-certificate-required`.
...
- `urn:wia:WIA-FLOOD_PREDICTION:hydrogen-quality-out-of-grade`
- `urn:wia:WIA-FLOOD_PREDICTION:cryogenic-temperature-excursion`
- `urn:wia:WIA-FLOOD_PREDICTION:guarantee-of-origin-mismatch`
- `urn:wia:WIA-FLOOD_PREDICTION:evidence-mismatch`
