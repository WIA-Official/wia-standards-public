# WIA-FLOOD_PREDICTION PHASE 3 — PROTOCOL Specification
...
A WIA-FLOOD_PREDICTION operator MAY claim conformance to
WIA-FLOOD_PREDICTION only after the operating jurisdiction's
...
A programme conformant with WIA-FLOOD_PREDICTION publishes
