# Intelligent Transportation — Phase 2: API Interface Specification
...
Phase 2 defines RESTful API endpoints for interacting with Intelligent Transportation services. This specification enables standardized programmatic access to athletic performance data across sports analytics platforms.

### 1.1 Base URL

```
Production: https://api.intelligent-transpor.wia.org/v1
Sandbox:    https://sandbox.intelligent-transpor.wia.org/v1
```
...
| Method | Endpoint | Description |
|--------|----------|-------------|
| POST | /data/ingest | Submit athletic performance data |
