# Next GEN Data Storage — Phase 2: API Interface Specification
...
Phase 2 defines RESTful API endpoints for interacting with Next GEN Data Storage services. This specification enables standardized programmatic access to operational data across management systems.

### 1.1 Base URL

```
Production: https://api.next-gen-data-storag.wia.org/v1
Sandbox:    https://sandbox.next-gen-data-storag.wia.org/v1
```
