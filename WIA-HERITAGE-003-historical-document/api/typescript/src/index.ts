...
/**
 * WIA-HERITAGE-003 SDK Client
 */
export class WIAHeritage003 {
  private config: WIAHeritage003Config;
  private endpoint: string;

  constructor(config: WIAHeritage003Config) {
    this.config = {
