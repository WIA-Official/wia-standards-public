# AI Content Moderation — Phase 4: Integration Specification
...
Phase 4 defines integration patterns and requirements for deploying AI Content Moderation within existing infrastructure. This specification covers system architecture, integration patterns, testing requirements, and deployment guidelines for AI service platforms and AI processing systems.
...
- Implement the `WIAai_content_moderationAdapter` interface
...
```json
{
  ...
  "channels": [
    "ai-content-moderation.data.ingested",
    "ai-content-moderation.resource.updated",
    "ai-content-moderation.alert.triggered"
  ]
}
```
...
```
WIA_STANDARD=ai-content-moderation
WIA_VERSION=1.0.0
WIA_LOG_LEVEL=info
