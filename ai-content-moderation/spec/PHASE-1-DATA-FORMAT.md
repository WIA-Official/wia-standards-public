# AI Content Moderation — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for AI Content Moderation systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across AI service platforms and AI processing systems.
...
```json
{
  ...
  "title": "WIA AI Content Moderation Data Format",
  "type": "object",
  "required": ["standard", "version", "timestamp", "data"],
  "properties": {
    "standard": {
      "type": "string",
      "const": "ai-content-moderation"
    },
    "version": {
      "type": "string",
      "pattern": "^\\d+\\.\\d+\\.\\d+$"
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (ai-content-moderation) |
...
### 5.3 File Extensions
- `.wia-ai-content-moderatio.json` — JSON format
- `.wia-ai-content-moderatio.pb` — Protocol Buffers
...
```json
{
  "standard": "ai-content-moderation",
  "version": "1.0.0",
