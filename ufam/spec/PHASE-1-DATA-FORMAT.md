# UFAM — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for UFAM systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across management systems and technology platforms.
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (ufam) |
...
### 5.3 File Extensions
- `.wia-ufam.json` — JSON format
- `.wia-ufam.pb` — Protocol Buffers
