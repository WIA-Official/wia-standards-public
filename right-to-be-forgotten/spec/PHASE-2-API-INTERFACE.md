# PHASE 2 — API INTERFACE · right-to-be-forgotten
**Version:** 1.0
**Status:** Active
...
This Phase defines the API INTERFACE layer of the *right-to-be-forgotten* WIA standard.
...
in lockstep across Phases 1–4 of right-to-be-forgotten so that conformance claims at any
