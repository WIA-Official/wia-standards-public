# Legal Tech — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for Legal Tech systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across case management systems and legal AI platforms.
...
```json
{
  ...
  "title": "WIA Legal Tech Data Format",
  "type": "object",
  "required": ["standard", "version", "timestamp", "data"],
  "properties": {
    "standard": {
      "type": "string",
      "const": "WIA-LEGAL_TECH"
    },
    "version": {
      "type": "string",
      "pattern": "^\\d+\\.\\d+\\.\\d+$"
    ...
    "data": {
      "type": "object",
      "description": "Primary legal document data payload"
    }
  }
}
```
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (WIA-LEGAL_TECH) |
...
| data | object | Yes | Domain-specific legal document data |
...
### 5.3 File Extensions
- `.wia-legal-tech.json` — JSON format
- `.wia-legal-tech.pb` — Protocol Buffers
