# Legal Tech — Phase 2: API Interface Specification
...
Phase 2 defines RESTful API endpoints for interacting with Legal Tech services. This specification enables standardized programmatic access to legal document data across case management systems.

### 1.1 Base URL

```
Production: https://api.legal-tech.wia.org/v1
Sandbox:    https://sandbox.legal-tech.wia.org/v1
```
...
| Method | Endpoint | Description |
|--------|----------|-------------|
| POST | /data/ingest | Submit legal document data |
