# Medical Robot — Phase 2: API Interface Specification
...
Phase 2 defines RESTful API endpoints for interacting with Medical Robot services. This specification enables standardized programmatic access to medical records across hospital information systems.

### 1.1 Base URL

```
Production: https://api.medical-robot.wia.org/v1
Sandbox:    https://sandbox.medical-robot.wia.org/v1
```
...
| Method | Endpoint | Description |
|--------|----------|-------------|
| POST | /data/ingest | Submit medical records |
