# Medical Robot — Phase 4: Integration Specification
...
Phase 4 defines integration patterns and requirements for deploying Medical Robot within existing infrastructure. This specification covers system architecture, integration patterns, testing requirements, and deployment guidelines for hospital information systems and medical devices.
...
For connecting legacy hospital information systems:
- Implement the `WIAmedical_robotAdapter` interface
...
```json
{
  ...
  "channels": [
    "medical-robot.data.ingested",
    "medical-robot.resource.updated",
    "medical-robot.alert.triggered"
  ]
}
```
