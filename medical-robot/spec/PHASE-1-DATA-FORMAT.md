# Medical Robot — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for Medical Robot systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across hospital information systems and medical devices.
...
```json
{
  ...
  "title": "WIA Medical Robot Data Format",
  "type": "object",
  ...
  "properties": {
    ...
    "data": {
      "type": "object",
      "description": "Primary medical records payload"
    }
  }
}
```
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (medical-robot) |
...
| data | object | Yes | Domain-specific medical records |
...
### 5.3 File Extensions
- `.wia-medical-robot.json` — JSON format
- `.wia-medical-robot.pb` — Protocol Buffers
