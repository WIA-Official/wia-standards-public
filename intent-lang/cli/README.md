...
Minimal POSIX shell client that demonstrates the WIA `intent-lang` standard's
...
```sh
export WIA_API_BASE="https://intent-lang.example.com/api/v1"
export WIA_API_TOKEN="<your-bearer-token>"
./intent-lang.sh list
./intent-lang.sh get <id>
./intent-lang.sh create payload.json
./intent-lang.sh validate payload.json
./intent-lang.sh export <id>
```
