# Quantum Computing — Phase 2: API Interface Specification
...
Phase 2 defines RESTful API endpoints for interacting with Quantum Computing services. This specification enables standardized programmatic access to quantum state data across quantum computing platforms.

### 1.1 Base URL

```
Production: https://api.quantum-computing.wia.org/v1
Sandbox:    https://sandbox.quantum-computing.wia.org/v1
```
