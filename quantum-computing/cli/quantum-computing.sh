#!/usr/bin/env bash
# quantum-computing — Quantum Computing CLI helper.
#
# Sample envelope generators for the WIA-QC-001 standard.
# Requires: bash 4+, jq.
set -euo pipefail
...
cmd_refs() {
    cat <<REFS
Normative references for WIA-QC-001 (Quantum Computing):
