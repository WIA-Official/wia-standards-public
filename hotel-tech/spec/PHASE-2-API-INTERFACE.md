# Hotel Tech — Phase 2: API Interface Specification
...
Phase 2 defines RESTful API endpoints for interacting with Hotel Tech services. This specification enables standardized programmatic access to hospitality operations data across property management systems.

### 1.1 Base URL

```
Production: https://api.hotel-tech.wia.org/v1
Sandbox:    https://sandbox.hotel-tech.wia.org/v1
```
...
| Method | Endpoint | Description |
|--------|----------|-------------|
| POST | /data/ingest | Submit hospitality operations data |
