# Hotel Tech — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for Hotel Tech systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across property management systems and guest service platforms.
...
```json
{
  ...
  "title": "WIA Hotel Tech Data Format",
  "type": "object",
  ...
  "properties": {
    ...
    "data": {
      "type": "object",
      "description": "Primary hospitality operations data payload"
    }
  }
}
```
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (hotel-tech) |
...
| data | object | Yes | Domain-specific hospitality operations data |
...
### 5.3 File Extensions
- `.wia-hotel-tech.json` — JSON format
- `.wia-hotel-tech.pb` — Protocol Buffers
