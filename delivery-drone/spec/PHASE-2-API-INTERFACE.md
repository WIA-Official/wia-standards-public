# Delivery Drone — Phase 2: API Interface Specification
...
Phase 2 defines RESTful API endpoints for interacting with Delivery Drone services. This specification enables standardized programmatic access to drone telemetry across drone management systems.

### 1.1 Base URL

```
Production: https://api.delivery-drone.wia.org/v1
Sandbox:    https://sandbox.delivery-drone.wia.org/v1
```
...
| Method | Endpoint | Description |
|--------|----------|-------------|
| POST | /data/ingest | Submit drone telemetry |
