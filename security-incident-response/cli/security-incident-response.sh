#!/usr/bin/env bash
# security-incident-response — Security Incident Response CLI helper.
#
# Sample envelope generators for the WIA-SEC-IR-001 standard.
# Requires: bash 4+, jq.
set -euo pipefail

STD_ID="WIA-SEC-IR-001"
...
cmd_refs() {
    cat <<REFS
Normative references for WIA-SEC-IR-001 (Security Incident Response):
