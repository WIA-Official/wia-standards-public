# WIA-SEC-IR-001 — Security Incident Response

> 보안 사고 대응 표준 — 사고 대응 · NIST SP 800-61 · ISO 27035 · SOAR · DFIR
...
security incident response hosts that need to interoperate across
...
1. NIST SP 800-61 IR Lifecycle
2. ISO/IEC 27035 Series Framework
3. MITRE ATT and CK Enterprise Mapping
4. STIX/TAXII Threat Intelligence
5. CVSS v4.0 Scoring
6. SOAR Playbook Engineering
7. Forensic Acquisition NIST 800-86
8. IODEF Information Sharing

## CLI

A POSIX shell helper is published at `cli/security-incident-response.sh`. The helper ships
