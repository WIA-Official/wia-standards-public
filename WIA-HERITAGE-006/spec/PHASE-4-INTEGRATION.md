...
This document defines how a WIA-HERITAGE-006 programme
...
`/.well-known/wia-WIA-HERITAGE-006` that links to the API
...
date WIA-HERITAGE-006 MAY migrate historical records by
