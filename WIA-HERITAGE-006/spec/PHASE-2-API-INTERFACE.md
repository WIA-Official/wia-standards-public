# WIA-HERITAGE-006 PHASE 2 — API-INTERFACE Specification
...
`urn:wia:WIA-HERITAGE-006:status-transition`.
...
`422` with type
`urn:wia:WIA-HERITAGE-006:source-mix-required`.
...
with type
`urn:wia:WIA-HERITAGE-006:laboratory-not-accredited`.
...
`409` with type
`urn:wia:WIA-HERITAGE-006:quality-certificate-required`.
...
- `urn:wia:WIA-HERITAGE-006:hydrogen-quality-out-of-grade`
- `urn:wia:WIA-HERITAGE-006:cryogenic-temperature-excursion`
- `urn:wia:WIA-HERITAGE-006:guarantee-of-origin-mismatch`
- `urn:wia:WIA-HERITAGE-006:evidence-mismatch`
