# PHASE 2 — API INTERFACE · WIA-SPACE-021: UTM - Unmanned Traffic Management
**Version:** 1.0
**Status:** Active
...
This Phase defines the API INTERFACE layer of the *WIA-SPACE-021: UTM - Unmanned Traffic Management* WIA standard.
...
in lockstep across Phases 1–4 of WIA-SPACE-021: UTM - Unmanned Traffic Management so that conformance claims at any
