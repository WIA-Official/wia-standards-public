# WIA-direct-air-capture Direct Air Capture

> Cross-vendor data and protocol layer for Direct Air Capture.

## Overview

WIA-direct-air-capture defines standardized data formats and protocol semantics for
Direct Air Capture. The standard exposes four PHASE documents covering data
...
```bash
npm install @wia/direct-air-capture
```

```typescript
import { Client } from '@wia/direct-air-capture';
const client = new Client({ baseUrl: 'https://api.example.com/wia-direct-air-capture' });
