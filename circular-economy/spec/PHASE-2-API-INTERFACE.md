# Circular Economy — Phase 2: API Interface Specification
...
Phase 2 defines RESTful API endpoints for interacting with Circular Economy services. This specification enables standardized programmatic access to material lifecycle data across recycling systems.

### 1.1 Base URL

```
Production: https://api.circular-economy.wia.org/v1
Sandbox:    https://sandbox.circular-economy.wia.org/v1
```
...
| Method | Endpoint | Description |
|--------|----------|-------------|
| POST | /data/ingest | Submit material lifecycle data |
