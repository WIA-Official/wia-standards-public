# Circular Economy — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for Circular Economy systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across recycling systems and sustainability platforms.
...
```json
{
  ...
  "title": "WIA Circular Economy Data Format",
  "type": "object",
  "required": ["standard", "version", "timestamp", "data"],
  "properties": {
    "standard": {
      "type": "string",
      "const": "circular-economy"
    },
    "version": {
      "type": "string",
      "pattern": "^\\d+\\.\\d+\\.\\d+$"
    ...
    "data": {
      "type": "object",
      "description": "Primary material lifecycle data payload"
    }
  }
}
```
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (circular-economy) |
...
| data | object | Yes | Domain-specific material lifecycle data |
...
### 5.3 File Extensions
- `.wia-circular-economy.json` — JSON format
- `.wia-circular-economy.pb` — Protocol Buffers
