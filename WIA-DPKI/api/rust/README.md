...
Official Rust SDK for the WIA-DPKI Standard.
...
```rust
use wia_dpki_sdk::CreateDpkiRequest;

let request = CreateDpkiRequest {
...
- Documentation: https://docs.wiastandards.com/WIA-DPKI
