# DPKI — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for DPKI systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across management systems and technology platforms.
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (WIA-DPKI) |
...
### 5.3 File Extensions
- `.wia-dpki.json` — JSON format
- `.wia-dpki.pb` — Protocol Buffers
