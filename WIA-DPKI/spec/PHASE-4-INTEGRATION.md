# WIA-DPKI PHASE 4 — INTEGRATION Specification
...
This document defines how a WIA-DPKI programme
...
`/.well-known/wia-WIA-DPKI` that links to the API
...
date WIA-DPKI MAY migrate historical records by
