# WIA-DPKI PHASE 2 — API-INTERFACE Specification
...
`urn:wia:WIA-DPKI:status-transition`.
...
`422` with type
`urn:wia:WIA-DPKI:source-mix-required`.
...
with type
`urn:wia:WIA-DPKI:laboratory-not-accredited`.
...
`409` with type
`urn:wia:WIA-DPKI:quality-certificate-required`.
...
- `urn:wia:WIA-DPKI:hydrogen-quality-out-of-grade`
- `urn:wia:WIA-DPKI:cryogenic-temperature-excursion`
- `urn:wia:WIA-DPKI:guarantee-of-origin-mismatch`
- `urn:wia:WIA-DPKI:evidence-mismatch`
