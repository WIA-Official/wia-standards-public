# WIA-DPKI PHASE 3 — PROTOCOL Specification
...
A WIA-DPKI operator MAY claim conformance to
WIA-DPKI only after the operating jurisdiction's
...
A programme conformant with WIA-DPKI publishes
