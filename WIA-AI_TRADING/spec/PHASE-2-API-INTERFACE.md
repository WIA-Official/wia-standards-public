# AI Trading — Phase 2: API Interface Specification
...
Phase 2 defines RESTful API endpoints for interacting with AI Trading services. This specification enables standardized programmatic access to AI model data across AI service platforms.

### 1.1 Base URL

```
Production: https://api.ai-trading.wia.org/v1
Sandbox:    https://sandbox.ai-trading.wia.org/v1
```
