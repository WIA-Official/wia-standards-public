# PHASE 2 — API INTERFACE · WIA-SPACE-024: Space Law Specification
**Version:** 1.0
**Status:** Active
...
This Phase defines the API INTERFACE layer of the *WIA-SPACE-024: Space Law Specification* WIA standard.
...
in lockstep across Phases 1–4 of WIA-SPACE-024: Space Law Specification so that conformance claims at any
