# WIA Medical Drone Delivery — PHASE Specification

**Standard slug:** `medical-drone-delivery`
**Editor's draft:** v1.0
**Status:** Normative
**License:** MIT
**弘益人間 — Benefit All Humanity**

> The PHASE documents under `spec/` are the single normative source for the WIA Medical Drone Delivery standard. Code under `api/`, `cli/`, and `simulator/` is informative reference material that demonstrates the contract; production implementations may diverge as long as they preserve the PHASE contract.
...
The Medical Drone Delivery standard targets regulated medical-payload aerial delivery deployments and is reviewed at every minor revision against the WIA crosswalk in Annex B.
...
WIA conformance for medical-drone-delivery is evaluated across three tiers:
...
- `wia-standards/standards/medical-drone-delivery/api/` — TypeScript SDK skeleton
- `wia-standards/standards/medical-drone-delivery/cli/` — POSIX shell client demonstrating the request/response contract
- `wia-standards/standards/medical-drone-delivery/simulator/` — interactive browser-based simulator for the PHASE protocol
