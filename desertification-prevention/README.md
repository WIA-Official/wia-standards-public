# WIA-desertification-prevention Desertification Prevention

> Cross-vendor data and protocol layer for Desertification Prevention.

## Overview

WIA-desertification-prevention defines standardized data formats and protocol semantics for
Desertification Prevention. The standard exposes four PHASE documents covering data
...
```bash
npm install @wia/desertification-prevention
```

```typescript
import { Client } from '@wia/desertification-prevention';
const client = new Client({ baseUrl: 'https://api.example.com/wia-desertification-prevention' });
