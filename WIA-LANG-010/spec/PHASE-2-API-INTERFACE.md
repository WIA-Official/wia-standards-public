# WIA-LANG-010 PHASE 2 — API-INTERFACE Specification
...
`urn:wia:WIA-LANG-010:status-transition`.
...
`422` with type
`urn:wia:WIA-LANG-010:source-mix-required`.
...
with type
`urn:wia:WIA-LANG-010:laboratory-not-accredited`.
...
`409` with type
`urn:wia:WIA-LANG-010:quality-certificate-required`.
...
- `urn:wia:WIA-LANG-010:hydrogen-quality-out-of-grade`
- `urn:wia:WIA-LANG-010:cryogenic-temperature-excursion`
- `urn:wia:WIA-LANG-010:guarantee-of-origin-mismatch`
- `urn:wia:WIA-LANG-010:evidence-mismatch`
