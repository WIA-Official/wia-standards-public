# WIA-support PHASE 4 — INTEGRATION Specification
...
This document defines how a support programme
...
`/.well-known/wia-support` that links to the API
...
date WIA-support MAY migrate historical records by
