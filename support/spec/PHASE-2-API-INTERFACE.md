# WIA-support PHASE 2 — API-INTERFACE Specification

**Standard:** WIA-support
...
`urn:wia:support:status-transition`.
...
`422` with type
`urn:wia:support:source-mix-required`.
...
with type
`urn:wia:support:laboratory-not-accredited`.
...
`409` with type
`urn:wia:support:quality-certificate-required`.
...
- `urn:wia:support:hydrogen-quality-out-of-grade`
- `urn:wia:support:cryogenic-temperature-excursion`
- `urn:wia:support:guarantee-of-origin-mismatch`
- `urn:wia:support:evidence-mismatch`
