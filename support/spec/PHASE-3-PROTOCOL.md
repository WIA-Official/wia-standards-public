# WIA-support PHASE 3 — PROTOCOL Specification
...
A support operator MAY claim conformance to
WIA-support only after the operating jurisdiction's
...
A programme conformant with WIA-support publishes
