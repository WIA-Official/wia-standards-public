# CDN — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for CDN systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across management systems and technology platforms.
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (cdn) |
...
### 5.3 File Extensions
- `.wia-cdn.json` — JSON format
- `.wia-cdn.pb` — Protocol Buffers
