# WIA-ART-010: Phase 4 - Integration Specification
**Version:** 1.0
**Status:** Official
...
Integration guidelines for WIA-ART-010 Interactive Art Standard.

## 2. Platform Integration

### 2.1 Web Applications
```html
<script src="https://cdn.wia.org/art-010/v1/wia-art-010.js"></script>
<script>
  const sdk = new WIAART010({
    apiKey: 'your-api-key'
  });
</script>
```
...
let sdk = WIAART010(apiKey: "your-api-key")
```

### 2.3 Server-Side Integration
```python
from wia_art_010 import SDK
