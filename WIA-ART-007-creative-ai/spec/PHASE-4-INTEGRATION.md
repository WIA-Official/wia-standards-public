# WIA-ART-007: Phase 4 - Integration Specification
**Version:** 1.0
**Status:** Official
...
Integration guidelines for WIA-ART-007 Creative AI Standard.

## 2. Platform Integration

### 2.1 Web Applications
```html
<script src="https://cdn.wia.org/art-007/v1/wia-art-007.js"></script>
<script>
  const sdk = new WIAART007({
    apiKey: 'your-api-key'
  });
</script>
```
...
let sdk = WIAART007(apiKey: "your-api-key")
```

### 2.3 Server-Side Integration
```python
from wia_art_007 import SDK
