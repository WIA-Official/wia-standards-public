# WIA-CHILD-001-online-safety Rust SDK

> **弘益人間 (Benefit All Humanity)**

Official Rust SDK for the WIA-CHILD-001-online-safety Standard.
...
```toml
[dependencies]
wia-child-001-online-safety-sdk = "1.0"
...
- ✅ **Data Validation** - Validate data against WIA-CHILD-001-online-safety standards
...
```rust
use wia_child_001_online_safety_sdk::CreateChild001OnlineSafetyRequest;

let request = CreateChild001OnlineSafetyRequest {
...
```rust
use wia_child_001_online_safety_sdk::ListParams;
...
```rust
use wia_child_001_online_safety_sdk::Error;
...
- Documentation: https://docs.wiastandards.com/WIA-CHILD-001-online-safety
