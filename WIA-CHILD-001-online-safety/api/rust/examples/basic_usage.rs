//! Basic usage example for the WIA-CHILD-001-online-safety SDK

use wia_child_001_online_safety_sdk::{Child001OnlineSafetyClient, Config, CreateChild001OnlineSafetyRequest};
use serde_json::json;
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!("🚀 WIA-CHILD-001-online-safety SDK Example");
