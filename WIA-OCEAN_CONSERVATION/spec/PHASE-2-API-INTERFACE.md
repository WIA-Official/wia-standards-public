# Ocean Conservation — Phase 2: API Interface Specification
...
Phase 2 defines RESTful API endpoints for interacting with Ocean Conservation services. This specification enables standardized programmatic access to oceanographic data across marine monitoring systems.

### 1.1 Base URL

```
Production: https://api.ocean-conservation.wia.org/v1
Sandbox:    https://sandbox.ocean-conservation.wia.org/v1
```
...
| Method | Endpoint | Description |
|--------|----------|-------------|
| POST | /data/ingest | Submit oceanographic data |
