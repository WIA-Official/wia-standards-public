# Ocean Conservation — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for Ocean Conservation systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across marine monitoring systems and maritime platforms.
...
```json
{
  ...
  "title": "WIA Ocean Conservation Data Format",
  "type": "object",
  "required": ["standard", "version", "timestamp", "data"],
  "properties": {
    "standard": {
      "type": "string",
      "const": "WIA-OCEAN_CONSERVATION"
    },
    "version": {
      "type": "string",
      "pattern": "^\\d+\\.\\d+\\.\\d+$"
    ...
    "data": {
      "type": "object",
      "description": "Primary oceanographic data payload"
    }
  }
}
```
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (WIA-OCEAN_CONSERVATION) |
...
| data | object | Yes | Domain-specific oceanographic data |
...
### 5.3 File Extensions
- `.wia-ocean-conservation.json` — JSON format
- `.wia-ocean-conservation.pb` — Protocol Buffers
...
```json
{
  "standard": "WIA-OCEAN_CONSERVATION",
  "version": "1.0.0",
