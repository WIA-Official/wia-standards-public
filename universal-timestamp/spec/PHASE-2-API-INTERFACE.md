# PHASE 2 — API INTERFACE · universal-timestamp
**Version:** 1.0
**Status:** Active
...
This Phase defines the API INTERFACE layer of the *universal-timestamp* WIA standard.
...
in lockstep across Phases 1–4 of universal-timestamp so that conformance claims at any
