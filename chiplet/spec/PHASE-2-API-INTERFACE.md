# WIA-CHIP-005 PHASE 2 — API Interface

**Standard:** WIA-CHIP-005 Chiplet Interoperability
**Phase:** 2 — API Interface
**Version:** 1.0
**Status:** Stable
**Source:** consolidated from `spec/chiplet-spec-v1.0.md` §6 (API
Interface Specification)

This document defines the REST API for chiplet registry, validation,
and conformance reporting. The full machine-readable definition lives
under `api/openapi.yaml`. Authentication uses OAuth 2.1 (RFC 9700) with
token-bound TLS 1.3. The API is versioned per Annex H.
