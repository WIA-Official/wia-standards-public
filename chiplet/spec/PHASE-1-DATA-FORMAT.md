# WIA-CHIP-005 PHASE 1 — Data Format Specification

**Standard:** WIA-CHIP-005 Chiplet Interoperability
**Phase:** 1 — Data Format
**Version:** 1.0
**Status:** Stable
**Source:** consolidated from `spec/chiplet-spec-v1.0.md` §5 (Data Format
Specification)

This document defines the canonical data structures exchanged across
WIA-CHIP-005 implementations: chiplet manifest, die identification,
package descriptors, and interconnect topology. Schemas are expressed in
JSON Schema 2020-12 and are stable for the lifetime of this PHASE.

References:
- IEEE 1838-2019 (Test Access Architecture for 3D-Stacked ICs)
- UCIe 1.1 (Universal Chiplet Interconnect Express)
- ISO/IEC 5169:2024 (Information technology — Hardware-component
  identification)
