# WIA-CHIP-005 PHASE 3 — Protocol

**Standard:** WIA-CHIP-005 Chiplet Interoperability
**Phase:** 3 — Protocol
**Version:** 1.0
**Status:** Stable
**Source:** consolidated from `spec/chiplet-spec-v1.0.md` §7 (Design
Protocol Specification)

This document defines the design and interconnect protocol used among
WIA-CHIP-005-conformant chiplets and packagers. It standardizes
hand-off events, capability negotiation, and bring-up sequencing so
that multi-vendor packaging flows are reproducible and auditable.

References:
- UCIe 1.1 link layer and protocol layer
- IEEE 1838-2019 test access protocol primitives
