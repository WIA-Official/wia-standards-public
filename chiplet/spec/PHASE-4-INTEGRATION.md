# WIA-CHIP-005 PHASE 4 — Integration

**Standard:** WIA-CHIP-005 Chiplet Interoperability
**Phase:** 4 — Integration
**Version:** 1.0
**Status:** Stable
**Source:** consolidated from `spec/chiplet-spec-v1.0.md` §8
(Integration Specification)

This document defines the integration concerns for WIA-CHIP-005
implementations: tooling integration (EDA), CI conformance pipelines,
SBOM emission, and supply-chain attestation. Implementations declare
their integration profile via the manifest in PHASE-1 and emit signed
evidence packages per Annex G.
