# Smart Water Management — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for Smart Water Management systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across smart infrastructure and IoT-enabled systems.
...
```json
{
  ...
  "title": "WIA Smart Water Management Data Format",
  "type": "object",
  "required": ["standard", "version", "timestamp", "data"],
  "properties": {
    "standard": {
      "type": "string",
      "const": "smart-water-management"
    },
    "version": {
      "type": "string",
      "pattern": "^\\d+\\.\\d+\\.\\d+$"
    ...
    "data": {
      "type": "object",
      "description": "Primary sensor data streams payload"
    }
  }
}
```
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (smart-water-management) |
...
| data | object | Yes | Domain-specific sensor data streams |
...
### 5.3 File Extensions
- `.wia-smart-water-manageme.json` — JSON format
- `.wia-smart-water-manageme.pb` — Protocol Buffers
...
```json
{
  "standard": "smart-water-management",
  "version": "1.0.0",
