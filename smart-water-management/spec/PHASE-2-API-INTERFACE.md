# Smart Water Management — Phase 2: API Interface Specification
...
Phase 2 defines RESTful API endpoints for interacting with Smart Water Management services. This specification enables standardized programmatic access to sensor data streams across smart infrastructure.

### 1.1 Base URL

```
Production: https://api.smart-water-manageme.wia.org/v1
Sandbox:    https://sandbox.smart-water-manageme.wia.org/v1
```
...
| Method | Endpoint | Description |
|--------|----------|-------------|
| POST | /data/ingest | Submit sensor data streams |
