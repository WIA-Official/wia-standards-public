# Military Satellite — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for Military Satellite systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across military command systems and defense platforms.
...
```json
{
  ...
  "title": "WIA Military Satellite Data Format",
  "type": "object",
  "required": ["standard", "version", "timestamp", "data"],
  "properties": {
    "standard": {
      "type": "string",
      "const": "military-satellite"
    },
    "version": {
      "type": "string",
      "pattern": "^\\d+\\.\\d+\\.\\d+$"
    ...
    "data": {
      "type": "object",
      "description": "Primary tactical data payload"
    }
  }
}
```
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (military-satellite) |
...
| data | object | Yes | Domain-specific tactical data |
...
### 5.3 File Extensions
- `.wia-military-satellite.json` — JSON format
- `.wia-military-satellite.pb` — Protocol Buffers
