# Military Satellite — Phase 2: API Interface Specification
...
Phase 2 defines RESTful API endpoints for interacting with Military Satellite services. This specification enables standardized programmatic access to tactical data across military command systems.

### 1.1 Base URL

```
Production: https://api.military-satellite.wia.org/v1
Sandbox:    https://sandbox.military-satellite.wia.org/v1
```
...
| Method | Endpoint | Description |
|--------|----------|-------------|
| POST | /data/ingest | Submit tactical data |
