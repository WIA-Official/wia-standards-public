...
Minimal POSIX shell client that demonstrates the WIA `cleaning-robot` standard's
...
```sh
export WIA_API_BASE="https://cleaning-robot.example.com/api/v1"
export WIA_API_TOKEN="<your-bearer-token>"
./cleaning-robot.sh list
./cleaning-robot.sh get <id>
./cleaning-robot.sh create payload.json
./cleaning-robot.sh validate payload.json
./cleaning-robot.sh export <id>
```
