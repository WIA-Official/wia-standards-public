# WIA-ROB-011: Cleaning Robot Standard

**전 세계 어디서든 인정되는 자율 청소 로봇 표준**
*Globally recognized autonomous cleaning robot standard*
...
WIA-ROB-011 is a comprehensive open standard for autonomous cleaning robots, defining data formats, APIs, communication protocols, and integration patterns. This standard enables interoperability, safety, and privacy across cleaning robot ecosystems.
