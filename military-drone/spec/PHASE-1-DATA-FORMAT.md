# Military Drone — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for Military Drone systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across military command systems and defense platforms.
...
```json
{
  ...
  "title": "WIA Military Drone Data Format",
  "type": "object",
  "required": ["standard", "version", "timestamp", "data"],
  "properties": {
    "standard": {
      "type": "string",
      "const": "military-drone"
    },
    "version": {
      "type": "string",
      "pattern": "^\\d+\\.\\d+\\.\\d+$"
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (military-drone) |
...
### 5.3 File Extensions
- `.wia-military-drone.json` — JSON format
- `.wia-military-drone.pb` — Protocol Buffers
