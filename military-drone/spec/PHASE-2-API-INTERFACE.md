# Military Drone — Phase 2: API Interface Specification
...
Phase 2 defines RESTful API endpoints for interacting with Military Drone services. This specification enables standardized programmatic access to tactical data across military command systems.

### 1.1 Base URL

```
Production: https://api.military-drone.wia.org/v1
Sandbox:    https://sandbox.military-drone.wia.org/v1
```
