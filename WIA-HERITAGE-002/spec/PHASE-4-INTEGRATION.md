...
This document defines how a WIA-HERITAGE-002 programme
...
`/.well-known/wia-WIA-HERITAGE-002` that links to the API
...
date WIA-HERITAGE-002 MAY migrate historical records by
