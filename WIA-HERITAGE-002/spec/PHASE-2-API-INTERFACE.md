# WIA-HERITAGE-002 PHASE 2 — API-INTERFACE Specification
...
`urn:wia:WIA-HERITAGE-002:status-transition`.
...
`422` with type
`urn:wia:WIA-HERITAGE-002:source-mix-required`.
...
with type
`urn:wia:WIA-HERITAGE-002:laboratory-not-accredited`.
...
`409` with type
`urn:wia:WIA-HERITAGE-002:quality-certificate-required`.
...
- `urn:wia:WIA-HERITAGE-002:hydrogen-quality-out-of-grade`
- `urn:wia:WIA-HERITAGE-002:cryogenic-temperature-excursion`
- `urn:wia:WIA-HERITAGE-002:guarantee-of-origin-mismatch`
- `urn:wia:WIA-HERITAGE-002:evidence-mismatch`
