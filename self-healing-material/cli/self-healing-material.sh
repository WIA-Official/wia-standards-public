#!/usr/bin/env bash
# self-healing-material — Self Healing Material CLI helper.
#
# Sample envelope generators for the WIA-MAT-SH-001 standard.
# Requires: bash 4+, jq.
set -euo pipefail

STD_ID="WIA-MAT-SH-001"
...
cmd_refs() {
    cat <<REFS
Normative references for WIA-MAT-SH-001 (Self Healing Material):
