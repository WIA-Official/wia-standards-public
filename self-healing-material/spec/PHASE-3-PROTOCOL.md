# WIA-MAT-SH-001 — Phase 3: PROTOCOL

> Self Healing Material canonical Phase 3 specification per the WIA Standards four-Phase architecture.

> Domain: 자가 치유 물질 — 자가 치유 물질 · 마이크로캡슐 · DA 반응 · 분자 동역학.

## A.1 Scope

This Phase covers the canonical protocol layer of the WIA-MAT-SH-001 standard. It composes with the Phase 4 document for cross-Phase integration and inherits cross-standard behaviour from the wider WIA Standards family per the README.md scope statement.
...
with `wia.standard.slug` = `self-healing-material` and `wia.standard.phase` =
...
`/.well-known/wia-self-healing-material-capabilities` enumerating per-endpoint
