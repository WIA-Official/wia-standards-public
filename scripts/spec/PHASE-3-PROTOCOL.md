# WIA-scripts PHASE 3 — PROTOCOL Specification
...
A scripts operator MAY claim conformance to
WIA-scripts only after the operating jurisdiction's
...
A programme conformant with WIA-scripts publishes
