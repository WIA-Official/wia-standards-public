# WIA-scripts PHASE 4 — INTEGRATION Specification
...
This document defines how a scripts programme
...
`/.well-known/wia-scripts` that links to the API
...
date WIA-scripts MAY migrate historical records by
