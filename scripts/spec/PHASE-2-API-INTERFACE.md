# WIA-scripts PHASE 2 — API-INTERFACE Specification

**Standard:** WIA-scripts
...
`urn:wia:scripts:status-transition`.
...
`422` with type
`urn:wia:scripts:source-mix-required`.
...
with type
`urn:wia:scripts:laboratory-not-accredited`.
...
`409` with type
`urn:wia:scripts:quality-certificate-required`.
...
- `urn:wia:scripts:hydrogen-quality-out-of-grade`
- `urn:wia:scripts:cryogenic-temperature-excursion`
- `urn:wia:scripts:guarantee-of-origin-mismatch`
- `urn:wia:scripts:evidence-mismatch`
