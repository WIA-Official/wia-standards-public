# Carbon Credit Micro — Phase 2: API Interface Specification
...
Phase 2 defines RESTful API endpoints for interacting with Carbon Credit Micro services. This specification enables standardized programmatic access to carbon emissions data across carbon tracking systems.

### 1.1 Base URL

```
Production: https://api.carbon-credit-micro.wia.org/v1
Sandbox:    https://sandbox.carbon-credit-micro.wia.org/v1
```
...
| Method | Endpoint | Description |
|--------|----------|-------------|
| POST | /data/ingest | Submit carbon emissions data |
