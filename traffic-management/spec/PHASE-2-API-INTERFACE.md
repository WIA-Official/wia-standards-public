# Traffic Management — Phase 2: API Interface Specification
...
Phase 2 defines RESTful API endpoints for interacting with Traffic Management services. This specification enables standardized programmatic access to traffic flow data across signal control systems.

### 1.1 Base URL

```
Production: https://api.traffic-management.wia.org/v1
Sandbox:    https://sandbox.traffic-management.wia.org/v1
```
...
| Method | Endpoint | Description |
|--------|----------|-------------|
| POST | /data/ingest | Submit traffic flow data |
