# Unmanned Weapon — Phase 2: API Interface Specification
...
Phase 2 defines RESTful API endpoints for interacting with Unmanned Weapon services. This specification enables standardized programmatic access to weapons system data across defense command systems.

### 1.1 Base URL

```
Production: https://api.unmanned-weapon.wia.org/v1
Sandbox:    https://sandbox.unmanned-weapon.wia.org/v1
```
