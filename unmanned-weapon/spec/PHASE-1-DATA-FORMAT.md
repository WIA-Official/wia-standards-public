# Unmanned Weapon — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for Unmanned Weapon systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across defense command systems and military platforms.
...
```json
{
  ...
  "title": "WIA Unmanned Weapon Data Format",
  "type": "object",
  "required": ["standard", "version", "timestamp", "data"],
  "properties": {
    "standard": {
      "type": "string",
      "const": "unmanned-weapon"
    },
    "version": {
      "type": "string",
      "pattern": "^\\d+\\.\\d+\\.\\d+$"
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (unmanned-weapon) |
...
### 5.3 File Extensions
- `.wia-unmanned-weapon.json` — JSON format
- `.wia-unmanned-weapon.pb` — Protocol Buffers
