...
/**
 * WIA-HERITAGE-010 SDK Client
 */
export class WIAHeritage010 {
  private config: WIAHeritage010Config;
  private endpoint: string;

  constructor(config: WIAHeritage010Config) {
    this.config = {
