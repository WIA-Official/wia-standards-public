# PHASE 2 — API INTERFACE · space-exploration
**Version:** 1.0
**Status:** Active
...
This Phase defines the API INTERFACE layer of the *space-exploration* WIA standard.
...
in lockstep across Phases 1–4 of space-exploration so that conformance claims at any
