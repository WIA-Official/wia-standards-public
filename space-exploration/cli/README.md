...
Minimal POSIX shell client that demonstrates the WIA `space-exploration` standard's
...
```sh
export WIA_API_BASE="https://space-exploration.example.com/api/v1"
export WIA_API_TOKEN="<your-bearer-token>"
./space-exploration.sh list
./space-exploration.sh get <id>
./space-exploration.sh create payload.json
./space-exploration.sh validate payload.json
./space-exploration.sh export <id>
```
