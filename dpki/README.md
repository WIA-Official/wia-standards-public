...
> Cross-vendor data and protocol layer for Dpki.

## Overview

WIA Dpki defines standardized data formats and protocol semantics.
...
issues with the `dpki` label. The WIA Standards working group reviews
