# BIO Integration — Phase 2: API Interface Specification
...
Phase 2 defines RESTful API endpoints for interacting with BIO Integration services. This specification enables standardized programmatic access to biological data across biotech research platforms.

### 1.1 Base URL

```
Production: https://api.bio-integration.wia.org/v1
Sandbox:    https://sandbox.bio-integration.wia.org/v1
```
