# BIO Integration — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for BIO Integration systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across biotech research platforms and laboratory systems.
...
```json
{
  ...
  "title": "WIA BIO Integration Data Format",
  "type": "object",
  "required": ["standard", "version", "timestamp", "data"],
  "properties": {
    "standard": {
      "type": "string",
      "const": "bio-integration"
    },
    "version": {
      "type": "string",
      "pattern": "^\\d+\\.\\d+\\.\\d+$"
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (bio-integration) |
...
### 5.3 File Extensions
- `.wia-bio-integration.json` — JSON format
- `.wia-bio-integration.pb` — Protocol Buffers
