# Industrial IOT — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for Industrial IOT systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across management systems and technology platforms.
...
```json
{
  ...
  "title": "WIA Industrial IOT Data Format",
  "type": "object",
  "required": ["standard", "version", "timestamp", "data"],
  "properties": {
    "standard": {
      "type": "string",
      "const": "industrial-iot"
    },
    "version": {
      "type": "string",
      "pattern": "^\\d+\\.\\d+\\.\\d+$"
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (industrial-iot) |
...
### 5.3 File Extensions
- `.wia-industrial-iot.json` — JSON format
- `.wia-industrial-iot.pb` — Protocol Buffers
