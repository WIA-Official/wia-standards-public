# Industrial IOT — Phase 4: Integration Specification
...
Phase 4 defines integration patterns and requirements for deploying Industrial IOT within existing infrastructure. This specification covers system architecture, integration patterns, testing requirements, and deployment guidelines for management systems and technology platforms.
...
- Implement the `WIAindustrial_iotAdapter` interface
...
```json
{
  ...
  "channels": [
    "industrial-iot.data.ingested",
    "industrial-iot.resource.updated",
    "industrial-iot.alert.triggered"
  ]
}
```
