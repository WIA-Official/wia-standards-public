...
Minimal POSIX shell client that demonstrates the WIA `industrial-iot` standard's
...
```sh
export WIA_API_BASE="https://industrial-iot.example.com/api/v1"
export WIA_API_TOKEN="<your-bearer-token>"
./industrial-iot.sh list
./industrial-iot.sh get <id>
./industrial-iot.sh create payload.json
./industrial-iot.sh validate payload.json
./industrial-iot.sh export <id>
```
