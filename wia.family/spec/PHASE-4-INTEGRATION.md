# WIA-wia.family PHASE 4 — INTEGRATION Specification
...
This document defines how a wia.family programme
...
`/.well-known/wia-wia.family` that links to the API
...
date WIA-wia.family MAY migrate historical records by
