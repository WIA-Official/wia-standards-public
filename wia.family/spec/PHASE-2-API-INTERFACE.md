# WIA-wia.family PHASE 2 — API-INTERFACE Specification

**Standard:** WIA-wia.family
...
`urn:wia:wia.family:status-transition`.
...
`422` with type
`urn:wia:wia.family:source-mix-required`.
...
with type
`urn:wia:wia.family:laboratory-not-accredited`.
...
`409` with type
`urn:wia:wia.family:quality-certificate-required`.
...
- `urn:wia:wia.family:hydrogen-quality-out-of-grade`
- `urn:wia:wia.family:cryogenic-temperature-excursion`
- `urn:wia:wia.family:guarantee-of-origin-mismatch`
- `urn:wia:wia.family:evidence-mismatch`
