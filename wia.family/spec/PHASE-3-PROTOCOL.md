# WIA-wia.family PHASE 3 — PROTOCOL Specification
...
A wia.family operator MAY claim conformance to
WIA-wia.family only after the operating jurisdiction's
...
A programme conformant with WIA-wia.family publishes
