# Augmentation Safety — Phase 2: API Interface Specification
...
Phase 2 defines RESTful API endpoints for interacting with Augmentation Safety services. This specification enables standardized programmatic access to augmentation parameters across enhancement systems.

### 1.1 Base URL

```
Production: https://api.augmentation-safety.wia.org/v1
Sandbox:    https://sandbox.augmentation-safety.wia.org/v1
```
...
| Method | Endpoint | Description |
|--------|----------|-------------|
| POST | /data/ingest | Submit augmentation parameters |
