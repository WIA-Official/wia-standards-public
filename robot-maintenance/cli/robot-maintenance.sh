#!/usr/bin/env bash
# robot-maintenance — Robot Maintenance CLI helper.
#
# Sample envelope generators for the WIA-ROBOT-MAINT-001 standard.
# Requires: bash 4+, jq.
set -euo pipefail

STD_ID="WIA-ROBOT-MAINT-001"
SLUG="robot-maintenance"
...
cmd_refs() {
    cat <<REFS
Normative references for WIA-ROBOT-MAINT-001 (Robot Maintenance):
