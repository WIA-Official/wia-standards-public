...
WIA standard `industrial-robot` — see <https://wiastandards.com> for the full standards catalogue.
...
WIA conformance for **industrial-robot** is evaluated across three tiers, mirrored in every PHASE document under `spec/`:
