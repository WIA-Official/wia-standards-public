# `industrial-robot` CLI

Minimal POSIX shell client that demonstrates the WIA `industrial-robot` standard's
...
```sh
export WIA_API_BASE="https://industrial-robot.example.com/api/v1"
export WIA_API_TOKEN="<your-bearer-token>"
./industrial-robot.sh list
./industrial-robot.sh get <id>
./industrial-robot.sh create payload.json
./industrial-robot.sh validate payload.json
./industrial-robot.sh export <id>
```
