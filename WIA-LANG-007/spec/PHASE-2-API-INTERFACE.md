# Lang 007 — Phase 2: API Interface Specification
...
Phase 2 defines RESTful API endpoints for interacting with Lang 007 services. This specification enables standardized programmatic access to linguistic data across NLP processing systems.

### 1.1 Base URL

```
Production: https://api.lang-007.wia.org/v1
Sandbox:    https://sandbox.lang-007.wia.org/v1
```
