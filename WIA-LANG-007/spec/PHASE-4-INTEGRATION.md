# WIA-LANG-007 PHASE 4 — INTEGRATION Specification
...
This document defines how a WIA-LANG-007 programme
...
`/.well-known/wia-WIA-LANG-007` that links to the API
...
date WIA-LANG-007 MAY migrate historical records by
