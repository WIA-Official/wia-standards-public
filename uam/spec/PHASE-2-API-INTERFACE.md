# PHASE 2 — API INTERFACE · WIA-SPACE-018: Urban Air Mobility (UAM) Standard
**Version:** 1.0
**Status:** Active
...
This Phase defines the API INTERFACE layer of the *WIA-SPACE-018: Urban Air Mobility (UAM) Standard* WIA standard.
...
in lockstep across Phases 1–4 of WIA-SPACE-018: Urban Air Mobility (UAM) Standard so that conformance claims at any
