# Embedded Software — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for Embedded Software systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across management systems and technology platforms.
...
```json
{
  ...
  "title": "WIA Embedded Software Data Format",
  "type": "object",
  "required": ["standard", "version", "timestamp", "data"],
  "properties": {
    "standard": {
      "type": "string",
      "const": "embedded-software"
    },
    "version": {
      "type": "string",
      "pattern": "^\\d+\\.\\d+\\.\\d+$"
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (embedded-software) |
...
### 5.3 File Extensions
- `.wia-embedded-software.json` — JSON format
- `.wia-embedded-software.pb` — Protocol Buffers
