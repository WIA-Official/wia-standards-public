#!/usr/bin/env bash
# smart-government — Smart Government CLI helper.
#
# Sample envelope generators for the WIA-GOV-001 standard.
# Requires: bash 4+, jq.
set -euo pipefail
...
cmd_refs() {
    cat <<REFS
Normative references for WIA-GOV-001 (Smart Government):
