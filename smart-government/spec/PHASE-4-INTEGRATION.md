# WIA-GOV-001 — Phase 4: INTEGRATION

> Smart Government canonical Phase 4 specification per the WIA Standards four-Phase architecture.

> Domain: 스마트 거버넌스 — 디지털 정부 · GovTech · eIDAS · 시민 디지털 신원 · 개방데이터.

## A.1 Scope

This Phase covers the canonical integration layer of the WIA-GOV-001 standard. It composes with the Phase 1 document for cross-Phase integration and inherits cross-standard behaviour from the wider WIA Standards family per the README.md scope statement.
