# WIA Medical Research Data — PHASE Specification

**Standard slug:** `medical-research-data`
**Editor's draft:** v1.0
**Status:** Normative
**License:** MIT
**弘益人間 — Benefit All Humanity**

> The PHASE documents under `spec/` are the single normative source for the WIA Medical Research Data standard. Code under `api/`, `cli/`, and `simulator/` is informative reference material that demonstrates the contract; production implementations may diverge as long as they preserve the PHASE contract.
...
The Medical Research Data standard targets FAIR-aligned research-data exchange deployments and is reviewed at every minor revision against the WIA crosswalk in Annex B.
...
WIA conformance for medical-research-data is evaluated across three tiers:
...
- `wia-standards/standards/medical-research-data/api/` — TypeScript SDK skeleton
- `wia-standards/standards/medical-research-data/cli/` — POSIX shell client demonstrating the request/response contract
- `wia-standards/standards/medical-research-data/simulator/` — interactive browser-based simulator for the PHASE protocol
