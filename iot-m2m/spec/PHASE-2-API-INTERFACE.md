# IOT M2m — Phase 2: API Interface Specification
...
Phase 2 defines RESTful API endpoints for interacting with IOT M2m services. This specification enables standardized programmatic access to operational data across management systems.

### 1.1 Base URL

```
Production: https://api.iot-m2m.wia.org/v1
Sandbox:    https://sandbox.iot-m2m.wia.org/v1
```
