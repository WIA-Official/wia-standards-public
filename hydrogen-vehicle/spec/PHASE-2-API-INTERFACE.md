# Hydrogen Vehicle — Phase 2: API Interface Specification
...
Phase 2 defines RESTful API endpoints for interacting with Hydrogen Vehicle services. This specification enables standardized programmatic access to vehicle data across transportation networks.

### 1.1 Base URL

```
Production: https://api.hydrogen-vehicle.wia.org/v1
Sandbox:    https://sandbox.hydrogen-vehicle.wia.org/v1
```
