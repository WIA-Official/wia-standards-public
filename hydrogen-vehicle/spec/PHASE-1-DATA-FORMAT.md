# Hydrogen Vehicle — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for Hydrogen Vehicle systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across transportation networks and vehicular systems.
...
```json
{
  ...
  "title": "WIA Hydrogen Vehicle Data Format",
  "type": "object",
  "required": ["standard", "version", "timestamp", "data"],
  "properties": {
    "standard": {
      "type": "string",
      "const": "hydrogen-vehicle"
    },
    "version": {
      "type": "string",
      "pattern": "^\\d+\\.\\d+\\.\\d+$"
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (hydrogen-vehicle) |
...
### 5.3 File Extensions
- `.wia-hydrogen-vehicle.json` — JSON format
- `.wia-hydrogen-vehicle.pb` — Protocol Buffers
