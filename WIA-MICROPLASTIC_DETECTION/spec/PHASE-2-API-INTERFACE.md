# Microplastic Detection — Phase 2: API Interface Specification
...
Phase 2 defines RESTful API endpoints for interacting with Microplastic Detection services. This specification enables standardized programmatic access to micro-scale measurement data across detection systems.

### 1.1 Base URL

```
Production: https://api.microplastic-detecti.wia.org/v1
Sandbox:    https://sandbox.microplastic-detecti.wia.org/v1
```
...
| Method | Endpoint | Description |
|--------|----------|-------------|
| POST | /data/ingest | Submit micro-scale measurement data |
