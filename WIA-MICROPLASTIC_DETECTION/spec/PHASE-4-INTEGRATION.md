# Microplastic Detection — Phase 4: Integration Specification
...
Phase 4 defines integration patterns and requirements for deploying Microplastic Detection within existing infrastructure. This specification covers system architecture, integration patterns, testing requirements, and deployment guidelines for detection systems and analytical platforms.

### 1.1 Integration Goals

- **Interoperability:** Seamless data exchange with existing Micro Technology systems
...
For connecting legacy detection systems:
- Implement the `WIAWIA_MICROPLASTIC_DETECTIONAdapter` interface
...
```json
{
  ...
  "channels": [
    "wia-microplastic_detection.data.ingested",
    "wia-microplastic_detection.resource.updated",
    "wia-microplastic_detection.alert.triggered"
  ]
}
```
...
```
WIA_STANDARD=WIA-MICROPLASTIC_DETECTION
WIA_VERSION=1.0.0
WIA_LOG_LEVEL=info
