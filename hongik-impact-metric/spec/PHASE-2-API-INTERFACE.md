# Hongik Impact Metric — Phase 2: API Interface Specification
...
Phase 2 defines RESTful API endpoints for interacting with Hongik Impact Metric services. This specification enables standardized programmatic access to operational data across management systems.

### 1.1 Base URL

```
Production: https://api.hongik-impact-metric.wia.org/v1
Sandbox:    https://sandbox.hongik-impact-metric.wia.org/v1
```
