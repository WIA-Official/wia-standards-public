# Hongik Impact Metric — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for Hongik Impact Metric systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across management systems and technology platforms.
...
```json
{
  ...
  "title": "WIA Hongik Impact Metric Data Format",
  "type": "object",
  "required": ["standard", "version", "timestamp", "data"],
  "properties": {
    "standard": {
      "type": "string",
      "const": "hongik-impact-metric"
    },
    "version": {
      "type": "string",
      "pattern": "^\\d+\\.\\d+\\.\\d+$"
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (hongik-impact-metric) |
...
### 5.3 File Extensions
- `.wia-hongik-impact-metric.json` — JSON format
- `.wia-hongik-impact-metric.pb` — Protocol Buffers
