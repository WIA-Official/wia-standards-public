# Predictive Maintenance — Phase 2: API Interface Specification
...
Phase 2 defines RESTful API endpoints for interacting with Predictive Maintenance services. This specification enables standardized programmatic access to AI model data across AI service platforms.

### 1.1 Base URL

```
Production: https://api.predictive-maintenan.wia.org/v1
Sandbox:    https://sandbox.predictive-maintenan.wia.org/v1
```
...
| Method | Endpoint | Description |
|--------|----------|-------------|
| POST | /data/ingest | Submit AI model data |
