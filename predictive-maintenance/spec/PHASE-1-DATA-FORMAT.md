# Predictive Maintenance — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for Predictive Maintenance systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across AI service platforms and AI processing systems.
...
```json
{
  ...
  "title": "WIA Predictive Maintenance Data Format",
  "type": "object",
  "required": ["standard", "version", "timestamp", "data"],
  "properties": {
    "standard": {
      "type": "string",
      "const": "predictive-maintenance"
    },
    "version": {
      "type": "string",
      "pattern": "^\\d+\\.\\d+\\.\\d+$"
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (predictive-maintenance) |
...
### 5.3 File Extensions
- `.wia-predictive-maintenan.json` — JSON format
- `.wia-predictive-maintenan.pb` — Protocol Buffers
