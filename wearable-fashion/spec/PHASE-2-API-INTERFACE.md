# Wearable Fashion — Phase 2: API Interface Specification
...
Phase 2 defines RESTful API endpoints for interacting with Wearable Fashion services. This specification enables standardized programmatic access to wearable sensor data across wearable platforms.

### 1.1 Base URL

```
Production: https://api.wearable-fashion.wia.org/v1
Sandbox:    https://sandbox.wearable-fashion.wia.org/v1
```
