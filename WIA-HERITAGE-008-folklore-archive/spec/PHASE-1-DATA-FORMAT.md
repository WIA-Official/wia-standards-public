# WIA-HERITAGE-008: Phase 1 - Data Format Specification
...
<rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#"
         xmlns:wia="http://wia.org/heritage/008#">
  <rdf:Description rdf:about="artifact_008.tif">
    <wia:artifactID>WIA-ART-2025-008</wia:artifactID>
...
```json
{
  ...
  "dc:identifier": "WIA-ART-2025-008",
...
@prefix wia: <http://wia.org/heritage/008#> .

<artifact:008> a crm:E22_Human-Made_Object ;
    crm:P1_is_identified_by "WIA-ART-2025-008" ;
    crm:P45_consists_of <material:terracotta> ;
    crm:P108i_was_produced_by <production:008> ;
    crm:P52_has_current_owner <institution:museum> ;
    crm:P55_has_current_location <location:athens> ;
    wia:hasDigitalRepresentation <model:008> .

<production:008> a crm:E12_Production ;
    crm:P4_has_time-span <timespan:450-400-bce> ;
    crm:P7_took_place_at <place:athens> .
```

### 3.3 WIA-HERITAGE-008 Extended Schema

```json
{
  "wia": {
    "version": "1.0",
    "standard": "WIA-HERITAGE-008",
    "artifact": {
      "id": "WIA-ART-2025-008",
...
Examples:
NAM_GR_WIA-ART-2025-008_model_v1_archive.glb
NAM_GR_WIA-ART-2025-008_texture_v1_4k.png
NAM_GR_WIA-ART-2025-008_metadata_v1.json
NAM_GR_WIA-ART-2025-008_photo_008_raw.tif
```
