...
/**
 * WIA-HERITAGE-008 SDK Client
 */
export class WIAHeritage008 {
  private config: WIAHeritage008Config;
  private endpoint: string;

  constructor(config: WIAHeritage008Config) {
    this.config = {
