# WIA-SPACE-017 PHASE 3 — Protocol

**Standard:** WIA-SPACE-017 Drone / UAV
**Phase:** 3 — Protocol
**Version:** 1.0
**Status:** Stable
**Source:** consolidated from `drone-uav-v1.0.md` §4 (Operational
Standards) and `WIA-SPACE-017-v1.0.md` §7 (Software and Firmware)

This document defines the protocols for command-and-control links,
mission upload/download, and over-the-air firmware update. References
authoritative cybersecurity baselines (IEC 62443) and operational
guidance (ICAO Annex 6) without reproducing them; conformance is
checked against those primary sources.
