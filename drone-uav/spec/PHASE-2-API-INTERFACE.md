# WIA-SPACE-017 PHASE 2 — API Interface

**Standard:** WIA-SPACE-017 Drone / UAV
**Phase:** 2 — API Interface
**Version:** 1.0
**Status:** Stable
**Source:** consolidated from `drone-uav-v1.0.md` §6 (Communication
Standards) + §8 (Data Management) and `WIA-SPACE-017-v1.0.md` §8
(Communication Protocols)

This document defines the REST and WebSocket APIs for fleet management,
mission planning, telemetry ingestion, and payload data retrieval. The
