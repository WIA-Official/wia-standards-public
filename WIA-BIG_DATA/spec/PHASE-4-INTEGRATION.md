# BIG Data — Phase 4: Integration Specification
...
Phase 4 defines integration patterns and requirements for deploying BIG Data within existing infrastructure. This specification covers system architecture, integration patterns, testing requirements, and deployment guidelines for management systems and technology platforms.
...
- Implement the `WIAWIA_BIG_DATAAdapter` interface
...
```json
{
  ...
  "channels": [
    "wia-big_data.data.ingested",
    "wia-big_data.resource.updated",
    "wia-big_data.alert.triggered"
  ]
}
```
