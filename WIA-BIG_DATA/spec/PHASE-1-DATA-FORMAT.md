# BIG Data — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for BIG Data systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across management systems and technology platforms.
...
```json
{
  ...
  "title": "WIA BIG Data Data Format",
  "type": "object",
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (WIA-BIG_DATA) |
...
### 5.3 File Extensions
- `.wia-big-data.json` — JSON format
- `.wia-big-data.pb` — Protocol Buffers
