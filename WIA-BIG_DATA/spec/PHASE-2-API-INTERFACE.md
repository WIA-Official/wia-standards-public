# BIG Data — Phase 2: API Interface Specification
...
Phase 2 defines RESTful API endpoints for interacting with BIG Data services. This specification enables standardized programmatic access to operational data across management systems.

### 1.1 Base URL

```
Production: https://api.big-data.wia.org/v1
Sandbox:    https://sandbox.big-data.wia.org/v1
```
