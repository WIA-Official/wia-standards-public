# WIA-MAT-SMART-001 — Phase 3: PROTOCOL

> Smart Material canonical Phase 3 specification per the WIA Standards four-Phase architecture.

> Domain: 스마트 물질 — 스마트 물질 · 압전체 · 자기변형체 · ER/MR 유체 · 능동 제어.

## A.1 Scope

This Phase covers the canonical protocol layer of the WIA-MAT-SMART-001 standard. It composes with the Phase 4 document for cross-Phase integration and inherits cross-standard behaviour from the wider WIA Standards family per the README.md scope statement.
