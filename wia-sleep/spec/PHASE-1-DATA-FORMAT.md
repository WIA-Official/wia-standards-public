# WIA Sleep — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for WIA Sleep systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across sleep monitoring systems and wellness devices.
...
```json
{
  ...
  "title": "WIA WIA Sleep Data Format",
  "type": "object",
  ...
  "properties": {
    ...
    "data": {
      "type": "object",
      "description": "Primary sleep pattern data payload"
    }
  }
}
```
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (wia-sleep) |
...
| data | object | Yes | Domain-specific sleep pattern data |
...
### 5.3 File Extensions
- `.wia-sleep.json` — JSON format
- `.wia-sleep.pb` — Protocol Buffers
