# WIA Sleep — Phase 2: API Interface Specification
...
Phase 2 defines RESTful API endpoints for interacting with WIA Sleep services. This specification enables standardized programmatic access to sleep pattern data across sleep monitoring systems.

### 1.1 Base URL

```
Production: https://api.sleep.wia.org/v1
Sandbox:    https://sandbox.sleep.wia.org/v1
```
...
| Method | Endpoint | Description |
|--------|----------|-------------|
| POST | /data/ingest | Submit sleep pattern data |
