# Asteroid Mining — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for Asteroid Mining systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across management systems and technology platforms.
...
```json
{
  ...
  "title": "WIA Asteroid Mining Data Format",
  "type": "object",
  "required": ["standard", "version", "timestamp", "data"],
  "properties": {
    "standard": {
      "type": "string",
      "const": "WIA-ASTEROID_MINING"
    },
    "version": {
      "type": "string",
      "pattern": "^\\d+\\.\\d+\\.\\d+$"
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (WIA-ASTEROID_MINING) |
...
### 5.3 File Extensions
- `.wia-asteroid-mining.json` — JSON format
- `.wia-asteroid-mining.pb` — Protocol Buffers
