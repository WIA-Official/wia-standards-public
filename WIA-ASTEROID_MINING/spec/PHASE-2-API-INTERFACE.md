# Asteroid Mining — Phase 2: API Interface Specification
...
Phase 2 defines RESTful API endpoints for interacting with Asteroid Mining services. This specification enables standardized programmatic access to operational data across management systems.

### 1.1 Base URL

```
Production: https://api.asteroid-mining.wia.org/v1
Sandbox:    https://sandbox.asteroid-mining.wia.org/v1
```
