# WIA-MAT-SM-001 — Phase 3: PROTOCOL

> Shape Memory Material canonical Phase 3 specification per the WIA Standards four-Phase architecture.

> Domain: 형상 기억 물질 — 형상 기억 합금 · NiTi · 형상 기억 폴리머 · 의료 디바이스.

## A.1 Scope

This Phase covers the canonical protocol layer of the WIA-MAT-SM-001 standard. It composes with the Phase 4 document for cross-Phase integration and inherits cross-standard behaviour from the wider WIA Standards family per the README.md scope statement.
