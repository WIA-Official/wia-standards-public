# WIA-MAT-SM-001 — Phase 1: DATA-FORMAT

> Shape Memory Material canonical Phase 1 specification per the WIA Standards four-Phase architecture.

> Domain: 형상 기억 물질 — 형상 기억 합금 · NiTi · 형상 기억 폴리머 · 의료 디바이스.

## A.1 Scope

This Phase covers the canonical data-format layer of the WIA-MAT-SM-001 standard. It composes with the Phase 2 document for cross-Phase integration and inherits cross-standard behaviour from the wider WIA Standards family per the README.md scope statement.
...
with `wia.standard.slug` = `shape-memory-material` and `wia.standard.phase` =
...
`/.well-known/wia-shape-memory-material-capabilities` enumerating per-endpoint
