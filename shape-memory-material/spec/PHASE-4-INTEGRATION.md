# WIA-MAT-SM-001 — Phase 4: INTEGRATION

> Shape Memory Material canonical Phase 4 specification per the WIA Standards four-Phase architecture.

> Domain: 형상 기억 물질 — 형상 기억 합금 · NiTi · 형상 기억 폴리머 · 의료 디바이스.

## A.1 Scope

This Phase covers the canonical integration layer of the WIA-MAT-SM-001 standard. It composes with the Phase 1 document for cross-Phase integration and inherits cross-standard behaviour from the wider WIA Standards family per the README.md scope statement.
