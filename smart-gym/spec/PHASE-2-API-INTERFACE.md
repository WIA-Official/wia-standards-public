# Smart GYM — Phase 2: API Interface Specification
...
Phase 2 defines RESTful API endpoints for interacting with Smart GYM services. This specification enables standardized programmatic access to sensor data streams across smart infrastructure.

### 1.1 Base URL

```
Production: https://api.smart-gym.wia.org/v1
Sandbox:    https://sandbox.smart-gym.wia.org/v1
```
