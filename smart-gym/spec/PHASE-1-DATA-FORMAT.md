# Smart GYM — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for Smart GYM systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across smart infrastructure and IoT-enabled systems.
...
```json
{
  ...
  "title": "WIA Smart GYM Data Format",
  "type": "object",
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (smart-gym) |
...
### 5.3 File Extensions
- `.wia-smart-gym.json` — JSON format
- `.wia-smart-gym.pb` — Protocol Buffers
