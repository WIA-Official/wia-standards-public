# WIA-DDOS_PROTECTION Rust SDK

> **弘益人間 (Benefit All Humanity)**

Official Rust SDK for the WIA-DDOS_PROTECTION Standard.
...
```rust
use wia_ddos_protection_sdk::CreateDdosProtectionRequest;

let request = CreateDdosProtectionRequest {
...
```rust
use wia_ddos_protection_sdk::ListParams;
...
```rust
use wia_ddos_protection_sdk::Error;
...
- Documentation: https://docs.wiastandards.com/WIA-DDOS_PROTECTION
