# WIA-DDOS_PROTECTION: Phase 2 - API Interface Specification
**Version:** 1.0
**Status:** Official
...
This document specifies the API interface requirements for DDOS PROTECTION. All implementations MUST provide these endpoints to ensure interoperability.

## 2. REST API Endpoints

### 2.1 Base URL
```
https://api.wia.org/v1/wia-ddos-protection/
```
...
```http
POST /v1/wia-ddos-protection/records HTTP/1.1
...
### 3.1 Installation
```bash
npm install @wia/wia-ddos-protection-sdk
```
...
### 3.3 Usage Example
```typescript
import { createClient } from '@wia/wia-ddos-protection-sdk';
...
WIA conformance for WIA-DDOS_PROTECTION is evaluated across three tiers:
...
- `wia-standards/standards/WIA-DDOS_PROTECTION/api/` — TypeScript SDK skeleton
- `wia-standards/standards/WIA-DDOS_PROTECTION/cli/` — POSIX shell client demonstrating the request/response contract
- `wia-standards/standards/WIA-DDOS_PROTECTION/simulator/` — interactive browser-based simulator for the PHASE protocol
