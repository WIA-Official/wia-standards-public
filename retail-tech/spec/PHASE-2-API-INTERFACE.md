# Retail Tech — Phase 2: API Interface Specification
...
Phase 2 defines RESTful API endpoints for interacting with Retail Tech services. This specification enables standardized programmatic access to AI model data across AI service platforms.

### 1.1 Base URL

```
Production: https://api.retail-tech.wia.org/v1
Sandbox:    https://sandbox.retail-tech.wia.org/v1
```
