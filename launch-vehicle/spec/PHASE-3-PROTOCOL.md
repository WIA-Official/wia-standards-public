# WIA Launch Vehicle — PHASE Specification

**Standard slug:** `launch-vehicle`
**Editor's draft:** v1.0
**Status:** Normative
**License:** MIT
**弘益人間 — Benefit All Humanity**

> The PHASE documents under `spec/` are the single normative source for the WIA Launch Vehicle standard. Code under `api/`, `cli/`, and `simulator/` is informative reference material that demonstrates the contract; production implementations may diverge as long as they preserve the PHASE contract.
...
The Launch Vehicle standard targets space-launch and orbital-payload deployments and is reviewed at every minor revision against the WIA crosswalk in Annex B.
...
WIA conformance for launch-vehicle is evaluated across three tiers:
...
- `wia-standards/standards/launch-vehicle/api/` — TypeScript SDK skeleton
- `wia-standards/standards/launch-vehicle/cli/` — POSIX shell client demonstrating the request/response contract
- `wia-standards/standards/launch-vehicle/simulator/` — interactive browser-based simulator for the PHASE protocol
