# Augmentation Ethics — Phase 2: API Interface Specification
...
Phase 2 defines RESTful API endpoints for interacting with Augmentation Ethics services. This specification enables standardized programmatic access to augmentation parameters across enhancement systems.

### 1.1 Base URL

```
Production: https://api.augmentation-ethics.wia.org/v1
Sandbox:    https://sandbox.augmentation-ethics.wia.org/v1
```
