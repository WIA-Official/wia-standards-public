# AI Human Collaboration — Phase 2: API Interface Specification
...
Phase 2 defines RESTful API endpoints for interacting with AI Human Collaboration services. This specification enables standardized programmatic access to AI model data across AI service platforms.

### 1.1 Base URL

```
Production: https://api.ai-human-collaborati.wia.org/v1
Sandbox:    https://sandbox.ai-human-collaborati.wia.org/v1
```
