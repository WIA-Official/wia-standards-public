# Assistive Wearable — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for Assistive Wearable systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across wearable platforms and body-worn devices.
...
```json
{
  ...
  "title": "WIA Assistive Wearable Data Format",
  "type": "object",
  "required": ["standard", "version", "timestamp", "data"],
  "properties": {
    "standard": {
      "type": "string",
      "const": "WIA-ASSISTIVE_WEARABLE"
    },
    "version": {
      "type": "string",
      "pattern": "^\\d+\\.\\d+\\.\\d+$"
    ...
    "data": {
      "type": "object",
      "description": "Primary wearable sensor data payload"
    }
  }
}
```
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (WIA-ASSISTIVE_WEARABLE) |
...
| data | object | Yes | Domain-specific wearable sensor data |
...
### 5.3 File Extensions
- `.wia-assistive-wearable.json` — JSON format
- `.wia-assistive-wearable.pb` — Protocol Buffers
...
```json
{
  "standard": "WIA-ASSISTIVE_WEARABLE",
  "version": "1.0.0",
