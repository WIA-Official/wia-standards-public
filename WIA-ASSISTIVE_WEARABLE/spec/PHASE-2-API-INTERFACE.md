# Assistive Wearable — Phase 2: API Interface Specification
...
Phase 2 defines RESTful API endpoints for interacting with Assistive Wearable services. This specification enables standardized programmatic access to wearable sensor data across wearable platforms.

### 1.1 Base URL

```
Production: https://api.assistive-wearable.wia.org/v1
Sandbox:    https://sandbox.assistive-wearable.wia.org/v1
```
...
| Method | Endpoint | Description |
|--------|----------|-------------|
| POST | /data/ingest | Submit wearable sensor data |
