...
/**
 * WIA-HERITAGE-004 SDK Client
 */
export class WIAHeritage004 {
  private config: WIAHeritage004Config;
  private endpoint: string;

  constructor(config: WIAHeritage004Config) {
    this.config = {
