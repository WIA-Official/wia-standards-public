# WIA-LANG-003 PHASE 2 — API-INTERFACE Specification
...
`urn:wia:WIA-LANG-003:status-transition`.
...
`422` with type
`urn:wia:WIA-LANG-003:source-mix-required`.
...
with type
`urn:wia:WIA-LANG-003:laboratory-not-accredited`.
...
`409` with type
`urn:wia:WIA-LANG-003:quality-certificate-required`.
...
- `urn:wia:WIA-LANG-003:hydrogen-quality-out-of-grade`
- `urn:wia:WIA-LANG-003:cryogenic-temperature-excursion`
- `urn:wia:WIA-LANG-003:guarantee-of-origin-mismatch`
- `urn:wia:WIA-LANG-003:evidence-mismatch`
