# EVTOL — Phase 4: Integration Specification
...
Phase 4 defines integration patterns and requirements for deploying EVTOL within existing infrastructure. This specification covers system architecture, integration patterns, testing requirements, and deployment guidelines for management systems and technology platforms.
...
- Implement the `WIAWIA_EVTOLAdapter` interface
...
```json
{
  ...
  "channels": [
    "wia-evtol.data.ingested",
    "wia-evtol.resource.updated",
    "wia-evtol.alert.triggered"
  ]
}
```
