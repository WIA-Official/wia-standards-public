# PHASE 2 — API INTERFACE · quantum-chip
**Version:** 1.0
**Status:** Active
...
This Phase defines the API INTERFACE layer of the *quantum-chip* WIA standard.
...
in lockstep across Phases 1–4 of quantum-chip so that conformance claims at any
