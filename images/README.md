...
WIA standard `images` — see <https://wiastandards.com> for the full standards catalogue.
...
WIA conformance for **images** is evaluated across three tiers, mirrored in every PHASE document under `spec/`:
