...
Minimal POSIX shell client that demonstrates the WIA `images` standard's
...
```sh
export WIA_API_BASE="https://images.example.com/api/v1"
export WIA_API_TOKEN="<your-bearer-token>"
./images.sh list
./images.sh get <id>
./images.sh create payload.json
./images.sh validate payload.json
./images.sh export <id>
```
