...
Minimal POSIX shell client that demonstrates the WIA `prompts` standard's
...
```sh
export WIA_API_BASE="https://prompts.example.com/api/v1"
export WIA_API_TOKEN="<your-bearer-token>"
./prompts.sh list
./prompts.sh get <id>
./prompts.sh create payload.json
./prompts.sh validate payload.json
./prompts.sh export <id>
```
