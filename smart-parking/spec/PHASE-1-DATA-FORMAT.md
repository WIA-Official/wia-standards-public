# Smart Parking — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for Smart Parking systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across smart infrastructure and IoT-enabled systems.
...
```json
{
  ...
  "title": "WIA Smart Parking Data Format",
  "type": "object",
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (smart-parking) |
...
### 5.3 File Extensions
- `.wia-smart-parking.json` — JSON format
- `.wia-smart-parking.pb` — Protocol Buffers
