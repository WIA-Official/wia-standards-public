...
Minimal POSIX shell client that demonstrates the WIA `gas-supply` standard's
...
```sh
export WIA_API_BASE="https://gas-supply.example.com/api/v1"
export WIA_API_TOKEN="<your-bearer-token>"
./gas-supply.sh list
./gas-supply.sh get <id>
./gas-supply.sh create payload.json
./gas-supply.sh validate payload.json
./gas-supply.sh export <id>
```
