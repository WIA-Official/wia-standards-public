# Synthetic Biology — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for Synthetic Biology systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across biotech research platforms and laboratory systems.
...
```json
{
  ...
  "title": "WIA Synthetic Biology Data Format",
  "type": "object",
  "required": ["standard", "version", "timestamp", "data"],
  "properties": {
    "standard": {
      "type": "string",
      "const": "WIA-SYNTHETIC-BIOLOGY"
    },
    "version": {
      "type": "string",
      "pattern": "^\\d+\\.\\d+\\.\\d+$"
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (WIA-SYNTHETIC-BIOLOGY) |
...
### 5.3 File Extensions
- `.wia-synthetic-biology.json` — JSON format
- `.wia-synthetic-biology.pb` — Protocol Buffers
