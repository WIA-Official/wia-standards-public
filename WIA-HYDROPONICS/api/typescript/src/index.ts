/**
 * WIA-HYDROPONICS TypeScript SDK
 * Version: 1.0.0
 * Philosophy: 弘益人間 (Benefit All Humanity)
 *
 * Comprehensive HYDROPONICS SDK supporting:
...
/**
 * Main WIA-HYDROPONICS SDK Class
 *
 * @example
 * ```typescript
 ...
 * ```
 */
export class WIAHYDROPONICSSDK {
  ...
  constructor(config: SDKConfig) {
    this.config = {
      ...
      baseURL: config.baseURL || 'https://api.wia-hydroponics.org/v1',
  ...
  /**
   * Get all supported HYDROPONICS protocols
 ...
 * Create SDK instance
 */
export function createWIAHYDROPONICSSDK(config: SDKConfig): WIAHYDROPONICSSDK {
  return new WIAHYDROPONICSSDK(config);
}

/**
 * Default export
 */
export default WIAHYDROPONICSSDK;
