...
- **Type-Safe**: Full TypeScript support with comprehensive type hydroponicsnitions
...
# or
yarn add @wia/hydroponics-sdk
# or
pnpm add @wia/hydroponics-sdk
```

## Quick Start

```typescript
import { WIADeFiSDK } from '@wia/hydroponics-sdk';
...
Get your API key at: https://api.wia-hydroponics.org/register
...
- Documentation: https://docs.wia.org/hydroponics-sdk
