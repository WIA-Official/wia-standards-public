# WIA-HYDROPONICS Specification - PHASE 2
...
The WIA-HYDROPONICS standard supports multiple API paradigms:
...
```typescript
import { WIAHydroponics & Vertical FarmingSDK } from '@wia/defi-sdk';

// Initialize SDK
const sdk = new WIAHydroponics & Vertical FarmingSDK({
  apiKey: 'YOUR_API_KEY',
...
```python
from wia_defi import WIAHydroponics & Vertical FarmingSDK

# Initialize SDK
sdk = WIAHydroponics & Vertical FarmingSDK(api_key='YOUR_API_KEY', network='mainnet')
