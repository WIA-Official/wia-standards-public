# WIA-HYDROPONICS PHASE 2 — API-INTERFACE Specification
...
`urn:wia:WIA-HYDROPONICS:status-transition`.
...
`422` with type
`urn:wia:WIA-HYDROPONICS:source-mix-required`.
...
with type
`urn:wia:WIA-HYDROPONICS:laboratory-not-accredited`.
...
`409` with type
`urn:wia:WIA-HYDROPONICS:quality-certificate-required`.
...
- `urn:wia:WIA-HYDROPONICS:hydrogen-quality-out-of-grade`
- `urn:wia:WIA-HYDROPONICS:cryogenic-temperature-excursion`
- `urn:wia:WIA-HYDROPONICS:guarantee-of-origin-mismatch`
- `urn:wia:WIA-HYDROPONICS:evidence-mismatch`
