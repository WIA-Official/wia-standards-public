# WIA-HYDROPONICS PHASE 4 — INTEGRATION Specification
...
This document defines how a WIA-HYDROPONICS programme
...
`/.well-known/wia-WIA-HYDROPONICS` that links to the API
...
date WIA-HYDROPONICS MAY migrate historical records by
