# Hydroponics — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for Hydroponics systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across management systems and technology platforms.
...
```json
{
  ...
  "title": "WIA Hydroponics Data Format",
  "type": "object",
  "required": ["standard", "version", "timestamp", "data"],
  "properties": {
    "standard": {
      "type": "string",
      "const": "WIA-HYDROPONICS"
    },
    "version": {
      "type": "string",
      "pattern": "^\\d+\\.\\d+\\.\\d+$"
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (WIA-HYDROPONICS) |
...
### 5.3 File Extensions
- `.wia-hydroponics.json` — JSON format
- `.wia-hydroponics.pb` — Protocol Buffers
