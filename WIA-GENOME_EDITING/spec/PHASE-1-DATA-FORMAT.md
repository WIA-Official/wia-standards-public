# Genome Editing — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for Genome Editing systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across management systems and technology platforms.
...
```json
{
  ...
  "title": "WIA Genome Editing Data Format",
  "type": "object",
  "required": ["standard", "version", "timestamp", "data"],
  "properties": {
    "standard": {
      "type": "string",
      "const": "WIA-GENOME_EDITING"
    },
    "version": {
      "type": "string",
      "pattern": "^\\d+\\.\\d+\\.\\d+$"
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (WIA-GENOME_EDITING) |
...
### 5.3 File Extensions
- `.wia-genome-editing.json` — JSON format
- `.wia-genome-editing.pb` — Protocol Buffers
