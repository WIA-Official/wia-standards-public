# WIA-FIN-017 PHASE 4 — Integration

**Standard:** WIA-FIN-017 AI Trading
**Phase:** 4 — Integration
**Version:** 1.0
**Status:** Stable
**Source:** consolidated from `WIA-FIN-017-spec-v1.0.md` §3 (Risk
Management), §5 (Compliance & Auditing), §9 (Implementation
Guidelines)

This document defines integration concerns: regulatory crosswalks
(MiFID II, SFTR, EMIR REFIT, US Reg-SCI), evidence packaging via
CycloneDX 1.5, and signed-attestation submission to a competent
authority. Risk-management runtime envelopes inherit from this PHASE
via the manifest in PHASE-1.
