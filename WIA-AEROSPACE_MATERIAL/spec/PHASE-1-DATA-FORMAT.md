# Aerospace Material — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for Aerospace Material systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across space communication systems and orbital platforms.
...
```json
{
  ...
  "title": "WIA Aerospace Material Data Format",
  "type": "object",
  "required": ["standard", "version", "timestamp", "data"],
  "properties": {
    "standard": {
      "type": "string",
      "const": "WIA-AEROSPACE_MATERIAL"
    },
    "version": {
      "type": "string",
      "pattern": "^\\d+\\.\\d+\\.\\d+$"
    ...
    "data": {
      "type": "object",
      "description": "Primary telemetry data payload"
    }
  }
}
```
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (WIA-AEROSPACE_MATERIAL) |
...
| data | object | Yes | Domain-specific telemetry data |
...
### 5.3 File Extensions
- `.wia-aerospace-material.json` — JSON format
- `.wia-aerospace-material.pb` — Protocol Buffers
...
```json
{
  "standard": "WIA-AEROSPACE_MATERIAL",
  "version": "1.0.0",
