# Aerospace Material — Phase 2: API Interface Specification
...
Phase 2 defines RESTful API endpoints for interacting with Aerospace Material services. This specification enables standardized programmatic access to telemetry data across space communication systems.

### 1.1 Base URL

```
Production: https://api.aerospace-material.wia.org/v1
Sandbox:    https://sandbox.aerospace-material.wia.org/v1
```
...
| Method | Endpoint | Description |
|--------|----------|-------------|
| POST | /data/ingest | Submit telemetry data |
