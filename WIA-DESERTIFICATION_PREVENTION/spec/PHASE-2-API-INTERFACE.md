# WIA-DESERTIFICATION_PREVENTION: Phase 2 - API Interface Specification
**Version:** 1.0
**Status:** Official
...
This document specifies the API interface requirements for DESERTIFICATION PREVENTION. All implementations MUST provide these endpoints to ensure interoperability.

## 2. REST API Endpoints

### 2.1 Base URL
```
https://api.wia.org/v1/wia-desertification-prevention/
```
...
```http
POST /v1/wia-desertification-prevention/records HTTP/1.1
...
### 3.1 Installation
```bash
npm install @wia/wia-desertification-prevention-sdk
```
...
### 3.3 Usage Example
```typescript
import { createClient } from '@wia/wia-desertification-prevention-sdk';
...
WIA conformance for WIA-DESERTIFICATION_PREVENTION is evaluated across three tiers:
...
- `wia-standards/standards/WIA-DESERTIFICATION_PREVENTION/api/` — TypeScript SDK skeleton
- `wia-standards/standards/WIA-DESERTIFICATION_PREVENTION/cli/` — POSIX shell client demonstrating the request/response contract
- `wia-standards/standards/WIA-DESERTIFICATION_PREVENTION/simulator/` — interactive browser-based simulator for the PHASE protocol
