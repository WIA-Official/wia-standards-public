...
echo -e "${CYAN}"
echo "╔════════════════════════════════════════════════════════════╗"
echo "║    WIA-OCEAN-010: Ocean Resource Standard Setup     ║"
echo "║              弘益人間 · Benefit All Humanity                ║"
echo "╚════════════════════════════════════════════════════════════╝"
echo -e "${NC}"

echo "Installing WIA-OCEAN-010 Ocean Resource Standard..."
...
# Make CLI executable
if [ -f "cli/ocean-resource.sh" ]; then
    chmod +x cli/ocean-resource.sh
...
if [ -d "$INSTALL_DIR" ]; then
    ln -sf "$(pwd)/cli/ocean-resource.sh" "$INSTALL_DIR/wia-ocean-010"
    echo -e "${GREEN}✓ Command 'wia-ocean-010' available${NC}"
else
...
echo ""
echo "Quick start:"
echo "  1. View status: ./cli/ocean-resource.sh status"
echo "  2. Read sensors: ./cli/ocean-resource.sh sensor read"
echo "  3. Start mission: ./cli/ocean-resource.sh mission start"
echo ""
echo "Documentation:"
...
echo "  npm install @wia/ocean-010"
echo ""
