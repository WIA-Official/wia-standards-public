# Supply Chain — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for Supply Chain systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across AI service platforms and AI processing systems.
...
```json
{
  ...
  "title": "WIA Supply Chain Data Format",
  "type": "object",
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (supply-chain) |
...
### 5.3 File Extensions
- `.wia-supply-chain.json` — JSON format
- `.wia-supply-chain.pb` — Protocol Buffers
