# Supply Chain — Phase 2: API Interface Specification
...
Phase 2 defines RESTful API endpoints for interacting with Supply Chain services. This specification enables standardized programmatic access to AI model data across AI service platforms.

### 1.1 Base URL

```
Production: https://api.supply-chain.wia.org/v1
Sandbox:    https://sandbox.supply-chain.wia.org/v1
```
