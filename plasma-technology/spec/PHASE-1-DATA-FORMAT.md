# Plasma Technology — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for Plasma Technology systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across management systems and technology platforms.
...
```json
{
  ...
  "title": "WIA Plasma Technology Data Format",
  "type": "object",
  "required": ["standard", "version", "timestamp", "data"],
  "properties": {
    "standard": {
      "type": "string",
      "const": "plasma-technology"
    },
    "version": {
      "type": "string",
      "pattern": "^\\d+\\.\\d+\\.\\d+$"
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (plasma-technology) |
...
### 5.3 File Extensions
- `.wia-plasma-technology.json` — JSON format
- `.wia-plasma-technology.pb` — Protocol Buffers
