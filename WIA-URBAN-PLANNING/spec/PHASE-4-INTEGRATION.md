# Urban Planning — Phase 4: Integration Specification
...
Phase 4 defines integration patterns and requirements for deploying Urban Planning within existing infrastructure. This specification covers system architecture, integration patterns, testing requirements, and deployment guidelines for management systems and technology platforms.
...
- Implement the `WIAWIA_URBAN_PLANNINGAdapter` interface
...
```json
{
  ...
  "channels": [
    "wia-urban-planning.data.ingested",
    "wia-urban-planning.resource.updated",
    "wia-urban-planning.alert.triggered"
  ]
}
```
...
```
WIA_STANDARD=WIA-URBAN-PLANNING
WIA_VERSION=1.0.0
WIA_LOG_LEVEL=info
