# Urban Planning — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for Urban Planning systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across management systems and technology platforms.
...
```json
{
  ...
  "title": "WIA Urban Planning Data Format",
  "type": "object",
  "required": ["standard", "version", "timestamp", "data"],
  "properties": {
    "standard": {
      "type": "string",
      "const": "WIA-URBAN-PLANNING"
    },
    "version": {
      "type": "string",
      "pattern": "^\\d+\\.\\d+\\.\\d+$"
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (WIA-URBAN-PLANNING) |
...
### 5.3 File Extensions
- `.wia-urban-planning.json` — JSON format
- `.wia-urban-planning.pb` — Protocol Buffers
