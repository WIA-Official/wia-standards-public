# Electric Vehicle — Phase 2: API Interface Specification
...
Phase 2 defines RESTful API endpoints for interacting with Electric Vehicle services. This specification enables standardized programmatic access to vehicle data across transportation networks.

### 1.1 Base URL

```
Production: https://api.electric-vehicle.wia.org/v1
Sandbox:    https://sandbox.electric-vehicle.wia.org/v1
```
