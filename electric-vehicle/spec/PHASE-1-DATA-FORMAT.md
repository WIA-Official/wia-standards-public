# Electric Vehicle — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for Electric Vehicle systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across transportation networks and vehicular systems.
...
```json
{
  ...
  "title": "WIA Electric Vehicle Data Format",
  "type": "object",
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (electric-vehicle) |
...
### 5.3 File Extensions
- `.wia-electric-vehicle.json` — JSON format
- `.wia-electric-vehicle.pb` — Protocol Buffers
