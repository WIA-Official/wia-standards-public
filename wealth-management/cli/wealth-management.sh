#!/usr/bin/env bash
# wealth-management — Wealth Management CLI helper.
#
# Sample envelope generators for the WIA-FIN-WEALTH-001 standard.
# Requires: bash 4+, jq.
set -euo pipefail

STD_ID="WIA-FIN-WEALTH-001"
...
cmd_refs() {
    cat <<REFS
Normative references for WIA-FIN-WEALTH-001 (Wealth Management):
