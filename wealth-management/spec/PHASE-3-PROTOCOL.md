# WIA-FIN-WEALTH-001 — Phase 3: PROTOCOL

> Wealth Management canonical Phase 3 specification per the WIA Standards four-Phase architecture.

> Domain: 자산 관리 — 자산 관리 · 포트폴리오 · MiFID II · 적합성 평가 · ESG 통합.

## A.1 Scope

This Phase covers the canonical protocol layer of the WIA-FIN-WEALTH-001 standard. It composes with the Phase 4 document for cross-Phase integration and inherits cross-standard behaviour from the wider WIA Standards family per the README.md scope statement.
