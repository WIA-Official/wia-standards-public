# Blockchain Security — Phase 2: API Interface Specification
...
Phase 2 defines RESTful API endpoints for interacting with Blockchain Security services. This specification enables standardized programmatic access to blockchain records across distributed ledger networks.

### 1.1 Base URL

```
Production: https://api.blockchain-security.wia.org/v1
Sandbox:    https://sandbox.blockchain-security.wia.org/v1
```
...
| Method | Endpoint | Description |
|--------|----------|-------------|
| POST | /data/ingest | Submit blockchain records |
