# Longevity Gene — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for Longevity Gene systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across management systems and technology platforms.
...
```json
{
  ...
  "title": "WIA Longevity Gene Data Format",
  "type": "object",
  "required": ["standard", "version", "timestamp", "data"],
  "properties": {
    "standard": {
      "type": "string",
      "const": "longevity-gene"
    },
    "version": {
      "type": "string",
      "pattern": "^\\d+\\.\\d+\\.\\d+$"
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (longevity-gene) |
...
### 5.3 File Extensions
- `.wia-longevity-gene.json` — JSON format
- `.wia-longevity-gene.pb` — Protocol Buffers
