# Disaster Management — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for Disaster Management systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across emergency response systems and early warning platforms.
...
```json
{
  ...
  "title": "WIA Disaster Management Data Format",
  "type": "object",
  "required": ["standard", "version", "timestamp", "data"],
  "properties": {
    "standard": {
      "type": "string",
      "const": "disaster-management"
    },
    "version": {
      "type": "string",
      "pattern": "^\\d+\\.\\d+\\.\\d+$"
    ...
    "data": {
      "type": "object",
      "description": "Primary disaster event data payload"
    }
  }
}
```
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (disaster-management) |
...
| data | object | Yes | Domain-specific disaster event data |
...
### 5.3 File Extensions
- `.wia-disaster-management.json` — JSON format
- `.wia-disaster-management.pb` — Protocol Buffers
