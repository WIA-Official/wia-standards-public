# Disaster Management — Phase 2: API Interface Specification
...
Phase 2 defines RESTful API endpoints for interacting with Disaster Management services. This specification enables standardized programmatic access to disaster event data across emergency response systems.

### 1.1 Base URL

```
Production: https://api.disaster-management.wia.org/v1
Sandbox:    https://sandbox.disaster-management.wia.org/v1
```
...
| Method | Endpoint | Description |
|--------|----------|-------------|
| POST | /data/ingest | Submit disaster event data |
