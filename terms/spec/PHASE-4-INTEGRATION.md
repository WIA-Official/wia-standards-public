# WIA-terms PHASE 4 — INTEGRATION Specification
...
This document defines how a terms programme
...
`/.well-known/wia-terms` that links to the API
...
date WIA-terms MAY migrate historical records by
