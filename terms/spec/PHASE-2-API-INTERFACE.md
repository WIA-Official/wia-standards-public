# WIA-terms PHASE 2 — API-INTERFACE Specification
...
`urn:wia:terms:status-transition`.
...
`422` with type
`urn:wia:terms:source-mix-required`.
...
with type
`urn:wia:terms:laboratory-not-accredited`.
...
`409` with type
`urn:wia:terms:quality-certificate-required`.
...
- `urn:wia:terms:hydrogen-quality-out-of-grade`
- `urn:wia:terms:cryogenic-temperature-excursion`
- `urn:wia:terms:guarantee-of-origin-mismatch`
- `urn:wia:terms:evidence-mismatch`
