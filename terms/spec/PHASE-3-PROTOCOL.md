# WIA-terms PHASE 3 — PROTOCOL Specification
...
A terms operator MAY claim conformance to
WIA-terms only after the operating jurisdiction's
...
A programme conformant with WIA-terms publishes
