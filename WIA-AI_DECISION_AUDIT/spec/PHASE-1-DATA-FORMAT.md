# AI Decision Audit — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for AI Decision Audit systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across AI service platforms and AI processing systems.
...
```json
{
  ...
  "title": "WIA AI Decision Audit Data Format",
  "type": "object",
  "required": ["standard", "version", "timestamp", "data"],
  "properties": {
    "standard": {
      "type": "string",
      "const": "WIA-AI_DECISION_AUDIT"
    },
    "version": {
      "type": "string",
      "pattern": "^\\d+\\.\\d+\\.\\d+$"
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (WIA-AI_DECISION_AUDIT) |
...
### 5.3 File Extensions
- `.wia-ai-decision-audit.json` — JSON format
- `.wia-ai-decision-audit.pb` — Protocol Buffers
...
```json
{
  "standard": "WIA-AI_DECISION_AUDIT",
  "version": "1.0.0",
