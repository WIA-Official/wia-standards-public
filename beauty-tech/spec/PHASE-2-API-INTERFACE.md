# Beauty Tech — Phase 2: API Interface Specification
...
Phase 2 defines RESTful API endpoints for interacting with Beauty Tech services. This specification enables standardized programmatic access to cosmetic analysis data across beauty tech platforms.

### 1.1 Base URL

```
Production: https://api.beauty-tech.wia.org/v1
Sandbox:    https://sandbox.beauty-tech.wia.org/v1
```
...
| Method | Endpoint | Description |
|--------|----------|-------------|
| POST | /data/ingest | Submit cosmetic analysis data |
