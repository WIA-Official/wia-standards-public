# Beauty Tech — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for Beauty Tech systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across beauty tech platforms and personalization systems.
...
```json
{
  ...
  "title": "WIA Beauty Tech Data Format",
  "type": "object",
  ...
  "properties": {
    ...
    "data": {
      "type": "object",
      "description": "Primary cosmetic analysis data payload"
    }
  }
}
```
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (beauty-tech) |
...
| data | object | Yes | Domain-specific cosmetic analysis data |
...
### 5.3 File Extensions
- `.wia-beauty-tech.json` — JSON format
- `.wia-beauty-tech.pb` — Protocol Buffers
