# Wormhole Navigation — Phase 2: API Interface Specification
...
Phase 2 defines RESTful API endpoints for interacting with Wormhole Navigation services. This specification enables standardized programmatic access to navigation telemetry across positioning systems.

### 1.1 Base URL

```
Production: https://api.wormhole-navigation.wia.org/v1
Sandbox:    https://sandbox.wormhole-navigation.wia.org/v1
```
...
| Method | Endpoint | Description |
|--------|----------|-------------|
| POST | /data/ingest | Submit navigation telemetry |
