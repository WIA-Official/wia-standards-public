# Wormhole Navigation — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for Wormhole Navigation systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across positioning systems and wayfinding platforms.
...
```json
{
  ...
  "title": "WIA Wormhole Navigation Data Format",
  "type": "object",
  "required": ["standard", "version", "timestamp", "data"],
  "properties": {
    "standard": {
      "type": "string",
      "const": "wormhole-navigation"
    },
    "version": {
      "type": "string",
      "pattern": "^\\d+\\.\\d+\\.\\d+$"
    ...
    "data": {
      "type": "object",
      "description": "Primary navigation telemetry payload"
    }
  }
}
```
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (wormhole-navigation) |
...
| data | object | Yes | Domain-specific navigation telemetry |
...
### 5.3 File Extensions
- `.wia-wormhole-navigation.json` — JSON format
- `.wia-wormhole-navigation.pb` — Protocol Buffers
