# WIA-ART-006: Phase 4 - Integration Specification
**Version:** 1.0
**Status:** Official
...
Integration guidelines for WIA-ART-006 Art Authentication Standard.

## 2. Platform Integration

### 2.1 Web Applications
```html
<script src="https://cdn.wia.org/art-006/v1/wia-art-006.js"></script>
<script>
  const sdk = new WIAART006({
    apiKey: 'your-api-key'
  });
</script>
```
...
let sdk = WIAART006(apiKey: "your-api-key")
```

### 2.3 Server-Side Integration
```python
from wia_art_006 import SDK
