# WIA-LANG-001 PHASE 2 — API-INTERFACE Specification
...
`urn:wia:WIA-LANG-001:status-transition`.
...
`422` with type
`urn:wia:WIA-LANG-001:source-mix-required`.
...
with type
`urn:wia:WIA-LANG-001:laboratory-not-accredited`.
...
`409` with type
`urn:wia:WIA-LANG-001:quality-certificate-required`.
...
- `urn:wia:WIA-LANG-001:hydrogen-quality-out-of-grade`
- `urn:wia:WIA-LANG-001:cryogenic-temperature-excursion`
- `urn:wia:WIA-LANG-001:guarantee-of-origin-mismatch`
