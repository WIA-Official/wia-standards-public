# Lang 001 — Phase 2: API Interface Specification
...
Phase 2 defines RESTful API endpoints for interacting with Lang 001 services. This specification enables standardized programmatic access to linguistic data across NLP processing systems.

### 1.1 Base URL

```
Production: https://api.lang-001.wia.org/v1
Sandbox:    https://sandbox.lang-001.wia.org/v1
```
...
| Method | Endpoint | Description |
|--------|----------|-------------|
| POST | /data/ingest | Submit linguistic data |
