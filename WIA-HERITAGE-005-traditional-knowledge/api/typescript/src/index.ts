...
/**
 * WIA-HERITAGE-005 SDK Client
 */
export class WIAHeritage005 {
  private config: WIAHeritage005Config;
  private endpoint: string;

  constructor(config: WIAHeritage005Config) {
    this.config = {
