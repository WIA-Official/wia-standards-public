# Maritime Safety — Phase 2: API Interface Specification
...
Phase 2 defines RESTful API endpoints for interacting with Maritime Safety services. This specification enables standardized programmatic access to operational data across management systems.

### 1.1 Base URL

```
Production: https://api.maritime-safety.wia.org/v1
Sandbox:    https://sandbox.maritime-safety.wia.org/v1
```
