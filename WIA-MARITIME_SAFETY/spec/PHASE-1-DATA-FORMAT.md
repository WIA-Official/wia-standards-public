# Maritime Safety — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for Maritime Safety systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across management systems and technology platforms.
...
```json
{
  ...
  "title": "WIA Maritime Safety Data Format",
  "type": "object",
  "required": ["standard", "version", "timestamp", "data"],
  "properties": {
    "standard": {
      "type": "string",
      "const": "WIA-MARITIME_SAFETY"
    },
    "version": {
      "type": "string",
      "pattern": "^\\d+\\.\\d+\\.\\d+$"
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (WIA-MARITIME_SAFETY) |
...
### 5.3 File Extensions
- `.wia-maritime-safety.json` — JSON format
- `.wia-maritime-safety.pb` — Protocol Buffers
