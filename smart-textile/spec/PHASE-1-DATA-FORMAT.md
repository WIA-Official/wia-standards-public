# Smart Textile — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for Smart Textile systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across smart infrastructure and IoT-enabled systems.
...
```json
{
  ...
  "title": "WIA Smart Textile Data Format",
  "type": "object",
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (smart-textile) |
...
### 5.3 File Extensions
- `.wia-smart-textile.json` — JSON format
- `.wia-smart-textile.pb` — Protocol Buffers
