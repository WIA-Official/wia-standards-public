# WIA-QM-001 — Phase 4: INTEGRATION

> Quantum Material canonical Phase 4 specification per the WIA Standards four-Phase architecture.

> Domain: 양자 물질 — 양자 물질 · 위상 절연체 · 초전도체 · 고체 NMR · STM.

## A.1 Scope

This Phase covers the canonical integration layer of the WIA-QM-001 standard. It composes with the Phase 1 document for cross-Phase integration and inherits cross-standard behaviour from the wider WIA Standards family per the README.md scope statement.
