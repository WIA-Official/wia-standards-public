#!/usr/bin/env bash
# quantum-material — Quantum Material CLI helper.
#
# Sample envelope generators for the WIA-QM-001 standard.
# Requires: bash 4+, jq.
set -euo pipefail

STD_ID="WIA-QM-001"
SLUG="quantum-material"
...
cmd_refs() {
    cat <<REFS
Normative references for WIA-QM-001 (Quantum Material):
