# WIA-AIR-SHIELD PHASE 4 — Integration

**Standard:** WIA-AIR-SHIELD
**Phase:** 4 — Integration
**Version:** 1.0
**Status:** Stable
**Source:** consolidated from `WIA-AIR-SHIELD-v1.0.md` §7 (사용 시나리오),
§8 (구현 가이드), §9 (인증 레벨)

This document defines integration concerns: deployment topologies
(single-tenant edge, federated, air-gapped batch), evidence packaging
via CycloneDX 1.5, and signed-attestation submission to a competent
authority. The mapping from this PHASE's object types to the
certification levels in §9 of the source spec is defined in Annex G's
evidence-package convention.
