...
WIA standard `haptic` — see <https://wiastandards.com> for the full standards catalogue.
...
WIA conformance for **haptic** is evaluated across three tiers, mirrored in every PHASE document under `spec/`:
