# Satellite Internet — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for Satellite Internet systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across management systems and technology platforms.
...
```json
{
  ...
  "title": "WIA Satellite Internet Data Format",
  "type": "object",
  "required": ["standard", "version", "timestamp", "data"],
  "properties": {
    "standard": {
      "type": "string",
      "const": "satellite-internet"
    },
    "version": {
      "type": "string",
      "pattern": "^\\d+\\.\\d+\\.\\d+$"
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (satellite-internet) |
...
### 5.3 File Extensions
- `.wia-satellite-internet.json` — JSON format
- `.wia-satellite-internet.pb` — Protocol Buffers
