# WIA-HERITAGE-007 PHASE 2 — API-INTERFACE Specification
...
`urn:wia:WIA-HERITAGE-007:status-transition`.
...
`422` with type
`urn:wia:WIA-HERITAGE-007:source-mix-required`.
...
with type
`urn:wia:WIA-HERITAGE-007:laboratory-not-accredited`.
...
`409` with type
`urn:wia:WIA-HERITAGE-007:quality-certificate-required`.
...
- `urn:wia:WIA-HERITAGE-007:hydrogen-quality-out-of-grade`
- `urn:wia:WIA-HERITAGE-007:cryogenic-temperature-excursion`
- `urn:wia:WIA-HERITAGE-007:guarantee-of-origin-mismatch`
- `urn:wia:WIA-HERITAGE-007:evidence-mismatch`
