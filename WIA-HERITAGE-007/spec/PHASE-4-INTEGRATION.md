...
This document defines how a WIA-HERITAGE-007 programme
...
`/.well-known/wia-WIA-HERITAGE-007` that links to the API
...
date WIA-HERITAGE-007 MAY migrate historical records by
