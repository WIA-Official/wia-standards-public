...
WIA standard `i18n` — see <https://wiastandards.com> for the full standards catalogue.
...
WIA conformance for **i18n** is evaluated across three tiers, mirrored in every PHASE document under `spec/`:
