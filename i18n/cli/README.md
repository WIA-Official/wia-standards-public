...
Minimal POSIX shell client that demonstrates the WIA `i18n` standard's
...
```sh
export WIA_API_BASE="https://i18n.example.com/api/v1"
export WIA_API_TOKEN="<your-bearer-token>"
./i18n.sh list
./i18n.sh get <id>
./i18n.sh create payload.json
./i18n.sh validate payload.json
./i18n.sh export <id>
```
