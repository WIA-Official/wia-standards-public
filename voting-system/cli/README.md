...
Minimal POSIX shell client that demonstrates the WIA `voting-system` standard's
...
```sh
export WIA_API_BASE="https://voting-system.example.com/api/v1"
export WIA_API_TOKEN="<your-bearer-token>"
./voting-system.sh list
./voting-system.sh get <id>
./voting-system.sh create payload.json
./voting-system.sh validate payload.json
./voting-system.sh export <id>
```
