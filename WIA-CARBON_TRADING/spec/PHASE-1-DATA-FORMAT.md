# Carbon Trading — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for Carbon Trading systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across carbon tracking systems and environmental monitoring.
...
```json
{
  ...
  "title": "WIA Carbon Trading Data Format",
  "type": "object",
  "required": ["standard", "version", "timestamp", "data"],
  "properties": {
    "standard": {
      "type": "string",
      "const": "WIA-CARBON_TRADING"
    },
    "version": {
      "type": "string",
      "pattern": "^\\d+\\.\\d+\\.\\d+$"
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (WIA-CARBON_TRADING) |
...
### 5.3 File Extensions
- `.wia-carbon-trading.json` — JSON format
- `.wia-carbon-trading.pb` — Protocol Buffers
