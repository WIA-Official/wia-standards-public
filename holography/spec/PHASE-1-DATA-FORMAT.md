# Holography — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for Holography systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across management systems and technology platforms.
...
```json
{
  ...
  "title": "WIA Holography Data Format",
  "type": "object",
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (holography) |
...
### 5.3 File Extensions
- `.wia-holography.json` — JSON format
- `.wia-holography.pb` — Protocol Buffers
