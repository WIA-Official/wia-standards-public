# WIA-HAPTIC Specification - PHASE 2
...
The WIA-HAPTIC standard supports multiple API paradigms:
...
```typescript
import { WIAHaptic TechnologySDK } from '@wia/defi-sdk';

// Initialize SDK
const sdk = new WIAHaptic TechnologySDK({
  apiKey: 'YOUR_API_KEY',
...
```python
from wia_defi import WIAHaptic TechnologySDK

# Initialize SDK
sdk = WIAHaptic TechnologySDK(api_key='YOUR_API_KEY', network='mainnet')
