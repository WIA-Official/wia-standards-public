# WIA-HAPTIC PHASE 4 — INTEGRATION Specification
...
This document defines how a WIA-HAPTIC programme
...
`/.well-known/wia-WIA-HAPTIC` that links to the API
...
date WIA-HAPTIC MAY migrate historical records by
