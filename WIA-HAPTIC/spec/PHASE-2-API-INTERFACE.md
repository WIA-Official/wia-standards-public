# WIA-HAPTIC PHASE 2 — API-INTERFACE Specification
...
`urn:wia:WIA-HAPTIC:status-transition`.
...
`422` with type
`urn:wia:WIA-HAPTIC:source-mix-required`.
...
with type
`urn:wia:WIA-HAPTIC:laboratory-not-accredited`.
...
`409` with type
`urn:wia:WIA-HAPTIC:quality-certificate-required`.
...
- `urn:wia:WIA-HAPTIC:hydrogen-quality-out-of-grade`
- `urn:wia:WIA-HAPTIC:cryogenic-temperature-excursion`
- `urn:wia:WIA-HAPTIC:guarantee-of-origin-mismatch`
- `urn:wia:WIA-HAPTIC:evidence-mismatch`
