/**
 * WIA-HAPTIC TypeScript SDK
 * Version: 1.0.0
 * Philosophy: 弘益人間 (Benefit All Humanity)
 *
 * Comprehensive HAPTIC SDK supporting:
...
export class WIAHAPTICSDK {
  ...
  constructor(config: SDKConfig) {
    this.config = {
      ...
      baseURL: config.baseURL || 'https://api.wia-haptic.org/v1',
  ...
  /**
   * Get all supported HAPTIC protocols
 ...
 * Create SDK instance
 */
export function createWIAHAPTICSDK(config: SDKConfig): WIAHAPTICSDK {
  return new WIAHAPTICSDK(config);
}

/**
 * Default export
 */
export default WIAHAPTICSDK;
