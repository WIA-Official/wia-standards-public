...
- **Type-Safe**: Full TypeScript support with comprehensive type hapticnitions
...
```bash
npm install @wia/haptic-sdk
# or
yarn add @wia/haptic-sdk
# or
pnpm add @wia/haptic-sdk
```

## Quick Start

```typescript
import { WIADeFiSDK } from '@wia/haptic-sdk';
...
Get your API key at: https://api.wia-haptic.org/register
...
- Documentation: https://docs.wia.org/haptic-sdk
