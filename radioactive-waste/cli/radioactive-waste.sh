#!/usr/bin/env bash
# radioactive-waste — Radioactive Waste Management CLI helper.
#
# Sample envelope generators for the WIA-ENE-026 standard.
# Requires: bash 4+, jq.
set -euo pipefail
...
cmd_refs() {
    cat <<REFS
Normative references for WIA-ENE-026 (Radioactive Waste Management):
