# WIA-FOOD_SAFETY: Phase 2 - API Interface Specification
**Version:** 1.0
**Status:** Official
...
This document specifies the API interface requirements for FOOD SAFETY. All implementations MUST provide these endpoints to ensure interoperability.

## 2. REST API Endpoints

### 2.1 Base URL
```
https://api.wia.org/v1/wia-food-safety/
```
...
```http
POST /v1/wia-food-safety/records HTTP/1.1
...
### 3.1 Installation
```bash
npm install @wia/wia-food-safety-sdk
```
...
### 3.3 Usage Example
```typescript
import { createClient } from '@wia/wia-food-safety-sdk';
...
WIA conformance for WIA-FOOD_SAFETY is evaluated across three tiers:
...
- `wia-standards/standards/WIA-FOOD_SAFETY/api/` — TypeScript SDK skeleton
- `wia-standards/standards/WIA-FOOD_SAFETY/cli/` — POSIX shell client demonstrating the request/response contract
- `wia-standards/standards/WIA-FOOD_SAFETY/simulator/` — interactive browser-based simulator for the PHASE protocol
