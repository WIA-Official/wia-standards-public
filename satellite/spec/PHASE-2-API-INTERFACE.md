# PHASE 2 — API INTERFACE · satellite
**Version:** 1.0
**Status:** Active
...
This Phase defines the API INTERFACE layer of the *satellite* WIA standard.
...
in lockstep across Phases 1–4 of satellite so that conformance claims at any
