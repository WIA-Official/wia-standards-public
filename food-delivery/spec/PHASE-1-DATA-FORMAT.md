# Food Delivery — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for Food Delivery systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across food supply chain systems and food processing equipment.
...
```json
{
  ...
  "title": "WIA Food Delivery Data Format",
  "type": "object",
  ...
  "properties": {
    ...
    "data": {
      "type": "object",
      "description": "Primary food safety data payload"
    }
  }
}
```
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (food-delivery) |
...
| data | object | Yes | Domain-specific food safety data |
...
### 5.3 File Extensions
- `.wia-food-delivery.json` — JSON format
- `.wia-food-delivery.pb` — Protocol Buffers
