# Food Delivery — Phase 2: API Interface Specification
...
Phase 2 defines RESTful API endpoints for interacting with Food Delivery services. This specification enables standardized programmatic access to food safety data across food supply chain systems.

### 1.1 Base URL

```
Production: https://api.food-delivery.wia.org/v1
Sandbox:    https://sandbox.food-delivery.wia.org/v1
```
...
| Method | Endpoint | Description |
|--------|----------|-------------|
| POST | /data/ingest | Submit food safety data |
