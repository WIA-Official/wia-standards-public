# Vehicle Infotainment — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for Vehicle Infotainment systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across transportation networks and vehicular systems.
...
```json
{
  ...
  "title": "WIA Vehicle Infotainment Data Format",
  "type": "object",
  "required": ["standard", "version", "timestamp", "data"],
  "properties": {
    "standard": {
      "type": "string",
      "const": "vehicle-infotainment"
    },
    "version": {
      "type": "string",
      "pattern": "^\\d+\\.\\d+\\.\\d+$"
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (vehicle-infotainment) |
...
### 5.3 File Extensions
- `.wia-vehicle-infotainment.json` — JSON format
- `.wia-vehicle-infotainment.pb` — Protocol Buffers
