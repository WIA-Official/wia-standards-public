...
- **Type-Safe**: Full TypeScript support with comprehensive type exoskeletonnitions
...
```bash
npm install @wia/exoskeleton-sdk
# or
yarn add @wia/exoskeleton-sdk
# or
pnpm add @wia/exoskeleton-sdk
```

## Quick Start

```typescript
import { WIADeFiSDK } from '@wia/exoskeleton-sdk';
...
Get your API key at: https://api.wia-exoskeleton.org/register
...
- Documentation: https://docs.wia.org/exoskeleton-sdk
