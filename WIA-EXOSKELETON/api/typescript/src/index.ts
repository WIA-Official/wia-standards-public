/**
 * WIA-EXOSKELETON TypeScript SDK
 * Version: 1.0.0
 * Philosophy: 弘益人間 (Benefit All Humanity)
 *
 * Comprehensive EXOSKELETON SDK supporting:
...
/**
 * Main WIA-EXOSKELETON SDK Class
 *
 * @example
 * ```typescript
 ...
 * ```
 */
export class WIAEXOSKELETONSDK {
  ...
  constructor(config: SDKConfig) {
    this.config = {
      ...
      baseURL: config.baseURL || 'https://api.wia-exoskeleton.org/v1',
  ...
  /**
   * Get all supported EXOSKELETON protocols
 ...
 * Create SDK instance
 */
export function createWIAEXOSKELETONSDK(config: SDKConfig): WIAEXOSKELETONSDK {
  return new WIAEXOSKELETONSDK(config);
}

/**
 * Default export
 */
export default WIAEXOSKELETONSDK;
