# WIA-EXOSKELETON PHASE 2 — API-INTERFACE Specification
...
`urn:wia:WIA-EXOSKELETON:status-transition`.
...
`422` with type
`urn:wia:WIA-EXOSKELETON:source-mix-required`.
...
with type
`urn:wia:WIA-EXOSKELETON:laboratory-not-accredited`.
...
`409` with type
`urn:wia:WIA-EXOSKELETON:quality-certificate-required`.
...
- `urn:wia:WIA-EXOSKELETON:hydrogen-quality-out-of-grade`
- `urn:wia:WIA-EXOSKELETON:cryogenic-temperature-excursion`
- `urn:wia:WIA-EXOSKELETON:guarantee-of-origin-mismatch`
- `urn:wia:WIA-EXOSKELETON:evidence-mismatch`
