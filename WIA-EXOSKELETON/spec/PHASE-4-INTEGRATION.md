# WIA-EXOSKELETON PHASE 4 — INTEGRATION Specification
...
This document defines how a WIA-EXOSKELETON programme
...
`/.well-known/wia-WIA-EXOSKELETON` that links to the API
...
date WIA-EXOSKELETON MAY migrate historical records by
