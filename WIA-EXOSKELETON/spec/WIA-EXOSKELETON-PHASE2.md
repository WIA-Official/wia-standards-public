# WIA-EXOSKELETON Specification - PHASE 2
...
The WIA-EXOSKELETON standard supports multiple API paradigms:
...
```typescript
import { WIAExoskeleton TechnologySDK } from '@wia/defi-sdk';

// Initialize SDK
const sdk = new WIAExoskeleton TechnologySDK({
  apiKey: 'YOUR_API_KEY',
...
```python
from wia_defi import WIAExoskeleton TechnologySDK

# Initialize SDK
sdk = WIAExoskeleton TechnologySDK(api_key='YOUR_API_KEY', network='mainnet')
