...
Minimal POSIX shell client that demonstrates the WIA `space-resource` standard's
...
```sh
export WIA_API_BASE="https://space-resource.example.com/api/v1"
export WIA_API_TOKEN="<your-bearer-token>"
./space-resource.sh list
./space-resource.sh get <id>
./space-resource.sh create payload.json
./space-resource.sh validate payload.json
./space-resource.sh export <id>
```
