# PHASE 2 — API INTERFACE · space-resource
**Version:** 1.0
**Status:** Active
...
This Phase defines the API INTERFACE layer of the *space-resource* WIA standard.
...
in lockstep across Phases 1–4 of space-resource so that conformance claims at any
