# AIR Cargo — Phase 4: Integration Specification
...
Phase 4 defines integration patterns and requirements for deploying AIR Cargo within existing infrastructure. This specification covers system architecture, integration patterns, testing requirements, and deployment guidelines for AI service platforms and AI processing systems.
...
- Implement the `WIAair_cargoAdapter` interface
...
```json
{
  ...
  "channels": [
    "air-cargo.data.ingested",
    "air-cargo.resource.updated",
    "air-cargo.alert.triggered"
  ]
}
```
