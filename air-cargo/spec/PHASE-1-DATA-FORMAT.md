# AIR Cargo — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for AIR Cargo systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across AI service platforms and AI processing systems.
...
```json
{
  ...
  "title": "WIA AIR Cargo Data Format",
  "type": "object",
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (air-cargo) |
...
### 5.3 File Extensions
- `.wia-air-cargo.json` — JSON format
- `.wia-air-cargo.pb` — Protocol Buffers
