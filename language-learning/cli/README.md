...
Minimal POSIX shell client that demonstrates the WIA `language-learning` standard's
...
```sh
export WIA_API_BASE="https://language-learning.example.com/api/v1"
export WIA_API_TOKEN="<your-bearer-token>"
./language-learning.sh list
./language-learning.sh get <id>
./language-learning.sh create payload.json
./language-learning.sh validate payload.json
./language-learning.sh export <id>
```
