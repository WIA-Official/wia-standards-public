# WIA-AUTO-025: PHASE 1 - Data Format Specification
...
This document defines PHASE 1 of the WIA-AUTO-025 Mobility-as-a-Service (MaaS) standard, focusing on data schemas, JSON structures, validation rules. This specification ensures interoperability across different MaaS platforms and service providers while maintaining flexibility for innovation.

### Purpose

The primary purpose of this phase is to establish standardized approaches for data schemas, JSON structures, validation rules within MaaS ecosystems. By adhering to this specification, implementers can build systems that seamlessly integrate with the broader mobility services landscape.

### Scope

This phase covers:
- Technical requirements for data schemas, JSON structures, validation rules
...
Organizations implementing this specification can pursue WIA-AUTO-025 PHASE 1 certification through:
...
- WIA-AUTO-025 PHASE 1 certification badge
...
|---------|------|---------|
| 1.0 | 2025-12-27 | Initial release of PHASE 1 specification |
