# EDU — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for EDU systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across educational platforms and classroom systems.
...
```json
{
  ...
  "properties": {
    ...
    "data": {
      "type": "object",
      "description": "Primary learning data payload"
    }
  }
}
```
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (WIA-EDU) |
...
| data | object | Yes | Domain-specific learning data |
...
### 5.3 File Extensions
- `.wia-edu.json` — JSON format
- `.wia-edu.pb` — Protocol Buffers
