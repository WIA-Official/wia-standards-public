# WIA-EDU PHASE 4 — INTEGRATION Specification
...
This document defines how a WIA-EDU programme
...
`/.well-known/wia-WIA-EDU` that links to the API
...
date WIA-EDU MAY migrate historical records by
