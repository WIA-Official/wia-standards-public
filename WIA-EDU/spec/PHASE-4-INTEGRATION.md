# EDU — Phase 4: Integration Specification
...
Phase 4 defines integration patterns and requirements for deploying EDU within existing infrastructure. This specification covers system architecture, integration patterns, testing requirements, and deployment guidelines for educational platforms and classroom systems.
...
For connecting legacy educational platforms:
- Implement the `WIAWIA_EDUAdapter` interface
...
```json
{
  ...
  "channels": [
    "wia-edu.data.ingested",
    "wia-edu.resource.updated",
    "wia-edu.alert.triggered"
  ]
}
```
