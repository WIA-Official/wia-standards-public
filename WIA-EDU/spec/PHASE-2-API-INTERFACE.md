# EDU — Phase 2: API Interface Specification
...
Phase 2 defines RESTful API endpoints for interacting with EDU services. This specification enables standardized programmatic access to learning data across educational platforms.

### 1.1 Base URL

```
Production: https://api.edu.wia.org/v1
Sandbox:    https://sandbox.edu.wia.org/v1
```
...
| Method | Endpoint | Description |
|--------|----------|-------------|
| POST | /data/ingest | Submit learning data |
