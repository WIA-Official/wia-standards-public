# WIA-EDU PHASE 2 — API-INTERFACE Specification
...
`urn:wia:WIA-EDU:status-transition`.
...
`422` with type
`urn:wia:WIA-EDU:source-mix-required`.
...
with type
`urn:wia:WIA-EDU:laboratory-not-accredited`.
...
`409` with type
`urn:wia:WIA-EDU:quality-certificate-required`.
...
- `urn:wia:WIA-EDU:hydrogen-quality-out-of-grade`
- `urn:wia:WIA-EDU:cryogenic-temperature-excursion`
- `urn:wia:WIA-EDU:guarantee-of-origin-mismatch`
- `urn:wia:WIA-EDU:evidence-mismatch`
