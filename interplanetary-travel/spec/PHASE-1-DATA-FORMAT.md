# Interplanetary Travel — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for Interplanetary Travel systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across management systems and technology platforms.
...
```json
{
  ...
  "title": "WIA Interplanetary Travel Data Format",
  "type": "object",
  "required": ["standard", "version", "timestamp", "data"],
  "properties": {
    "standard": {
      "type": "string",
      "const": "interplanetary-travel"
    },
    "version": {
      "type": "string",
      "pattern": "^\\d+\\.\\d+\\.\\d+$"
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (interplanetary-travel) |
...
### 5.3 File Extensions
- `.wia-interplanetary-trave.json` — JSON format
- `.wia-interplanetary-trave.pb` — Protocol Buffers
