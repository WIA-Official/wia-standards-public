# Zcics — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for Zcics systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across management systems and technology platforms.
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (zcics) |
...
### 5.3 File Extensions
- `.wia-zcics.json` — JSON format
- `.wia-zcics.pb` — Protocol Buffers
