/**
 * WIA-DEFI TypeScript SDK
 * Version: 1.0.0
 * Philosophy: 弘益人間 (Benefit All Humanity)
 *
 * Comprehensive DeFi SDK supporting:
...
export class WIADeFiSDK {
  ...
  constructor(config: SDKConfig) {
    this.config = {
      ...
      baseURL: config.baseURL || 'https://api.wia-defi.org/v1',
 ...
 * Create SDK instance
 */
export function createWIADeFiSDK(config: SDKConfig): WIADeFiSDK {
  return new WIADeFiSDK(config);
}

/**
 * Default export
 */
export default WIADeFiSDK;
