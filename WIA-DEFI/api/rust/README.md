...
Official Rust SDK for the WIA-DEFI Standard.
...
```rust
use wia_defi_sdk::CreateDefiRequest;

let request = CreateDefiRequest {
...
- Documentation: https://docs.wiastandards.com/WIA-DEFI
