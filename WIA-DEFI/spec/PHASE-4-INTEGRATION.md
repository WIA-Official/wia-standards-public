# WIA-DEFI PHASE 4 — INTEGRATION Specification
...
This document defines how a WIA-DEFI programme
...
`/.well-known/wia-WIA-DEFI` that links to the API
...
date WIA-DEFI MAY migrate historical records by
