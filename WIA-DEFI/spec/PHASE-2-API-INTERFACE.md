# WIA-DEFI PHASE 2 — API-INTERFACE Specification
...
`urn:wia:WIA-DEFI:status-transition`.
...
`422` with type
`urn:wia:WIA-DEFI:source-mix-required`.
...
with type
`urn:wia:WIA-DEFI:laboratory-not-accredited`.
...
`409` with type
`urn:wia:WIA-DEFI:quality-certificate-required`.
...
- `urn:wia:WIA-DEFI:hydrogen-quality-out-of-grade`
- `urn:wia:WIA-DEFI:cryogenic-temperature-excursion`
- `urn:wia:WIA-DEFI:guarantee-of-origin-mismatch`
- `urn:wia:WIA-DEFI:evidence-mismatch`
