# Machine Vision — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for Machine Vision systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across management systems and technology platforms.
...
```json
{
  ...
  "title": "WIA Machine Vision Data Format",
  "type": "object",
  "required": ["standard", "version", "timestamp", "data"],
  "properties": {
    "standard": {
      "type": "string",
      "const": "WIA-MACHINE_VISION"
    },
    "version": {
      "type": "string",
      "pattern": "^\\d+\\.\\d+\\.\\d+$"
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (WIA-MACHINE_VISION) |
...
### 5.3 File Extensions
- `.wia-machine-vision.json` — JSON format
- `.wia-machine-vision.pb` — Protocol Buffers
