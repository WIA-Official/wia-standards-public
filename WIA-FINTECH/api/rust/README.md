# WIA-FINTECH Rust SDK

> **弘益人間 (Benefit All Humanity)**

Official Rust SDK for the WIA-FINTECH Standard.
...
```rust
use wia_fintech_sdk::CreateFintechRequest;

let request = CreateFintechRequest {
...
```rust
use wia_fintech_sdk::ListParams;
...
- Documentation: https://docs.wiastandards.com/WIA-FINTECH
