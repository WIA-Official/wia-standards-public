/**
 * WIA-FINTECH TypeScript SDK
 * Version: 1.0.0
 * Philosophy: 弘益人間 (Benefit All Humanity)
 *
 * Comprehensive FINTECH SDK supporting:
...
export class WIAFINTECHSDK {
  ...
  constructor(config: SDKConfig) {
    this.config = {
      ...
      baseURL: config.baseURL || 'https://api.wia-fintech.org/v1',
  ...
  /**
   * Get all supported FINTECH protocols
 ...
 * Create SDK instance
 */
export function createWIAFINTECHSDK(config: SDKConfig): WIAFINTECHSDK {
  return new WIAFINTECHSDK(config);
}

/**
 * Default export
 */
export default WIAFINTECHSDK;
