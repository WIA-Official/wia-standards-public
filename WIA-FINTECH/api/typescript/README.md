...
- **Type-Safe**: Full TypeScript support with comprehensive type fintechnitions
...
```bash
npm install @wia/fintech-sdk
# or
yarn add @wia/fintech-sdk
# or
pnpm add @wia/fintech-sdk
```

## Quick Start

```typescript
import { WIADeFiSDK } from '@wia/fintech-sdk';
...
Get your API key at: https://api.wia-fintech.org/register
...
- Documentation: https://docs.wia.org/fintech-sdk
