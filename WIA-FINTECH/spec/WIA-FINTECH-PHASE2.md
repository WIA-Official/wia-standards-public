# WIA-FINTECH Specification - PHASE 2
...
The WIA-FINTECH standard supports multiple API paradigms:
...
```typescript
import { WIAFinancial TechnologySDK } from '@wia/defi-sdk';

// Initialize SDK
const sdk = new WIAFinancial TechnologySDK({
  apiKey: 'YOUR_API_KEY',
...
```python
from wia_defi import WIAFinancial TechnologySDK

# Initialize SDK
sdk = WIAFinancial TechnologySDK(api_key='YOUR_API_KEY', network='mainnet')
