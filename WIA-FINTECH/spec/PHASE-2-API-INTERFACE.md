# WIA-FINTECH PHASE 2 — API-INTERFACE Specification
...
`urn:wia:WIA-FINTECH:status-transition`.
...
`422` with type
`urn:wia:WIA-FINTECH:source-mix-required`.
...
with type
`urn:wia:WIA-FINTECH:laboratory-not-accredited`.
...
`409` with type
`urn:wia:WIA-FINTECH:quality-certificate-required`.
...
- `urn:wia:WIA-FINTECH:hydrogen-quality-out-of-grade`
- `urn:wia:WIA-FINTECH:cryogenic-temperature-excursion`
- `urn:wia:WIA-FINTECH:guarantee-of-origin-mismatch`
- `urn:wia:WIA-FINTECH:evidence-mismatch`
