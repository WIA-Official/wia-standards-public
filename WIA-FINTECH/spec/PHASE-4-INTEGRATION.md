# WIA-FINTECH PHASE 4 — INTEGRATION Specification
...
This document defines how a WIA-FINTECH programme
...
`/.well-known/wia-WIA-FINTECH` that links to the API
...
date WIA-FINTECH MAY migrate historical records by
