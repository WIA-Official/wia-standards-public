# WIA-LANG-005 PHASE 4 — INTEGRATION Specification
...
This document defines how a WIA-LANG-005 programme
...
`/.well-known/wia-WIA-LANG-005` that links to the API
...
date WIA-LANG-005 MAY migrate historical records by
