# LIDAR Sensor — Phase 2: API Interface Specification
...
Phase 2 defines RESTful API endpoints for interacting with LIDAR Sensor services. This specification enables standardized programmatic access to sensor readings across sensor networks.

### 1.1 Base URL

```
Production: https://api.lidar-sensor.wia.org/v1
Sandbox:    https://sandbox.lidar-sensor.wia.org/v1
```
