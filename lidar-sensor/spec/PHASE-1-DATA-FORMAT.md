# LIDAR Sensor — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for LIDAR Sensor systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across sensor networks and measurement systems.
...
```json
{
  ...
  "title": "WIA LIDAR Sensor Data Format",
  "type": "object",
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (lidar-sensor) |
...
### 5.3 File Extensions
- `.wia-lidar-sensor.json` — JSON format
- `.wia-lidar-sensor.pb` — Protocol Buffers
