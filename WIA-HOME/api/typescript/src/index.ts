/**
 * WIA-HOME TypeScript SDK
 * Version: 1.0.0
 * Philosophy: 弘益人間 (Benefit All Humanity)
 *
 * Comprehensive HOME SDK supporting:
...
export class WIAHOMESDK {
  ...
  constructor(config: SDKConfig) {
    this.config = {
      ...
      baseURL: config.baseURL || 'https://api.wia-home.org/v1',
  ...
  /**
   * Get all supported HOME protocols
 ...
 * Create SDK instance
 */
export function createWIAHOMESDK(config: SDKConfig): WIAHOMESDK {
  return new WIAHOMESDK(config);
}

/**
 * Default export
 */
export default WIAHOMESDK;
