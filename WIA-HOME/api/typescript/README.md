...
- **Type-Safe**: Full TypeScript support with comprehensive type homenitions
...
```bash
npm install @wia/home-sdk
# or
yarn add @wia/home-sdk
# or
pnpm add @wia/home-sdk
```

## Quick Start

```typescript
import { WIADeFiSDK } from '@wia/home-sdk';
...
Get your API key at: https://api.wia-home.org/register
...
- Documentation: https://docs.wia.org/home-sdk
