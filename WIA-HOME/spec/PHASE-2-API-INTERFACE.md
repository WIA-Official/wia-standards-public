...
`urn:wia:WIA-HOME:status-transition`.
...
`422` with type
`urn:wia:WIA-HOME:source-mix-required`.
...
with type
`urn:wia:WIA-HOME:laboratory-not-accredited`.
...
`409` with type
`urn:wia:WIA-HOME:quality-certificate-required`.
...
- `urn:wia:WIA-HOME:hydrogen-quality-out-of-grade`
- `urn:wia:WIA-HOME:cryogenic-temperature-excursion`
- `urn:wia:WIA-HOME:guarantee-of-origin-mismatch`
- `urn:wia:WIA-HOME:evidence-mismatch`
