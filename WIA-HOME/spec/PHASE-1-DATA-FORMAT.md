# Home — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for Home systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across management systems and technology platforms.
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (WIA-HOME) |
...
### 5.3 File Extensions
- `.wia-home.json` — JSON format
- `.wia-home.pb` — Protocol Buffers
