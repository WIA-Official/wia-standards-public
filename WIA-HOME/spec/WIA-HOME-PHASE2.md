# WIA-HOME Specification - PHASE 2
...
The WIA-HOME standard supports multiple API paradigms:
...
```typescript
import { WIASmart HomeSDK } from '@wia/defi-sdk';

// Initialize SDK
const sdk = new WIASmart HomeSDK({
  apiKey: 'YOUR_API_KEY',
...
```python
from wia_defi import WIASmart HomeSDK

# Initialize SDK
sdk = WIASmart HomeSDK(api_key='YOUR_API_KEY', network='mainnet')
