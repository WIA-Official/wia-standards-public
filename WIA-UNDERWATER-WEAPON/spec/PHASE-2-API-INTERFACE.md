# Underwater Weapon — Phase 2: API Interface Specification
...
Phase 2 defines RESTful API endpoints for interacting with Underwater Weapon services. This specification enables standardized programmatic access to water quality data across water treatment systems.

### 1.1 Base URL

```
Production: https://api.underwater-weapon.wia.org/v1
Sandbox:    https://sandbox.underwater-weapon.wia.org/v1
```
...
| Method | Endpoint | Description |
|--------|----------|-------------|
| POST | /data/ingest | Submit water quality data |
