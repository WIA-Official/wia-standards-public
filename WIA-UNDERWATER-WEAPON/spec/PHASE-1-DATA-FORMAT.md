# Underwater Weapon — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for Underwater Weapon systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across water treatment systems and hydraulic infrastructure.
...
```json
{
  ...
  "title": "WIA Underwater Weapon Data Format",
  "type": "object",
  "required": ["standard", "version", "timestamp", "data"],
  "properties": {
    "standard": {
      "type": "string",
      "const": "WIA-UNDERWATER-WEAPON"
    },
    "version": {
      "type": "string",
      "pattern": "^\\d+\\.\\d+\\.\\d+$"
    ...
    "data": {
      "type": "object",
      "description": "Primary water quality data payload"
    }
  }
}
```
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (WIA-UNDERWATER-WEAPON) |
...
| data | object | Yes | Domain-specific water quality data |
...
### 5.3 File Extensions
- `.wia-underwater-weapon.json` — JSON format
- `.wia-underwater-weapon.pb` — Protocol Buffers
...
```json
{
  "standard": "WIA-UNDERWATER-WEAPON",
  "version": "1.0.0",
