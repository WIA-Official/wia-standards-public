...
Minimal POSIX shell client that demonstrates the WIA `bci-consent` standard's
...
```sh
export WIA_API_BASE="https://bci-consent.example.com/api/v1"
export WIA_API_TOKEN="<your-bearer-token>"
./bci-consent.sh list
./bci-consent.sh get <id>
./bci-consent.sh create payload.json
./bci-consent.sh validate payload.json
./bci-consent.sh export <id>
```
