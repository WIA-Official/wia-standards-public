...
export class AutonomousShip {
  ...
  private async initialize(): Promise<void> {
    console.log(`[WIA-OCEAN-009] Initializing ${this.config.vehicleId}`);
    ...
    console.log('[WIA-OCEAN-009] Initialization complete');
  }
  ...
  async startMission(config: MissionConfig): Promise<MissionData> {
    console.log('[WIA-OCEAN-009] Starting mission');
  ...
  async descend(targetDepth: number, rate: number = 30): Promise<void> {
    console.log(`[WIA-OCEAN-009] Descending to ${targetDepth}m at ${rate}m/min`);
    ...
    console.log(`[WIA-OCEAN-009] Reached target depth: ${targetDepth}m`);
  }
  ...
  async ascend(rate: number = 30): Promise<void> {
    console.log(`[WIA-OCEAN-009] Ascending at ${rate}m/min`);

    this.emitEvent('dive_end', { rate });

    await this.delay(1000); // Simulate ascent

    console.log('[WIA-OCEAN-009] Surfaced');
  }
  ...
  async sendCommand(command: ControlCommand): Promise<void> {
    console.log('[WIA-OCEAN-009] Sending command:', command);
    await this.delay(100);
  }
  ...
  async emergencySurface(): Promise<void> {
    console.log('[WIA-OCEAN-009] EMERGENCY SURFACE INITIATED');
    ...
    console.log('[WIA-OCEAN-009] Surfaced - Emergency procedure complete');
  }
