# Education Robot — Phase 2: API Interface Specification
...
Phase 2 defines RESTful API endpoints for interacting with Education Robot services. This specification enables standardized programmatic access to robot telemetry across robotic control systems.

### 1.1 Base URL

```
Production: https://api.education-robot.wia.org/v1
Sandbox:    https://sandbox.education-robot.wia.org/v1
```
