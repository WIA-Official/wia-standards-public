# PHASE 2 — API INTERFACE · space-habitat
**Version:** 1.0
**Status:** Active
...
This Phase defines the API INTERFACE layer of the *space-habitat* WIA standard.
...
in lockstep across Phases 1–4 of space-habitat so that conformance claims at any
