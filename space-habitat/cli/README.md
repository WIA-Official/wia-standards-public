...
Minimal POSIX shell client that demonstrates the WIA `space-habitat` standard's
...
```sh
export WIA_API_BASE="https://space-habitat.example.com/api/v1"
export WIA_API_TOKEN="<your-bearer-token>"
./space-habitat.sh list
./space-habitat.sh get <id>
./space-habitat.sh create payload.json
./space-habitat.sh validate payload.json
./space-habitat.sh export <id>
```
