# Agricultural IOT — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for Agricultural IOT systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across farm management systems and agricultural equipment.
...
```json
{
  ...
  "title": "WIA Agricultural IOT Data Format",
  "type": "object",
  "required": ["standard", "version", "timestamp", "data"],
  "properties": {
    "standard": {
      "type": "string",
      "const": "agricultural-iot"
    },
    "version": {
      "type": "string",
      "pattern": "^\\d+\\.\\d+\\.\\d+$"
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (agricultural-iot) |
...
### 5.3 File Extensions
- `.wia-agricultural-iot.json` — JSON format
- `.wia-agricultural-iot.pb` — Protocol Buffers
