# Agricultural IOT — Phase 2: API Interface Specification
...
Phase 2 defines RESTful API endpoints for interacting with Agricultural IOT services. This specification enables standardized programmatic access to agricultural data across farm management systems.

### 1.1 Base URL

```
Production: https://api.agricultural-iot.wia.org/v1
Sandbox:    https://sandbox.agricultural-iot.wia.org/v1
```
