# Flexible Display — Phase 3: Protocol Specification
...
Phase 3 defines communication protocols for real-time data exchange between Flexible Display components, including display testing systems and visual output devices. This specification ensures secure, efficient, and interoperable data streaming.
...
|------|-----------|-------------|
| DATA | Uni/Bi | display parameters transmission |
