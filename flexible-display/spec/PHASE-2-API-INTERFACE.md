# Flexible Display — Phase 2: API Interface Specification
...
Phase 2 defines RESTful API endpoints for interacting with Flexible Display services. This specification enables standardized programmatic access to display parameters across display testing systems.

### 1.1 Base URL

```
Production: https://api.flexible-display.wia.org/v1
Sandbox:    https://sandbox.flexible-display.wia.org/v1
```
