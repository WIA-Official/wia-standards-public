# WIA-AGRI-IRR-001 — Phase 2: API

> Smart Irrigation canonical Phase 2 specification per the WIA Standards four-Phase architecture.

> Domain: 스마트 관개 — 정밀 관개 · ISOBUS · FAO 56 ETo · 물 사용 효율 · IoT.

## A.1 Scope

This Phase covers the canonical api layer of the WIA-AGRI-IRR-001 standard. It composes with the Phase 3 document for cross-Phase integration and inherits cross-standard behaviour from the wider WIA Standards family per the README.md scope statement.
