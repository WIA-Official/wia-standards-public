# Devops — Phase 4: Integration Specification
...
Phase 4 defines integration patterns and requirements for deploying Devops within existing infrastructure. This specification covers system architecture, integration patterns, testing requirements, and deployment guidelines for management systems and technology platforms.
...
- Implement the `WIAdevopsAdapter` interface
...
```json
{
  ...
  "channels": [
    "devops.data.ingested",
    "devops.resource.updated",
    "devops.alert.triggered"
  ]
}
```
