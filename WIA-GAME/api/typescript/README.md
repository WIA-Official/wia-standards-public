...
- **Type-Safe**: Full TypeScript support with comprehensive type gamenitions
...
```bash
npm install @wia/game-sdk
# or
yarn add @wia/game-sdk
# or
pnpm add @wia/game-sdk
```

## Quick Start

```typescript
import { WIADeFiSDK } from '@wia/game-sdk';
...
Get your API key at: https://api.wia-game.org/register
...
- Documentation: https://docs.wia.org/game-sdk
