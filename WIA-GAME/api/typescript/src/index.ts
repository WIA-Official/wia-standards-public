/**
 * WIA-GAME TypeScript SDK
 * Version: 1.0.0
 * Philosophy: 弘益人間 (Benefit All Humanity)
 *
 * Comprehensive GAME SDK supporting:
...
export class WIAGAMESDK {
  ...
  constructor(config: SDKConfig) {
    this.config = {
      ...
      baseURL: config.baseURL || 'https://api.wia-game.org/v1',
  ...
  /**
   * Get all supported GAME protocols
 ...
 * Create SDK instance
 */
export function createWIAGAMESDK(config: SDKConfig): WIAGAMESDK {
  return new WIAGAMESDK(config);
}

/**
 * Default export
 */
export default WIAGAMESDK;
