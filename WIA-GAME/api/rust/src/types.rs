//! Type definitions for the WIA-GAME Standard
//!
//! This module contains all the data structures used in the WIA-GAME API.
...
/// Main data structure for WIA-GAME
