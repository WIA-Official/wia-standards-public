# Game — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for Game systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across gaming platforms and interactive entertainment systems.
...
```json
{
  ...
  "properties": {
    ...
    "data": {
      "type": "object",
      "description": "Primary game state data payload"
    }
  }
}
```
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (WIA-GAME) |
...
| data | object | Yes | Domain-specific game state data |
...
### 5.3 File Extensions
- `.wia-game.json` — JSON format
- `.wia-game.pb` — Protocol Buffers
