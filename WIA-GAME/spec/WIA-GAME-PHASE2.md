# WIA-GAME Specification - PHASE 2
...
The WIA-GAME standard supports multiple API paradigms:
...
```typescript
import { WIAGame DevelopmentSDK } from '@wia/defi-sdk';

// Initialize SDK
const sdk = new WIAGame DevelopmentSDK({
  apiKey: 'YOUR_API_KEY',
...
```python
from wia_defi import WIAGame DevelopmentSDK

# Initialize SDK
sdk = WIAGame DevelopmentSDK(api_key='YOUR_API_KEY', network='mainnet')
