# WIA-GAME PHASE 4 — INTEGRATION Specification
...
This document defines how a WIA-GAME programme
...
`/.well-known/wia-WIA-GAME` that links to the API
...
date WIA-GAME MAY migrate historical records by
