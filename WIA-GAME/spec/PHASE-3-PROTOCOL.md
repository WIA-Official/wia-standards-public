# WIA-GAME PHASE 3 — PROTOCOL Specification
...
A WIA-GAME operator MAY claim conformance to
WIA-GAME only after the operating jurisdiction's
...
A programme conformant with WIA-GAME publishes
