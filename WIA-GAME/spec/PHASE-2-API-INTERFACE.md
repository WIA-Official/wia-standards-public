# Game — Phase 2: API Interface Specification
...
Phase 2 defines RESTful API endpoints for interacting with Game services. This specification enables standardized programmatic access to game state data across gaming platforms.

### 1.1 Base URL

```
Production: https://api.game.wia.org/v1
Sandbox:    https://sandbox.game.wia.org/v1
```
...
| Method | Endpoint | Description |
|--------|----------|-------------|
| POST | /data/ingest | Submit game state data |
