# WIA-GAME PHASE 2 — API-INTERFACE Specification
...
`urn:wia:WIA-GAME:status-transition`.
...
`422` with type
`urn:wia:WIA-GAME:source-mix-required`.
...
with type
`urn:wia:WIA-GAME:laboratory-not-accredited`.
...
`409` with type
`urn:wia:WIA-GAME:quality-certificate-required`.
...
- `urn:wia:WIA-GAME:hydrogen-quality-out-of-grade`
- `urn:wia:WIA-GAME:cryogenic-temperature-excursion`
- `urn:wia:WIA-GAME:guarantee-of-origin-mismatch`
- `urn:wia:WIA-GAME:evidence-mismatch`
