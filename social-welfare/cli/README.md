...
Minimal POSIX shell client that demonstrates the WIA `social-welfare` standard's
...
```sh
export WIA_API_BASE="https://social-welfare.example.com/api/v1"
export WIA_API_TOKEN="<your-bearer-token>"
./social-welfare.sh list
./social-welfare.sh get <id>
./social-welfare.sh create payload.json
./social-welfare.sh validate payload.json
./social-welfare.sh export <id>
```
