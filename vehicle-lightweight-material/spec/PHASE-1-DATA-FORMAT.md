# Vehicle Lightweight Material — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for Vehicle Lightweight Material systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across transportation networks and vehicular systems.
...
```json
{
  ...
  "title": "WIA Vehicle Lightweight Material Data Format",
  "type": "object",
  "required": ["standard", "version", "timestamp", "data"],
  "properties": {
    "standard": {
      "type": "string",
      "const": "vehicle-lightweight-material"
    },
    "version": {
      "type": "string",
      "pattern": "^\\d+\\.\\d+\\.\\d+$"
    ...
    "data": {
      "type": "object",
      "description": "Primary vehicle data payload"
    }
  }
}
```
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (vehicle-lightweight-material) |
...
| data | object | Yes | Domain-specific vehicle data |
...
### 5.3 File Extensions
- `.wia-vehicle-lightweight-.json` — JSON format
- `.wia-vehicle-lightweight-.pb` — Protocol Buffers
...
```json
{
  "standard": "vehicle-lightweight-material",
  "version": "1.0.0",
