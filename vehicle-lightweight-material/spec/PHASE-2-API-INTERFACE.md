# Vehicle Lightweight Material — Phase 2: API Interface Specification
...
Phase 2 defines RESTful API endpoints for interacting with Vehicle Lightweight Material services. This specification enables standardized programmatic access to vehicle data across transportation networks.

### 1.1 Base URL

```
Production: https://api.vehicle-lightweight-.wia.org/v1
Sandbox:    https://sandbox.vehicle-lightweight-.wia.org/v1
```
...
| Method | Endpoint | Description |
|--------|----------|-------------|
| POST | /data/ingest | Submit vehicle data |
