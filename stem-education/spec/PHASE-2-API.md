# WIA-EDU-019 — Phase 2: API

> STEM Education canonical Phase 2 specification per the WIA Standards four-Phase architecture.

> Domain: STEM 교육 — 과학·기술·공학·수학 교육 · NGSS · CSTA · 평가 프레임.

## A.1 Scope

This Phase covers the canonical api layer of the WIA-EDU-019 standard. It composes with the Phase 3 document for cross-Phase integration and inherits cross-standard behaviour from the wider WIA Standards family per the README.md scope statement.
