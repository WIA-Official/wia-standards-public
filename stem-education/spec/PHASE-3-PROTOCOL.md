# WIA-EDU-019 — Phase 3: PROTOCOL

> STEM Education canonical Phase 3 specification per the WIA Standards four-Phase architecture.

> Domain: STEM 교육 — 과학·기술·공학·수학 교육 · NGSS · CSTA · 평가 프레임.

## A.1 Scope

This Phase covers the canonical protocol layer of the WIA-EDU-019 standard. It composes with the Phase 4 document for cross-Phase integration and inherits cross-standard behaviour from the wider WIA Standards family per the README.md scope statement.
