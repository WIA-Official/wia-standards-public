# WIA-EDU-019 — Phase 1: DATA-FORMAT

> STEM Education canonical Phase 1 specification per the WIA Standards four-Phase architecture.

> Domain: STEM 교육 — 과학·기술·공학·수학 교육 · NGSS · CSTA · 평가 프레임.

## A.1 Scope

This Phase covers the canonical data-format layer of the WIA-EDU-019 standard. It composes with the Phase 2 document for cross-Phase integration and inherits cross-standard behaviour from the wider WIA Standards family per the README.md scope statement.
...
with `wia.standard.slug` = `stem-education` and `wia.standard.phase` =
...
`/.well-known/wia-stem-education-capabilities` enumerating per-endpoint
