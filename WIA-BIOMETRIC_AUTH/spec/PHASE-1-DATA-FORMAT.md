# Biometric Auth — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for Biometric Auth systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across biotech research platforms and laboratory systems.
...
```json
{
  ...
  "title": "WIA Biometric Auth Data Format",
  "type": "object",
  "required": ["standard", "version", "timestamp", "data"],
  "properties": {
    "standard": {
      "type": "string",
      "const": "WIA-BIOMETRIC_AUTH"
    },
    "version": {
      "type": "string",
      "pattern": "^\\d+\\.\\d+\\.\\d+$"
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (WIA-BIOMETRIC_AUTH) |
...
### 5.3 File Extensions
- `.wia-biometric-auth.json` — JSON format
- `.wia-biometric-auth.pb` — Protocol Buffers
