# Biometric Auth — Phase 2: API Interface Specification
...
Phase 2 defines RESTful API endpoints for interacting with Biometric Auth services. This specification enables standardized programmatic access to biological data across biotech research platforms.

### 1.1 Base URL

```
Production: https://api.biometric-auth.wia.org/v1
Sandbox:    https://sandbox.biometric-auth.wia.org/v1
```
