...
- Implement the `WIAhuman_augmentationAdapter` interface
...
```json
{
  ...
  "channels": [
    "human-augmentation.data.ingested",
    "human-augmentation.resource.updated",
    "human-augmentation.alert.triggered"
  ]
}
```
...
```
WIA_STANDARD=human-augmentation
WIA_VERSION=1.0.0
WIA_LOG_LEVEL=info
