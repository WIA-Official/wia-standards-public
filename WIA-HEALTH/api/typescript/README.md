...
- **Type-Safe**: Full TypeScript support with comprehensive type healthnitions
...
```bash
npm install @wia/health-sdk
# or
yarn add @wia/health-sdk
# or
pnpm add @wia/health-sdk
```

## Quick Start

```typescript
import { WIADeFiSDK } from '@wia/health-sdk';
...
Get your API key at: https://api.wia-health.org/register
...
- Documentation: https://docs.wia.org/health-sdk
