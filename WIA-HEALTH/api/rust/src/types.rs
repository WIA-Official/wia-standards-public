//! Type definitions for the WIA-HEALTH Standard
//!
//! This module contains all the data structures used in the WIA-HEALTH API.
...
/// Main data structure for WIA-HEALTH
