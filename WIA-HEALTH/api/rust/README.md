...
Official Rust SDK for the WIA-HEALTH Standard.
...
```rust
use wia_health_sdk::CreateHealthRequest;

let request = CreateHealthRequest {
...
- Documentation: https://docs.wiastandards.com/WIA-HEALTH
