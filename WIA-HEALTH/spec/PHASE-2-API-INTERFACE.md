# Health — Phase 2: API Interface Specification
...
Phase 2 defines RESTful API endpoints for interacting with Health services. This specification enables standardized programmatic access to patient health data across clinical systems.

### 1.1 Base URL

```
Production: https://api.health.wia.org/v1
Sandbox:    https://sandbox.health.wia.org/v1
```
