...
`urn:wia:WIA-HEALTH:status-transition`.
...
`422` with type
`urn:wia:WIA-HEALTH:source-mix-required`.
...
with type
`urn:wia:WIA-HEALTH:laboratory-not-accredited`.
...
`409` with type
`urn:wia:WIA-HEALTH:quality-certificate-required`.
...
- `urn:wia:WIA-HEALTH:hydrogen-quality-out-of-grade`
- `urn:wia:WIA-HEALTH:cryogenic-temperature-excursion`
- `urn:wia:WIA-HEALTH:guarantee-of-origin-mismatch`
- `urn:wia:WIA-HEALTH:evidence-mismatch`
