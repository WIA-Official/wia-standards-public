# Health — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for Health systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across clinical systems and health monitoring devices.
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (WIA-HEALTH) |
...
### 5.3 File Extensions
- `.wia-health.json` — JSON format
- `.wia-health.pb` — Protocol Buffers
