# WIA-HEALTH PHASE 3 — PROTOCOL Specification
...
A WIA-HEALTH operator MAY claim conformance to
WIA-HEALTH only after the operating jurisdiction's
...
A programme conformant with WIA-HEALTH publishes
