# WIA-HEALTH PHASE 4 — INTEGRATION Specification
...
This document defines how a WIA-HEALTH programme
...
`/.well-known/wia-WIA-HEALTH` that links to the API
...
date WIA-HEALTH MAY migrate historical records by
