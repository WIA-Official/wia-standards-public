# WIA-HEALTH Specification - PHASE 2
...
The WIA-HEALTH standard supports multiple API paradigms:
...
```typescript
import { WIADigital HealthSDK } from '@wia/defi-sdk';

// Initialize SDK
const sdk = new WIADigital HealthSDK({
  apiKey: 'YOUR_API_KEY',
...
```python
from wia_defi import WIADigital HealthSDK

# Initialize SDK
sdk = WIADigital HealthSDK(api_key='YOUR_API_KEY', network='mainnet')
