# Electronic Warfare — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for Electronic Warfare systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across management systems and technology platforms.
...
```json
{
  ...
  "title": "WIA Electronic Warfare Data Format",
  "type": "object",
  "required": ["standard", "version", "timestamp", "data"],
  "properties": {
    "standard": {
      "type": "string",
      "const": "electronic-warfare"
    },
    "version": {
      "type": "string",
      "pattern": "^\\d+\\.\\d+\\.\\d+$"
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (electronic-warfare) |
...
### 5.3 File Extensions
- `.wia-electronic-warfare.json` — JSON format
- `.wia-electronic-warfare.pb` — Protocol Buffers
