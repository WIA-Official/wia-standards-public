# AI Chip — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for AI Chip systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across AI service platforms and AI processing systems.
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (ai-chip) |
...
### 5.3 File Extensions
- `.wia-ai-chip.json` — JSON format
- `.wia-ai-chip.pb` — Protocol Buffers
