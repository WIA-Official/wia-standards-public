# Electronic Skin — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for Electronic Skin systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across management systems and technology platforms.
...
```json
{
  ...
  "title": "WIA Electronic Skin Data Format",
  "type": "object",
  "required": ["standard", "version", "timestamp", "data"],
  "properties": {
    "standard": {
      "type": "string",
      "const": "electronic-skin"
    },
    "version": {
      "type": "string",
      "pattern": "^\\d+\\.\\d+\\.\\d+$"
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (electronic-skin) |
...
### 5.3 File Extensions
- `.wia-electronic-skin.json` — JSON format
- `.wia-electronic-skin.pb` — Protocol Buffers
