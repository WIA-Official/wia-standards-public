# Chronic Pain — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for Chronic Pain systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across AI service platforms and AI processing systems.
...
```json
{
  ...
  "title": "WIA Chronic Pain Data Format",
  "type": "object",
  "required": ["standard", "version", "timestamp", "data"],
  "properties": {
    "standard": {
      "type": "string",
      "const": "WIA-CHRONIC-PAIN"
    },
    "version": {
      "type": "string",
      "pattern": "^\\d+\\.\\d+\\.\\d+$"
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (WIA-CHRONIC-PAIN) |
...
### 5.3 File Extensions
- `.wia-chronic-pain.json` — JSON format
- `.wia-chronic-pain.pb` — Protocol Buffers
