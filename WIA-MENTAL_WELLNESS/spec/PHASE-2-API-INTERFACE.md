# Mental Wellness — Phase 2: API Interface Specification
...
Phase 2 defines RESTful API endpoints for interacting with Mental Wellness services. This specification enables standardized programmatic access to mental wellness data across therapy platforms.

### 1.1 Base URL

```
Production: https://api.mental-wellness.wia.org/v1
Sandbox:    https://sandbox.mental-wellness.wia.org/v1
```
...
| Method | Endpoint | Description |
|--------|----------|-------------|
| POST | /data/ingest | Submit mental wellness data |
