# `greenhouse-gas-monitoring` CLI

Minimal POSIX shell client that demonstrates the WIA `greenhouse-gas-monitoring` standard's
...
```sh
export WIA_API_BASE="https://greenhouse-gas-monitoring.example.com/api/v1"
export WIA_API_TOKEN="<your-bearer-token>"
./greenhouse-gas-monitoring.sh list
./greenhouse-gas-monitoring.sh get <id>
./greenhouse-gas-monitoring.sh create payload.json
./greenhouse-gas-monitoring.sh validate payload.json
./greenhouse-gas-monitoring.sh export <id>
```
