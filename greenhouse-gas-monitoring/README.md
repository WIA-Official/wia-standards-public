...
WIA standard `greenhouse-gas-monitoring` — see <https://wiastandards.com> for the full standards catalogue.
...
WIA conformance for **greenhouse-gas-monitoring** is evaluated across three tiers, mirrored in every PHASE document under `spec/`:
...
```
standards/greenhouse-gas-monitoring/
