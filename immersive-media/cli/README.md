...
Minimal POSIX shell client that demonstrates the WIA `immersive-media` standard's
...
```sh
export WIA_API_BASE="https://immersive-media.example.com/api/v1"
export WIA_API_TOKEN="<your-bearer-token>"
./immersive-media.sh list
./immersive-media.sh get <id>
./immersive-media.sh create payload.json
./immersive-media.sh validate payload.json
./immersive-media.sh export <id>
```
