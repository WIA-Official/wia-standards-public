# PHASE 2 — API INTERFACE · remote-patient-monitoring
**Version:** 1.0
**Status:** Active
...
This Phase defines the API INTERFACE layer of the *remote-patient-monitoring* WIA standard.
...
in lockstep across Phases 1–4 of remote-patient-monitoring so that conformance claims at any
