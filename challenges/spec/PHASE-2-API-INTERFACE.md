# WIA-challenges PHASE 2 — API-INTERFACE Specification

**Standard:** WIA-challenges
...
`urn:wia:challenges:status-transition`.
...
`422` with type
`urn:wia:challenges:source-mix-required`.
...
with type
`urn:wia:challenges:laboratory-not-accredited`.
...
`409` with type
`urn:wia:challenges:quality-certificate-required`.
...
- `urn:wia:challenges:hydrogen-quality-out-of-grade`
- `urn:wia:challenges:cryogenic-temperature-excursion`
- `urn:wia:challenges:guarantee-of-origin-mismatch`
- `urn:wia:challenges:evidence-mismatch`
