# WIA-challenges PHASE 3 — PROTOCOL Specification
...
A challenges operator MAY claim conformance to
WIA-challenges only after the operating jurisdiction's
...
A programme conformant with WIA-challenges publishes
