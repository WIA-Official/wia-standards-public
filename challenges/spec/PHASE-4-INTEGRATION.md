# WIA-challenges PHASE 4 — INTEGRATION Specification
...
This document defines how a challenges programme
...
`/.well-known/wia-challenges` that links to the API
...
date WIA-challenges MAY migrate historical records by
