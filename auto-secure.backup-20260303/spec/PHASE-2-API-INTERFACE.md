# WIA-auto-secure.backup-20260303 PHASE 2 — API-INTERFACE Specification

**Standard:** WIA-auto-secure.backup-20260303
...
`urn:wia:auto-secure.backup-20260303:status-transition`.
...
`422` with type
`urn:wia:auto-secure.backup-20260303:source-mix-required`.
...
with type
`urn:wia:auto-secure.backup-20260303:laboratory-not-accredited`.
...
`409` with type
`urn:wia:auto-secure.backup-20260303:quality-certificate-required`.
...
- `urn:wia:auto-secure.backup-20260303:hydrogen-quality-out-of-grade`
- `urn:wia:auto-secure.backup-20260303:cryogenic-temperature-excursion`
- `urn:wia:auto-secure.backup-20260303:guarantee-of-origin-mismatch`
- `urn:wia:auto-secure.backup-20260303:evidence-mismatch`
