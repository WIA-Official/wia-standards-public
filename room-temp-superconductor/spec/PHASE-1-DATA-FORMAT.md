# Room Temp Superconductor — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for Room Temp Superconductor systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across management systems and technology platforms.
...
```json
{
  ...
  "title": "WIA Room Temp Superconductor Data Format",
  "type": "object",
  "required": ["standard", "version", "timestamp", "data"],
  "properties": {
    "standard": {
      "type": "string",
      "const": "room-temp-superconductor"
    },
    "version": {
      "type": "string",
      "pattern": "^\\d+\\.\\d+\\.\\d+$"
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (room-temp-superconductor) |
...
### 5.3 File Extensions
- `.wia-room-temp-supercondu.json` — JSON format
- `.wia-room-temp-supercondu.pb` — Protocol Buffers
...
```json
{
  "standard": "room-temp-superconductor",
  "version": "1.0.0",
