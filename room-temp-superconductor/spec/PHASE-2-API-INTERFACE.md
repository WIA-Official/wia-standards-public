# Room Temp Superconductor — Phase 2: API Interface Specification
...
Phase 2 defines RESTful API endpoints for interacting with Room Temp Superconductor services. This specification enables standardized programmatic access to operational data across management systems.

### 1.1 Base URL

```
Production: https://api.room-temp-supercondu.wia.org/v1
Sandbox:    https://sandbox.room-temp-supercondu.wia.org/v1
```
