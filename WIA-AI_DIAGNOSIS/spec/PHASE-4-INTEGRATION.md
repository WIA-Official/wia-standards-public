# AI Diagnosis — Phase 4: Integration Specification
...
Phase 4 defines integration patterns and requirements for deploying AI Diagnosis within existing infrastructure. This specification covers system architecture, integration patterns, testing requirements, and deployment guidelines for AI service platforms and AI processing systems.
...
- Implement the `WIAWIA_AI_DIAGNOSISAdapter` interface
...
```json
{
  ...
  "channels": [
    "wia-ai_diagnosis.data.ingested",
    "wia-ai_diagnosis.resource.updated",
    "wia-ai_diagnosis.alert.triggered"
  ]
}
```
