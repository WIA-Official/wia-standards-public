# AI Diagnosis — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for AI Diagnosis systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across AI service platforms and AI processing systems.
...
```json
{
  ...
  "title": "WIA AI Diagnosis Data Format",
  "type": "object",
  "required": ["standard", "version", "timestamp", "data"],
  "properties": {
    "standard": {
      "type": "string",
      "const": "WIA-AI_DIAGNOSIS"
    },
    "version": {
      "type": "string",
      "pattern": "^\\d+\\.\\d+\\.\\d+$"
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (WIA-AI_DIAGNOSIS) |
...
### 5.3 File Extensions
- `.wia-ai-diagnosis.json` — JSON format
- `.wia-ai-diagnosis.pb` — Protocol Buffers
