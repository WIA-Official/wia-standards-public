...
This document defines how a WIA-HERITAGE-005 programme
...
`/.well-known/wia-WIA-HERITAGE-005` that links to the API
...
date WIA-HERITAGE-005 MAY migrate historical records by
