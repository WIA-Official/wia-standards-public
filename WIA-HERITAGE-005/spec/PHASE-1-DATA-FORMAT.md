# Heritage 005 — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for Heritage 005 systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across digital preservation systems and cultural databases.
...
```json
{
  ...
  "title": "WIA Heritage 005 Data Format",
  "type": "object",
  "required": ["standard", "version", "timestamp", "data"],
  "properties": {
    "standard": {
      "type": "string",
      "const": "WIA-HERITAGE-005"
    },
    "version": {
      "type": "string",
      "pattern": "^\\d+\\.\\d+\\.\\d+$"
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (WIA-HERITAGE-005) |
...
### 5.3 File Extensions
- `.wia-heritage-005.json` — JSON format
- `.wia-heritage-005.pb` — Protocol Buffers
