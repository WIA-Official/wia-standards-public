...
`urn:wia:WIA-HERITAGE-005:status-transition`.
...
`422` with type
`urn:wia:WIA-HERITAGE-005:source-mix-required`.
...
with type
`urn:wia:WIA-HERITAGE-005:laboratory-not-accredited`.
...
`409` with type
`urn:wia:WIA-HERITAGE-005:quality-certificate-required`.
...
- `urn:wia:WIA-HERITAGE-005:hydrogen-quality-out-of-grade`
- `urn:wia:WIA-HERITAGE-005:cryogenic-temperature-excursion`
- `urn:wia:WIA-HERITAGE-005:guarantee-of-origin-mismatch`
- `urn:wia:WIA-HERITAGE-005:evidence-mismatch`
