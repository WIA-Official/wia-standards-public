# AI Interoperability — Phase 2: API Interface Specification
...
Phase 2 defines RESTful API endpoints for interacting with AI Interoperability services. This specification enables standardized programmatic access to AI model data across AI service platforms.

### 1.1 Base URL

```
Production: https://api.ai-interoperability.wia.org/v1
Sandbox:    https://sandbox.ai-interoperability.wia.org/v1
```
