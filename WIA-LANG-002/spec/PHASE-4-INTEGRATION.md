# WIA-LANG-002 PHASE 4 — INTEGRATION Specification
...
This document defines how a WIA-LANG-002 programme
...
`/.well-known/wia-WIA-LANG-002` that links to the API
...
date WIA-LANG-002 MAY migrate historical records by
