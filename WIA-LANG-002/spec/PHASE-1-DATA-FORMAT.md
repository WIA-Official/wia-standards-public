# Lang 002 — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for Lang 002 systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across NLP processing systems and language service platforms.
...
```json
{
  ...
  "title": "WIA Lang 002 Data Format",
  "type": "object",
  ...
  "properties": {
    ...
    "data": {
      "type": "object",
      "description": "Primary linguistic data payload"
    }
  }
}
```
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (WIA-LANG-002) |
...
| data | object | Yes | Domain-specific linguistic data |
...
### 5.3 File Extensions
- `.wia-lang-002.json` — JSON format
- `.wia-lang-002.pb` — Protocol Buffers
