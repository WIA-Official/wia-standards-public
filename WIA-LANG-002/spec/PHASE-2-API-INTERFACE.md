# WIA-LANG-002 PHASE 2 — API-INTERFACE Specification
...
`urn:wia:WIA-LANG-002:status-transition`.
...
`422` with type
`urn:wia:WIA-LANG-002:source-mix-required`.
...
with type
`urn:wia:WIA-LANG-002:laboratory-not-accredited`.
...
`409` with type
`urn:wia:WIA-LANG-002:quality-certificate-required`.
...
- `urn:wia:WIA-LANG-002:hydrogen-quality-out-of-grade`
- `urn:wia:WIA-LANG-002:cryogenic-temperature-excursion`
- `urn:wia:WIA-LANG-002:guarantee-of-origin-mismatch`
- `urn:wia:WIA-LANG-002:evidence-mismatch`
