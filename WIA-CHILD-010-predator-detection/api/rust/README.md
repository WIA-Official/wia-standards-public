# WIA-CHILD-010-predator-detection Rust SDK

> **弘益人間 (Benefit All Humanity)**

Official Rust SDK for the WIA-CHILD-010-predator-detection Standard.
...
```toml
[dependencies]
wia-child-010-predator-detection-sdk = "1.0"
...
```rust
use wia_child_010_predator_detection_sdk::CreateChild010PredatorDetectionRequest;

let request = CreateChild010PredatorDetectionRequest {
...
```rust
use wia_child_010_predator_detection_sdk::ListParams;
...
```rust
use wia_child_010_predator_detection_sdk::Error;
...
- Documentation: https://docs.wiastandards.com/WIA-CHILD-010-predator-detection
