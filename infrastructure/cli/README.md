...
Minimal POSIX shell client that demonstrates the WIA `infrastructure` standard's
...
```sh
export WIA_API_BASE="https://infrastructure.example.com/api/v1"
export WIA_API_TOKEN="<your-bearer-token>"
./infrastructure.sh list
./infrastructure.sh get <id>
./infrastructure.sh create payload.json
./infrastructure.sh validate payload.json
./infrastructure.sh export <id>
```
