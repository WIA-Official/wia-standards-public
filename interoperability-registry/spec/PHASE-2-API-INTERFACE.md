# Interoperability Registry — Phase 2: API Interface Specification
...
Phase 2 defines RESTful API endpoints for interacting with Interoperability Registry services. This specification enables standardized programmatic access to operational data across management systems.

### 1.1 Base URL

```
Production: https://api.interoperability-reg.wia.org/v1
Sandbox:    https://sandbox.interoperability-reg.wia.org/v1
```
...
| Method | Endpoint | Description |
|--------|----------|-------------|
| POST | /data/ingest | Submit operational data |
