# Interoperability Registry — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for Interoperability Registry systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across management systems and technology platforms.
...
```json
{
  ...
  "title": "WIA Interoperability Registry Data Format",
  "type": "object",
  "required": ["standard", "version", "timestamp", "data"],
  "properties": {
    "standard": {
      "type": "string",
      "const": "interoperability-registry"
    },
    "version": {
      "type": "string",
      "pattern": "^\\d+\\.\\d+\\.\\d+$"
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (interoperability-registry) |
...
### 5.3 File Extensions
- `.wia-interoperability-reg.json` — JSON format
- `.wia-interoperability-reg.pb` — Protocol Buffers
...
```json
{
  "standard": "interoperability-registry",
  "version": "1.0.0",
