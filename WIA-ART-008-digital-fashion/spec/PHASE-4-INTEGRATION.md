# WIA-ART-008: Phase 4 - Integration Specification
**Version:** 1.0
**Status:** Official
...
Integration guidelines for WIA-ART-008 Digital Fashion Standard.

## 2. Platform Integration

### 2.1 Web Applications
```html
<script src="https://cdn.wia.org/art-008/v1/wia-art-008.js"></script>
<script>
  const sdk = new WIAART008({
    apiKey: 'your-api-key'
  });
</script>
```
...
let sdk = WIAART008(apiKey: "your-api-key")
```

### 2.3 Server-Side Integration
```python
from wia_art_008 import SDK
