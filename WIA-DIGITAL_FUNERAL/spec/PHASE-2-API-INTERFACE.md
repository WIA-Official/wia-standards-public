# WIA-DIGITAL_FUNERAL: Phase 2 - API Interface Specification
**Version:** 1.0
**Status:** Official
...
This document specifies the API interface requirements for DIGITAL FUNERAL. All implementations MUST provide these endpoints to ensure interoperability.

## 2. REST API Endpoints

### 2.1 Base URL
```
https://api.wia.org/v1/wia-digital-funeral/
```
...
```http
POST /v1/wia-digital-funeral/records HTTP/1.1
...
### 3.1 Installation
```bash
npm install @wia/wia-digital-funeral-sdk
```
...
### 3.3 Usage Example
```typescript
import { createClient } from '@wia/wia-digital-funeral-sdk';
...
WIA conformance for WIA-DIGITAL_FUNERAL is evaluated across three tiers:
...
- `wia-standards/standards/WIA-DIGITAL_FUNERAL/api/` — TypeScript SDK skeleton
- `wia-standards/standards/WIA-DIGITAL_FUNERAL/cli/` — POSIX shell client demonstrating the request/response contract
- `wia-standards/standards/WIA-DIGITAL_FUNERAL/simulator/` — interactive browser-based simulator for the PHASE protocol
