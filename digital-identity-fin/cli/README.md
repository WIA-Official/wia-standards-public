# `digital-identity-fin` CLI

Minimal POSIX shell client that demonstrates the WIA `digital-identity-fin` standard's
...
```sh
export WIA_API_BASE="https://digital-identity-fin.example.com/api/v1"
export WIA_API_TOKEN="<your-bearer-token>"
./digital-identity-fin.sh list
./digital-identity-fin.sh get <id>
./digital-identity-fin.sh create payload.json
./digital-identity-fin.sh validate payload.json
./digital-identity-fin.sh export <id>
```
