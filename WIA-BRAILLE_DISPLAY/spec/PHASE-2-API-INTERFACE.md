# Braille Display — Phase 2: API Interface Specification
...
Phase 2 defines RESTful API endpoints for interacting with Braille Display services. This specification enables standardized programmatic access to AI model data across AI service platforms.

### 1.1 Base URL

```
Production: https://api.braille-display.wia.org/v1
Sandbox:    https://sandbox.braille-display.wia.org/v1
```
