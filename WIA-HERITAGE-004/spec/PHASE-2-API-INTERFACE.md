# WIA-HERITAGE-004 PHASE 2 — API-INTERFACE Specification
...
`urn:wia:WIA-HERITAGE-004:status-transition`.
...
`422` with type
`urn:wia:WIA-HERITAGE-004:source-mix-required`.
...
with type
`urn:wia:WIA-HERITAGE-004:laboratory-not-accredited`.
...
`409` with type
`urn:wia:WIA-HERITAGE-004:quality-certificate-required`.
...
- `urn:wia:WIA-HERITAGE-004:hydrogen-quality-out-of-grade`
- `urn:wia:WIA-HERITAGE-004:cryogenic-temperature-excursion`
- `urn:wia:WIA-HERITAGE-004:guarantee-of-origin-mismatch`
- `urn:wia:WIA-HERITAGE-004:evidence-mismatch`
