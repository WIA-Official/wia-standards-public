# Heritage 004 — Phase 2: API Interface Specification
...
Phase 2 defines RESTful API endpoints for interacting with Heritage 004 services. This specification enables standardized programmatic access to heritage artifact data across digital preservation systems.

### 1.1 Base URL

```
Production: https://api.heritage-004.wia.org/v1
Sandbox:    https://sandbox.heritage-004.wia.org/v1
```
