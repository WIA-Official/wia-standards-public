# Accessible UI — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for Accessible UI systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across management systems and technology platforms.
...
```json
{
  ...
  "title": "WIA Accessible UI Data Format",
  "type": "object",
  "required": ["standard", "version", "timestamp", "data"],
  "properties": {
    "standard": {
      "type": "string",
      "const": "WIA-ACCESSIBLE_UI"
    },
    "version": {
      "type": "string",
      "pattern": "^\\d+\\.\\d+\\.\\d+$"
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (WIA-ACCESSIBLE_UI) |
...
### 5.3 File Extensions
- `.wia-accessible-ui.json` — JSON format
- `.wia-accessible-ui.pb` — Protocol Buffers
