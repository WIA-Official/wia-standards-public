# Network Security — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for Network Security systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across network management systems and network infrastructure.
...
```json
{
  ...
  "title": "WIA Network Security Data Format",
  "type": "object",
  "required": ["standard", "version", "timestamp", "data"],
  "properties": {
    "standard": {
      "type": "string",
      "const": "network-security"
    },
    "version": {
      "type": "string",
      "pattern": "^\\d+\\.\\d+\\.\\d+$"
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (network-security) |
...
### 5.3 File Extensions
- `.wia-network-security.json` — JSON format
- `.wia-network-security.pb` — Protocol Buffers
