# Network Security — Phase 4: Integration Specification
...
Phase 4 defines integration patterns and requirements for deploying Network Security within existing infrastructure. This specification covers system architecture, integration patterns, testing requirements, and deployment guidelines for network management systems and network infrastructure.
...
- Implement the `WIAnetwork_securityAdapter` interface
...
```json
{
  ...
  "channels": [
    "network-security.data.ingested",
    "network-security.resource.updated",
    "network-security.alert.triggered"
  ]
}
```
