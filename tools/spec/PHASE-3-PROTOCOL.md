# WIA-tools PHASE 3 — PROTOCOL Specification
...
A tools operator MAY claim conformance to
WIA-tools only after the operating jurisdiction's
...
A programme conformant with WIA-tools publishes
