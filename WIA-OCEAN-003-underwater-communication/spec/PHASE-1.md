...
CTD (Conductivity-Temperature-Depth):
  Temperature: -2°C to 40°C (±0.003°C)
...
ISO Certifications Required:
  - ISO 9003: Quality Management
  - ISO 14003: Environmental Management
...
WIA conformance for WIA-OCEAN-003-underwater-communication is evaluated across three tiers:
...
- `wia-standards/standards/WIA-OCEAN-003-underwater-communication/api/` — TypeScript SDK skeleton
- `wia-standards/standards/WIA-OCEAN-003-underwater-communication/cli/` — POSIX shell client demonstrating the request/response contract
- `wia-standards/standards/WIA-OCEAN-003-underwater-communication/simulator/` — interactive browser-based simulator for the PHASE protocol
