#!/usr/bin/env bash
# resource-depletion — Resource Depletion CLI helper.
#
# Sample envelope generators for the WIA-ENE-039 standard.
# Requires: bash 4+, jq.
set -euo pipefail

STD_ID="WIA-ENE-039"
SLUG="resource-depletion"
...
cmd_refs() {
    cat <<REFS
Normative references for WIA-ENE-039 (Resource Depletion):
