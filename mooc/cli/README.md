...
Minimal POSIX shell client that demonstrates the WIA `mooc` standard's
...
```sh
export WIA_API_BASE="https://mooc.example.com/api/v1"
export WIA_API_TOKEN="<your-bearer-token>"
./mooc.sh list
./mooc.sh get <id>
./mooc.sh create payload.json
./mooc.sh validate payload.json
./mooc.sh export <id>
```
