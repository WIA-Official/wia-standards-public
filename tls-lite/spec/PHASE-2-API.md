# WIA-TLS-LITE — Phase 2: API

> TLS Lite canonical Phase 2 specification per the WIA Standards four-Phase architecture.

> Domain: TLS Lite — 경량 TLS · IoT · 임베디드 · TLS 1.3 부분집합 · DTLS.

## A.1 Scope

This Phase covers the canonical api layer of the WIA-TLS-LITE standard. It composes with the Phase 3 document for cross-Phase integration and inherits cross-standard behaviour from the wider WIA Standards family per the README.md scope statement.
