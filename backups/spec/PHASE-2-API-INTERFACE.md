# WIA-backups PHASE 2 — API-INTERFACE Specification

**Standard:** WIA-backups
...
`urn:wia:backups:status-transition`.
...
`422` with type
`urn:wia:backups:source-mix-required`.
...
with type
`urn:wia:backups:laboratory-not-accredited`.
...
`409` with type
`urn:wia:backups:quality-certificate-required`.
...
- `urn:wia:backups:hydrogen-quality-out-of-grade`
- `urn:wia:backups:cryogenic-temperature-excursion`
- `urn:wia:backups:guarantee-of-origin-mismatch`
- `urn:wia:backups:evidence-mismatch`
