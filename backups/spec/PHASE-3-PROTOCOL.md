# WIA-backups PHASE 3 — PROTOCOL Specification
...
A backups operator MAY claim conformance to
WIA-backups only after the operating jurisdiction's
...
A programme conformant with WIA-backups publishes
