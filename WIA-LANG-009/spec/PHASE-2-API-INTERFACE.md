# WIA-LANG-009 PHASE 2 — API-INTERFACE Specification
...
`urn:wia:WIA-LANG-009:status-transition`.
...
`422` with type
`urn:wia:WIA-LANG-009:source-mix-required`.
...
with type
`urn:wia:WIA-LANG-009:laboratory-not-accredited`.
...
`409` with type
`urn:wia:WIA-LANG-009:quality-certificate-required`.
...
- `urn:wia:WIA-LANG-009:hydrogen-quality-out-of-grade`
- `urn:wia:WIA-LANG-009:cryogenic-temperature-excursion`
- `urn:wia:WIA-LANG-009:guarantee-of-origin-mismatch`
- `urn:wia:WIA-LANG-009:evidence-mismatch`
