# Security Robot — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for Security Robot systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across robotic control systems and robotic platforms.
...
```json
{
  ...
  "title": "WIA Security Robot Data Format",
  "type": "object",
  "required": ["standard", "version", "timestamp", "data"],
  "properties": {
    "standard": {
      "type": "string",
      "const": "security-robot"
    },
    "version": {
      "type": "string",
      "pattern": "^\\d+\\.\\d+\\.\\d+$"
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (security-robot) |
...
### 5.3 File Extensions
- `.wia-security-robot.json` — JSON format
- `.wia-security-robot.pb` — Protocol Buffers
