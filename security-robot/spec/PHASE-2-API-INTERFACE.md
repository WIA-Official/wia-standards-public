# Security Robot — Phase 2: API Interface Specification
...
Phase 2 defines RESTful API endpoints for interacting with Security Robot services. This specification enables standardized programmatic access to robot telemetry across robotic control systems.

### 1.1 Base URL

```
Production: https://api.security-robot.wia.org/v1
Sandbox:    https://sandbox.security-robot.wia.org/v1
```
