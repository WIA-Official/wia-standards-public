# Dimension Portal — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for Dimension Portal systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across experimental physics systems and research platforms.
...
```json
{
  ...
  "title": "WIA Dimension Portal Data Format",
  "type": "object",
  "required": ["standard", "version", "timestamp", "data"],
  "properties": {
    "standard": {
      "type": "string",
      "const": "dimension-portal"
    },
    "version": {
      "type": "string",
      "pattern": "^\\d+\\.\\d+\\.\\d+$"
    ...
    "data": {
      "type": "object",
      "description": "Primary dimensional measurement data payload"
    }
  }
}
```
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (dimension-portal) |
...
| data | object | Yes | Domain-specific dimensional measurement data |
...
### 5.3 File Extensions
- `.wia-dimension-portal.json` — JSON format
- `.wia-dimension-portal.pb` — Protocol Buffers
