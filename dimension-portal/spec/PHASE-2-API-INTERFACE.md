# Dimension Portal — Phase 2: API Interface Specification
...
Phase 2 defines RESTful API endpoints for interacting with Dimension Portal services. This specification enables standardized programmatic access to dimensional measurement data across experimental physics systems.

### 1.1 Base URL

```
Production: https://api.dimension-portal.wia.org/v1
Sandbox:    https://sandbox.dimension-portal.wia.org/v1
```
...
| Method | Endpoint | Description |
|--------|----------|-------------|
| POST | /data/ingest | Submit dimensional measurement data |
