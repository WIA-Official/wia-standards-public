# Additive Manufacturing — Phase 4: Integration Specification
...
Phase 4 defines integration patterns and requirements for deploying Additive Manufacturing within existing infrastructure. This specification covers system architecture, integration patterns, testing requirements, and deployment guidelines for management systems and technology platforms.
...
- Implement the `WIAadditive_manufacturingAdapter` interface
...
```json
{
  ...
  "channels": [
    "additive-manufacturing.data.ingested",
    "additive-manufacturing.resource.updated",
    "additive-manufacturing.alert.triggered"
  ]
}
```
...
```
WIA_STANDARD=additive-manufacturing
WIA_VERSION=1.0.0
WIA_LOG_LEVEL=info
