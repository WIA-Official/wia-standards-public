# Additive Manufacturing — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for Additive Manufacturing systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across management systems and technology platforms.
...
```json
{
  ...
  "title": "WIA Additive Manufacturing Data Format",
  "type": "object",
  "required": ["standard", "version", "timestamp", "data"],
  "properties": {
    "standard": {
      "type": "string",
      "const": "additive-manufacturing"
    },
    "version": {
      "type": "string",
      "pattern": "^\\d+\\.\\d+\\.\\d+$"
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (additive-manufacturing) |
...
### 5.3 File Extensions
- `.wia-additive-manufacturi.json` — JSON format
- `.wia-additive-manufacturi.pb` — Protocol Buffers
