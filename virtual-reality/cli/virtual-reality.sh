#!/usr/bin/env bash
# virtual-reality — Virtual Reality CLI helper.
#
# Sample envelope generators for the WIA-XR-VR-001 standard.
# Requires: bash 4+, jq.
set -euo pipefail

STD_ID="WIA-XR-VR-001"
...
cmd_refs() {
    cat <<REFS
Normative references for WIA-XR-VR-001 (Virtual Reality):
