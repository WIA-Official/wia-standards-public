# Software License — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for Software License systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across management systems and technology platforms.
...
```json
{
  ...
  "title": "WIA Software License Data Format",
  "type": "object",
  "required": ["standard", "version", "timestamp", "data"],
  "properties": {
    "standard": {
      "type": "string",
      "const": "software-license"
    },
    "version": {
      "type": "string",
      "pattern": "^\\d+\\.\\d+\\.\\d+$"
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (software-license) |
...
### 5.3 File Extensions
- `.wia-software-license.json` — JSON format
- `.wia-software-license.pb` — Protocol Buffers
