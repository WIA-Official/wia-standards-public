# Smart Sensor — Phase 2: API Interface Specification
...
Phase 2 defines RESTful API endpoints for interacting with Smart Sensor services. This specification enables standardized programmatic access to sensor data streams across smart infrastructure.

### 1.1 Base URL

```
Production: https://api.smart-sensor.wia.org/v1
Sandbox:    https://sandbox.smart-sensor.wia.org/v1
```
