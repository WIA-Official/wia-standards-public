# PHASE 2 — API INTERFACE · smart-sensor
**Version:** 1.0
**Status:** Active
...
This Phase defines the API INTERFACE layer of the *smart-sensor* WIA standard.
...
in lockstep across Phases 1–4 of smart-sensor so that conformance claims at any
