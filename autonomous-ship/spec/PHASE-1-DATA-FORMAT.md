# Autonomous Ship — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for Autonomous Ship systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across management systems and technology platforms.
...
```json
{
  ...
  "title": "WIA Autonomous Ship Data Format",
  "type": "object",
  "required": ["standard", "version", "timestamp", "data"],
  "properties": {
    "standard": {
      "type": "string",
      "const": "autonomous-ship"
    },
    "version": {
      "type": "string",
      "pattern": "^\\d+\\.\\d+\\.\\d+$"
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (autonomous-ship) |
...
### 5.3 File Extensions
- `.wia-autonomous-ship.json` — JSON format
- `.wia-autonomous-ship.pb` — Protocol Buffers
