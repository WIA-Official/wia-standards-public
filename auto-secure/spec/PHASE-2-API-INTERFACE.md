# WIA-auto-secure PHASE 2 — API-INTERFACE Specification

**Standard:** WIA-auto-secure
**Phase:** 2 — API-INTERFACE
**Version:** 1.0
**Status:** Stable

This document defines the canonical API-INTERFACE layer for WIA-auto-secure
...
This PHASE document defines the api-interface concerns for WIA-auto-secure.
...
- standardSlug (constant value: "auto-secure")
...
at `/.well-known/wia/auto-secure`. The discovery document declares the
...
github.com/WIA-Official/wia-standards/issues with the `auto-secure` label.
