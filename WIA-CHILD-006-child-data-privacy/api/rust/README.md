# WIA-CHILD-006-child-data-privacy Rust SDK

> **弘益人間 (Benefit All Humanity)**

Official Rust SDK for the WIA-CHILD-006-child-data-privacy Standard.
...
```toml
[dependencies]
wia-child-006-child-data-privacy-sdk = "1.0"
...
```rust
use wia_child_006_child_data_privacy_sdk::CreateChild006ChildDataPrivacyRequest;
...
```rust
use wia_child_006_child_data_privacy_sdk::ListParams;
...
```rust
use wia_child_006_child_data_privacy_sdk::Error;
...
- Documentation: https://docs.wiastandards.com/WIA-CHILD-006-child-data-privacy
