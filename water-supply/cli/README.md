...
Minimal POSIX shell client that demonstrates the WIA `water-supply` standard's
...
```sh
export WIA_API_BASE="https://water-supply.example.com/api/v1"
export WIA_API_TOKEN="<your-bearer-token>"
./water-supply.sh list
./water-supply.sh get <id>
./water-supply.sh create payload.json
./water-supply.sh validate payload.json
./water-supply.sh export <id>
```
