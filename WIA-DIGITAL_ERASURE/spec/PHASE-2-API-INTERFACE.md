# WIA-DIGITAL_ERASURE: Phase 2 - API Interface Specification
**Version:** 1.0
**Status:** Official
...
This document specifies the API interface requirements for DIGITAL ERASURE. All implementations MUST provide these endpoints to ensure interoperability.

## 2. REST API Endpoints

### 2.1 Base URL
```
https://api.wia.org/v1/wia-digital-erasure/
```
...
```http
POST /v1/wia-digital-erasure/records HTTP/1.1
...
### 3.1 Installation
```bash
npm install @wia/wia-digital-erasure-sdk
```
...
### 3.3 Usage Example
```typescript
import { createClient } from '@wia/wia-digital-erasure-sdk';
