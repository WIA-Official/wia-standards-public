# WIA-FOOD_ALLERGY_PASSPORT: Phase 1 - Data Format Specification
**Version:** 1.0
**Status:** Official
...
This document specifies the data format requirements for FOOD ALLERGY PASSPORT. All implementations MUST follow these specifications to ensure interoperability across systems.
...
```json
{
  "type": "WIA-FOOD_ALLERGY_PASSPORTRecord",
  "version": "1.0",
  "id": "string (UUID v4)",
  "timestamp": "ISO 8601",
  "data": {
...
```json
{
  ...
  "properties": {
    "type": { "type": "string", "const": "WIA-FOOD_ALLERGY_PASSPORTRecord" },
