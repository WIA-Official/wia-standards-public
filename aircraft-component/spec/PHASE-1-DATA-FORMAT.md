# WIA-SPACE-016 PHASE 1 — Data Format Specification

**Standard:** WIA-SPACE-016 Aircraft Component
**Phase:** 1 — Data Format
**Version:** 1.0
**Status:** Stable
**Source:** consolidated from `WIA-SPACE-016-v1.0.md` §2 (Aircraft
Structure Standards) and §3 (Material Standards)

This document defines the canonical data structures for aircraft
component identification, structural envelopes, material certification
records, and traceability metadata. Schemas are expressed in JSON
