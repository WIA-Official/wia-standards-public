# WIA-SPACE-016 PHASE 2 — API Interface

**Standard:** WIA-SPACE-016 Aircraft Component
**Phase:** 2 — API Interface
**Version:** 1.0
**Status:** Stable
**Source:** consolidated from `WIA-SPACE-016-v1.0.md` §7 (Avionics
Standards)

This document defines the REST APIs for component catalog lookup,
maintenance event submission, certification-package upload, and
traceability queries. The full machine-readable definition lives under
...
- `componentCatalog` — list, retrieve, search component type designations
- `maintenanceEvent` — record, retrieve, query maintenance actions
- `certificationPackage` — submit FAA/EASA/KCAA certification evidence
- `traceability` — query by serial number across the component lifetime
...
the IETF well-known URI mechanism (RFC 8615). Manifest endpoints are
signed using Sigstore (DSSE envelope) and the signing key is rotated
per the deployment policy.
