# Scientific Instrument — Phase 1: Data Format Specification
...
Phase 1 defines standardized data formats for Scientific Instrument systems. This specification establishes the core data model, field definitions, validation rules, and serialization formats to ensure interoperability across management systems and technology platforms.
...
```json
{
  ...
  "title": "WIA Scientific Instrument Data Format",
  "type": "object",
  "required": ["standard", "version", "timestamp", "data"],
  "properties": {
    "standard": {
      "type": "string",
      "const": "scientific-instrument"
    },
    "version": {
      "type": "string",
      "pattern": "^\\d+\\.\\d+\\.\\d+$"
...
|-------|------|----------|-------------|
| standard | string | Yes | Standard identifier (scientific-instrument) |
...
### 5.3 File Extensions
- `.wia-scientific-instrumen.json` — JSON format
- `.wia-scientific-instrumen.pb` — Protocol Buffers
...
```json
{
  "standard": "scientific-instrument",
  "version": "1.0.0",
