# Scientific Instrument — Phase 4: Integration Specification
...
Phase 4 defines integration patterns and requirements for deploying Scientific Instrument within existing infrastructure. This specification covers system architecture, integration patterns, testing requirements, and deployment guidelines for management systems and technology platforms.
...
- Implement the `WIAscientific_instrumentAdapter` interface
...
```json
{
  ...
  "channels": [
    "scientific-instrument.data.ingested",
    "scientific-instrument.resource.updated",
    "scientific-instrument.alert.triggered"
  ]
}
```
...
```
WIA_STANDARD=scientific-instrument
WIA_VERSION=1.0.0
WIA_LOG_LEVEL=info
