...
This document specifies the data format requirements for DIGITAL WILL. All implementations MUST follow these specifications to ensure interoperability across systems.
...
```json
{
  ...
  "properties": {
    "type": { "type": "string", "const": "WIA-DIGITAL_WILLRecord" },
