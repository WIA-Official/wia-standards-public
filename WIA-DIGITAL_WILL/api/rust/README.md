# WIA-DIGITAL_WILL Rust SDK

> **弘益人間 (Benefit All Humanity)**

Official Rust SDK for the WIA-DIGITAL_WILL Standard.
...
```rust
use wia_digital_will_sdk::CreateDigitalWillRequest;

let request = CreateDigitalWillRequest {
...
```rust
use wia_digital_will_sdk::ListParams;
...
```rust
use wia_digital_will_sdk::Error;
...
- Documentation: https://docs.wiastandards.com/WIA-DIGITAL_WILL
